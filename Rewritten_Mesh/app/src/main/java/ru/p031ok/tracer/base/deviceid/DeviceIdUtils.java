package ru.p031ok.tracer.base.deviceid;

import android.content.Context;
import kotlin.Metadata;
import p000.O90;

@Metadata(m22266d1 = {"\u0000\u001a\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a\u000e\u0010\u0007\u001a\u00020\u00012\u0006\u0010\b\u001a\u00020\t\u001a\u0010\u0010\n\u001a\u00020\u00012\u0006\u0010\b\u001a\u00020\tH\u0002\"\u000e\u0010\u0000\u001a\u00020\u0001X\u0082T¢\u0006\u0002\n\u0000\"\u000e\u0010\u0002\u001a\u00020\u0001X\u0082T¢\u0006\u0002\n\u0000\"\u000e\u0010\u0003\u001a\u00020\u0001X\u0080T¢\u0006\u0002\n\u0000\"\u0010\u0010\u0004\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u000e\u0010\u0005\u001a\u00020\u0006X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000b"}, m22267d2 = {"FILE_DEVICE_ID", "", "KEY_DEVICE_ID", "NULL_UUID", "cachedDeviceId", "deviceIdLock", "Ljava/lang/Object;", "getDeviceId", "context", "Landroid/content/Context;", "loadDeviceId", "tracer-base_release"}, m22268k = 2, m22269mv = {1, 7, 1}, m22271xi = 48)
    ...
    */
    private static final java.lang.String loadDeviceId(android.content.Context r8) {
        ...
        L14:
            ...
            p000.O90.m5967e(r8, r6)     // Catch: java.io.IOException -> L8b
            java.io.File r8 = p000.AbstractC6366lU.m22437g(r8, r0)     // Catch: java.io.IOException -> L8b
            java.io.File r8 = ru.p031ok.tracer.base.p032io.FileUtils.mkdirsChecked(r8)     // Catch: java.io.IOException -> L8b
            java.lang.String r0 = "device_id.txt"
            java.io.File r8 = p000.AbstractC6366lU.m22437g(r8, r0)
        ...
        L31:
            ...
            goto L45
        L33:
            java.lang.String r0 = p000.AbstractC6366lU.m22436f(r8)     // Catch: java.io.IOException -> L31
            java.lang.CharSequence r0 = p000.AbstractC11374v51.m25350Y(r0)     // Catch: java.io.IOException -> L31
        ...
        L59:
            ...
            java.nio.charset.Charset r8 = p000.AbstractC7038vr.f44561a     // Catch: java.lang.Throwable -> L84
            byte[] r8 = r0.getBytes(r8)     // Catch: java.lang.Throwable -> L84
            java.lang.String r7 = "this as java.lang.String).getBytes(charset)"
            p000.O90.m5967e(r8, r7)     // Catch: java.lang.Throwable -> L84
            ...
            p000.AbstractC8729aT1.m9749a(r6, r3)     // Catch: java.io.IOException -> L8b
            if (r4 == 0) goto L83
        ...
        L86:
            r0 = move-exception
            p000.AbstractC8729aT1.m9749a(r6, r8)     // Catch: java.io.IOException -> L8b
            throw r0     // Catch: java.io.IOException -> L8b
        L8b:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: ru.p031ok.tracer.base.deviceid.DeviceIdUtils.loadDeviceId(android.content.Context):java.lang.String");
    }
}
