package ru.p031ok.tracer.lite.limits;
...
public final class TracerLiteLimits implements TracerFeatureLimits {
    ...
    @Metadata(m22266d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006¨\u0006\u0007"}, m22267d2 = {"Lru/ok/tracer/lite/limits/TracerLiteLimits$Companion;", "", "()V", "get", "Lru/ok/tracer/lite/limits/TracerLiteLimits;", "tracer", "Lru/ok/tracer/lite/TracerLite;", "tracer-lite-commons_release"}, m22268k = 1, m22269mv = {1, 7, 1}, m22271xi = 48)
    ...
    private final SharedPreferences getPrefs() {
        ...
        O90.m5967e(sharedPreferences, "context.getSharedPrefere…e\", Context.MODE_PRIVATE)");
    ...
    public boolean isLimited(String featureName, String tag) {
        ...
        return featureName != null && jCurrentTimeMillis < getPrefs().getLong(AbstractC7222ym.m26234k("system.", featureName, ".shutdown.until.ts"), Long.MIN_VALUE);
    }
    ...
    public void setShutdownMs(Long globalShutdownMs, String featureName, Long featureShutdownMs, String tag, Long tagShutdownMs) {
        ...
        if (featureName == null || featureShutdownMs == null || featureShutdownMs.longValue() <= 0) {
            ...
            editorEdit.putLong(AbstractC7222ym.m26234k("system.", featureName, ".shutdown.until.ts"), featureShutdownMs.longValue() + System.currentTimeMillis());
        }
        if (z2) {
            editorEdit.apply();
        }
