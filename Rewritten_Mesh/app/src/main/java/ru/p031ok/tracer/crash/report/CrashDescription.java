...
public final /* data */ class CrashDescription {
    ...
    public CrashDescription(long j, CrashType crashType, String str, String str2, String str3, String str4, String str5, String str6) {
        O90.m5968f(crashType, "crashType");
        O90.m5968f(str, "crashFilesDir");
        O90.m5968f(str2, "systemStatePath");
        O90.m5968f(str3, "tagsPath");
        O90.m5968f(str4, "stacktracePath");
        O90.m5968f(str5, "allStacktracesPath");
        O90.m5968f(str6, "logsPath");
        this.timestamp = j;
    ...
    public final CrashDescription copy(long timestamp, CrashType crashType, String crashFilesDir, String systemStatePath, String tagsPath, String stacktracePath, String allStacktracesPath, String logsPath) {
        O90.m5968f(crashType, "crashType");
        O90.m5968f(crashFilesDir, "crashFilesDir");
        O90.m5968f(systemStatePath, "systemStatePath");
        O90.m5968f(tagsPath, "tagsPath");
        O90.m5968f(stacktracePath, "stacktracePath");
        O90.m5968f(allStacktracesPath, "allStacktracesPath");
        O90.m5968f(logsPath, "logsPath");
    ...
    public final void delete() {
        AbstractC6366lU.m22433c(new File(this.crashFilesDir));
    }
    ...
    public boolean equals(Object other) {
        ...
        return this.timestamp == crashDescription.timestamp && this.crashType == crashDescription.crashType && O90.m5963a(this.crashFilesDir, crashDescription.crashFilesDir) && O90.m5963a(this.systemStatePath, crashDescription.systemStatePath) && O90.m5963a(this.tagsPath, crashDescription.tagsPath) && O90.m5963a(this.stacktracePath, crashDescription.stacktracePath) && O90.m5963a(this.allStacktracesPath, crashDescription.allStacktracesPath) && O90.m5963a(this.logsPath, crashDescription.logsPath);
    }
    ...
    public int hashCode() {
        ...
        return this.logsPath.hashCode() + AbstractC1374Vq.m8586e(AbstractC1374Vq.m8586e(AbstractC1374Vq.m8586e(AbstractC1374Vq.m8586e(AbstractC1374Vq.m8586e((this.crashType.hashCode() + (((int) (j ^ (j >>> 32))) * 31)) * 31, 31, this.crashFilesDir), 31, this.systemStatePath), 31, this.tagsPath), 31, this.stacktracePath), 31, this.allStacktracesPath);
    }
    ...
    public String toString() {
        ...
        sb.append(", logsPath=");
        return F91.m2539v(sb, this.logsPath, ')');
    }
}
