...
public final class SamplingProfiler {
    ...
    private final void onFinish() {
        ...
        State state3 = state;
        O90.d(state3, "null cannot be cast to non-null type ru.ok.tracer.profiler.sampling.SamplingProfiler.InProgress");
        InProgress inProgress = (InProgress) state3;
        state = new Finished(inProgress.getSampleFile(), inProgress.getTag(), AbstractC5686lO1.b(inProgress.getRequestedDuration(), SystemClock.elapsedRealtime() - inProgress.getStartRealtime()));
    }
    ...
    private final void onStart(String tag, long duration) {
        ...
        try {
            ...
            mainHandler.postDelayed(new A3(12), duration);
    ...
    private final void onStop(boolean send, final String tagSuffix) {
        ...
        State state3 = state;
        O90.d(state3, "null cannot be cast to non-null type ru.ok.tracer.profiler.sampling.SamplingProfiler.Finished");
    ...
    private final void onUpload(File sampleFile, String tag, long duration) {
        ...
        Context context2 = context;
        if (context2 != null) {
            sampleUploader.upload(context2, FEATURE_SAMPLED_TRACEKt.getFEATURE_SAMPLED_TRACE(), sampleFile, (72 & 8) != 0, (72 & 16) != 0 ? null : tag, (72 & 32) != 0 ? null : Long.valueOf(duration), (72 & 64) != 0 ? NN.a : null);
        } else {
            O90.o("context");
            throw null;
        }
    ...
    public static final void commit(String tagSuffix) {
        ...
        RunnableC6658qU0 runnableC6658qU0 = new RunnableC6658qU0(tagSuffix, 1);
        if (O90.a(Looper.myLooper(), Looper.getMainLooper())) {
    ...
    public static final void start(String tag, long duration) {
        O90.f(tag, "tag");
        RunnableC3593eV0 runnableC3593eV0 = new RunnableC3593eV0(0, tag, duration);
        if (O90.a(Looper.myLooper(), Looper.getMainLooper())) {
