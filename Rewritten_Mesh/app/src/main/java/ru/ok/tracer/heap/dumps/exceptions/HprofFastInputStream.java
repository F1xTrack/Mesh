...
public class HprofFastInputStream extends InputStream {
    ...
    private void discardFromInput(int i) throws IOException {
        while (i > 0) {
            int iSkipBytes = this.in.skipBytes(i);
            if (iSkipBytes == -1) {
    ...
    */
    private void parseHeap() throws java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: ru.ok.tracer.heap.dumps.exceptions.HprofFastInputStream.parseHeap():void");
    }
                            ...
                            default:
                                switch (i) {
                                    ...
                                    case 68:
                                        return 8;
                                    default:
                                        throw new IllegalArgumentException(AbstractC8235ym.g(i, "Signature type ", " is not supported"));
                                }
                        }
                    }
                }
