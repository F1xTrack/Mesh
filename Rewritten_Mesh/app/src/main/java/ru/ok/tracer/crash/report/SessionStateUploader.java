...
public final class SessionStateUploader {
    ...
    public static final void upload$lambda$3(HttpRequest httpRequest, ConditionVariable conditionVariable, SessionStateStorage sessionStateStorage) {
        byte[] bytes;
        O90.f(httpRequest, "$request");
        O90.f(conditionVariable, "$sessionUploadCondition");
        O90.f(sessionStateStorage, "$storage");
        try {
            ...
            try {
                ...
                String strH = (body2 == null || (bytes = body2.getBytes()) == null) ? null : D51.h(bytes);
                NetworkResponseHandler.universalHandleResponse$default(NetworkResponseHandler.INSTANCE, contentType, strH, FEATURE_CRASH_FREEKt.getFEATURE_CRASH_FREE().getName(), null, 8, null);
                if (statusCode != 200) {
                    ...
                    new StringBuilder("Result: ").append(strH);
    ...
    public final void upload(SystemState systemState, List<SessionState> prevSessionStates, SessionStateStorage storage) throws JSONException {
        ...
        O90.f(prevSessionStates, "prevSessionStates");
        O90.f(storage, "storage");
        ...
        O90.e(string2, "bodyJsonObject.toString()");
        ...
        TracerThreads.INSTANCE.runOnIo(new RunnableC1313Qp0(httpRequest, conditionVariable, storage, 9));
    }
