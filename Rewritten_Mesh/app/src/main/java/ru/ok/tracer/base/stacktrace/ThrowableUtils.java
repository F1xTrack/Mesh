...
public final class ThrowableUtils {
    ...
    public static final void appendStackTraceTo(Throwable th, Appendable appendable) throws IOException {
        O90.f(th, "<this>");
        O90.f(appendable, "out");
        StackTraceElement[] stackTrace = th.getStackTrace();
        O90.e(stackTrace, "stackTrace");
    ...
    public static final void appendTo(StackTraceElement stackTraceElement, Appendable appendable, int i, String str) throws IOException {
        ...
        O90.e(appendableAppend, "out.append(\")\")");
        O90.e(appendableAppend.append('\n'), "append('\\n')");
    }
    ...
    private static final int framesInCommon(StackTraceElement[] stackTraceElementArr, StackTraceElement[] stackTraceElementArr2) {
        int iP = J8.p(stackTraceElementArr);
        for (int iP2 = J8.p(stackTraceElementArr2); iP >= 0 && iP2 >= 0 && O90.a(stackTraceElementArr[iP], stackTraceElementArr2[iP2]); iP2--) {
            iP--;
        }
        return (stackTraceElementArr.length - 1) - iP;
    }
    ...
    private static final int framesRepeat(Throwable th, StackTraceElement[] stackTraceElementArr) {
        if (th instanceof StackOverflowError) {
            ...
            for (int i = 1; i < length; i++) {
                if (O90.a(stackTraceElement, stackTraceElementArr[i])) {
                    return i;
                }
            }
        }
    ...
    private static final <T> void plusAssign(Map<T, C1518Tf1> map, T t) {
        O90.f(map, "<this>");
        map.put(t, C1518Tf1.a);
    }

    private static final void appendStackTraceTo(Throwable th, Appendable appendable, int i, String str, StackTraceElement[] stackTraceElementArr, int i2, Map<Throwable, C1518Tf1> map) throws IOException {
        if (map.containsKey(th)) {
            Appendable appendableAppend = appendIndent(appendable, 1).append("[CIRCULAR REFERENCE: ").append(th.toString()).append("]");
            O90.e(appendableAppend, "out.appendIndent(1)\n    …s.toString()).append(\"]\")");
            O90.e(appendableAppend.append('\n'), "append('\\n')");
            return;
        }
        plusAssign(map, th);
        Appendable appendableAppend2 = appendIndent(appendable, i).append(str).append(th.toString());
        O90.e(appendableAppend2, "out.appendIndent(indent)…).append(this.toString())");
        O90.e(appendableAppend2.append('\n'), "append('\\n')");
        ...
        if (iFramesRepeat > 0) {
            ...
            O90.e(appendableAppend3, "out.appendIndent(indent …).append(\" calls repeat\")");
            O90.e(appendableAppend3.append('\n'), "append('\\n')");
        } else if (i2 != 0) {
            Appendable appendableAppend4 = appendIndent(appendable, i + 1).append("... ").append(String.valueOf(i2)).append(" more");
            O90.e(appendableAppend4, "out.appendIndent(indent …String()).append(\" more\")");
            O90.e(appendableAppend4.append('\n'), "append('\\n')");
        }
        Throwable[] suppressed = th.getSuppressed();
        O90.e(suppressed, "suppressed");
        for (Throwable th2 : suppressed) {
            StackTraceElement[] stackTrace = th2.getStackTrace();
            O90.e(stackTrace, "suppTrace");
