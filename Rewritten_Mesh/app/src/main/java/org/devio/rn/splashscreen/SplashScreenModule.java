...
import defpackage.RunnableC1558Tt;
...
public class SplashScreenModule extends ReactContextBaseJavaModule {
    ...
    public void hide() {
        ...
        if (currentActivity == null) {
            WeakReference weakReference = NS1.b;
        ...
        currentActivity.runOnUiThread(new RunnableC1558Tt(currentActivity, 4));
    }
    ...
    public void show() {
        ...
        NS1.b = new WeakReference(currentActivity);
