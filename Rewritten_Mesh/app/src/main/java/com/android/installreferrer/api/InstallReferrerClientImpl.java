...
class InstallReferrerClientImpl extends InstallReferrerClient {
    ...
    public final class InstallReferrerServiceConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            if (iBinder == null) {
                ...
                u40 = iInterfaceQueryLocalInterface instanceof W40 ? (W40) iInterfaceQueryLocalInterface : new U40(iBinder);
            }
            installReferrerClientImpl.service = u40;
    ...
    public ReferrerDetails getInstallReferrer() throws RemoteException {
        ...
        bundle.putString(AnalyticsBaseParamsConstantsKt.PACKAGE_NAME, this.mApplicationContext.getPackageName());
        try {
            return new ReferrerDetails(((U40) this.service).m7872G(bundle));
