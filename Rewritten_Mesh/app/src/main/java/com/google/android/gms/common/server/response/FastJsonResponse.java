...
public abstract class FastJsonResponse {
    ...
    private final void zaE(Field field, Object obj) {
        ...
        switch (i) {
            ...
            case 3:
            default:
                throw new IllegalStateException(AbstractC11153tN0.m24909u(i, "Unsupported type for conversion: "));
            case 4:
                if (objZae != null) {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        @SafeParcelable.Field(getter = "getTypeIn", m11119id = 2)
        protected final int zaa;

        @SafeParcelable.Field(getter = "isTypeInArray", m11119id = 3)
        protected final boolean zab;

        @SafeParcelable.Field(getter = "getTypeOut", m11119id = 4)
        protected final int zac;

        @SafeParcelable.Field(getter = "isTypeOutArray", m11119id = 5)
        protected final boolean zad;

        @SafeParcelable.Field(getter = "getOutputFieldName", m11119id = 6)
        protected final String zae;

        @SafeParcelable.Field(getter = "getSafeParcelableFieldId", m11119id = 7)
        protected final int zaf;
        protected final Class zag;

        @SafeParcelable.Field(getter = "getConcreteTypeName", m11119id = 8)
        protected final String zah;

        @SafeParcelable.VersionField(getter = "getVersionCode", m11122id = 1)
        private final int zai;
        private zan zaj;

        @SafeParcelable.Field(getter = "getWrappedConverter", m11119id = 9, type = "com.google.android.gms.common.server.converter.ConverterWrapper")
        private final FieldConverter zak;

        @SafeParcelable.Constructor
        public Field(@SafeParcelable.Param(m11120id = 1) int i, @SafeParcelable.Param(m11120id = 2) int i2, @SafeParcelable.Param(m11120id = 3) boolean z, @SafeParcelable.Param(m11120id = 4) int i3, @SafeParcelable.Param(m11120id = 5) boolean z2, @SafeParcelable.Param(m11120id = 6) String str, @SafeParcelable.Param(m11120id = 7) int i4, @SafeParcelable.Param(m11120id = 8) String str2, @SafeParcelable.Param(m11120id = 9) com.google.android.gms.common.server.converter.zaa zaaVar) {
            this.zai = i;
            this.zaa = i2;
            this.zab = z;
            this.zac = i3;
