...
public final class zan extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getRootClassName", m11119id = 3)
    private final String zac;

    @SafeParcelable.Constructor
    public zan(@SafeParcelable.Param(m11120id = 1) int i, @SafeParcelable.Param(m11120id = 2) ArrayList arrayList, @SafeParcelable.Param(m11120id = 3) String str) {
        this.zaa = i;
