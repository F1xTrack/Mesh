...
public class SafeParcelReader {
    ...
    public static int validateObjectHeader(Parcel parcel) {
        ...
        if (i < iDataPosition || i > parcel.dataSize()) {
            throw new ParseException(AbstractC7222ym.m26229f(iDataPosition, "Size read is invalid start=", i, " end="), parcel);
        }
        return i;
    }
    ...
    private static void zza(Parcel parcel, int i, int i2, int i3) {
        ...
        throw new ParseException(AbstractC1374Vq.m8593l(AbstractC1374Vq.m8594m("Expected size ", " got ", i3, i2, " (0x"), Integer.toHexString(i2), ")"), parcel);
    }
    ...
    private static void zzb(Parcel parcel, int i, int i2) {
        ...
        throw new ParseException(AbstractC1374Vq.m8593l(AbstractC1374Vq.m8594m("Expected size ", " got ", i2, size, " (0x"), Integer.toHexString(size), ")"), parcel);
    }
}
