...
public class ModuleInstallResponse extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValue = "false", getter = "getShouldUnregisterListener", m11119id = 2)
    ...
    public ModuleInstallResponse(@SafeParcelable.Param(m11120id = 1) int i, @SafeParcelable.Param(m11120id = 2) boolean z) {
        this.zaa = i;
        this.zab = z;
    }
}
