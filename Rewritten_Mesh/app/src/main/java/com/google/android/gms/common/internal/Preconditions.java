...
public final class Preconditions {
    ...
    public static void checkHandlerThread(Handler handler) {
        ...
        if (looperMyLooper != handler.getLooper()) {
            throw new IllegalStateException(AbstractC11153tN0.m24912x("Must be called on ", handler.getLooper().getThread().getName(), " thread, but got ", looperMyLooper != null ? looperMyLooper.getThread().getName() : "null current looper", "."));
        }
    }
