...
public class SleepSegmentRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getUserPreferredSleepWindow", m11119id = 1)
    private final List zza;

    @SafeParcelable.Field(defaultValue = "0", getter = "getRequestedDataType", m11119id = 2)
    ...
    public SleepSegmentRequest(@SafeParcelable.Param(m11120id = 1) List list, @SafeParcelable.Param(m11120id = 2) int i) {
        this.zza = list;
        this.zzb = i;
    }
}
