...
public class ActivityTransitionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getTransitionEvents", m11119id = 1)
    private final List zza;

    @SafeParcelable.Field(getter = "getExtras", m11119id = 2)
    private Bundle zzb;

    public ActivityTransitionResult(@SafeParcelable.Param(m11120id = 1) List<ActivityTransitionEvent> list) {
        this.zzb = null;
    ...
    public ActivityTransitionResult(@SafeParcelable.Param(m11120id = 1) List list, @SafeParcelable.Param(m11120id = 2) Bundle bundle) {
        this(list);
        this.zzb = bundle;
    }
}
