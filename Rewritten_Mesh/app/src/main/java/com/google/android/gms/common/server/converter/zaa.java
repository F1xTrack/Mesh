...
public final class zaa extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getStringToIntConverter", m11119id = 2)
    private final StringToIntConverter zab;

    @SafeParcelable.Constructor
    public zaa(@SafeParcelable.Param(m11120id = 1) int i, @SafeParcelable.Param(m11120id = 2) StringToIntConverter stringToIntConverter) {
        this.zaa = i;
