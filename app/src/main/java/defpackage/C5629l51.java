...
public final class C5629l51 implements InterfaceC5361jh1, Y60, U91 {
    public static final C0572Hc b = new C0572Hc("camerax.core.streamSharing.captureTypes", List.class, null);
    public final C0873Ky0 a;

    public C5629l51(C0873Ky0 c0873Ky0) {
        this.a = c0873Ky0;
    }
    ...
    @Override // defpackage.M60
    public final int p() {
        return ((Integer) w(M60.x0)).intValue();
    }
