...
public final class C6526po extends AbstractC5762lo {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C6526po(int i, boolean z) {
    ...
    public C6526po(String str, String str2) {
        super("parameter", "invalid-parameter", AbstractC7209tN0.x("The given value for ", str, " could not be parsed! (Received: ", str2, ")"), null);
    }

    public C6526po(int i) {
        super("format", "invalid-fps", AbstractC8235ym.g(i, "The given format cannot run at ", " FPS! Make sure your FPS is lower than `format.maxFps` but higher than `format.minFps`."), null);
    }

    public C6526po(EnumC1608Uj1 enumC1608Uj1) {
        O90.f(enumC1608Uj1, "mode");
        StringBuilder sb = new StringBuilder("The given format does not support the videoStabilizationMode \"");
        String str = enumC1608Uj1.a;
        sb.append(str);
    ...
    public C6526po(String str) {
        super("capture", "invalid-path", AbstractC8235ym.k("The given path (", str, ") is invalid, or not writable!"), null);
    }
}
