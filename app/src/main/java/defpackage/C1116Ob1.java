...
public final class C1116Ob1 {
    public final boolean a;
    public final String b;
    public final C1506Tb1 c;
    public final int d;
    public final byte[] e;
    ...
    */
    public C1116Ob1(boolean r6, java.lang.String r7, int r8, byte[] r9, int r10, int r11, byte[] r12) {
        /*
            r5 = this;
            r0 = 2
            r5.<init>()
        ...
        L59:
            ...
            defpackage.AbstractC6789rA1.h(r7)
            goto L20
        L70:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.C1116Ob1.<init>(boolean, java.lang.String, int, byte[], int, int, byte[]):void");
    }
}
