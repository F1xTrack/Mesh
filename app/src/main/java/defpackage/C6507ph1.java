...
public final class C6507ph1 {
    public final /* synthetic */ int a;

    public static void c(Drawable drawable, int i) {
        AbstractC4135hL.g(drawable, i);
    }
    ...
    public static int d(long j, int i, int i2, byte[] bArr) {
        ...
        if (i2 == 1) {
            return AbstractC7270th1.c(i, AbstractC1053Ng1.g(j, bArr));
        }
        if (i2 == 2) {
            return AbstractC7270th1.d(i, AbstractC1053Ng1.g(j, bArr), AbstractC1053Ng1.g(j + 1, bArr));
        }
                ...
                while (i7 < length) {
                    ...
                    if (cCharAt3 < 128 && i8 < i6) {
                        ...
                        if ((cCharAt3 >= 55296 && 57343 >= cCharAt3) || i8 > i6 - 3) {
                            ...
                            throw new C6888rh1(i7 - 1, length);
                        }
            ...
            default:
                ...
                while (true) {
                    ...
                    if (i13 < length2 && (cCharAt2 = str.charAt(i13)) < 128) {
                        AbstractC1053Ng1.k(bArr, j2, (byte) cCharAt2);
                        i13++;
                        j2 = 1 + j2;
                    }
                }
                if (i13 != length2) {
                    while (i13 < length2) {
                        ...
                        if (cCharAt5 < 128 && j2 < j3) {
                            AbstractC1053Ng1.k(bArr, j2, (byte) cCharAt5);
                            str3 = str5;
                            j2 += j;
                            str2 = str4;
                            ...
                            if ((cCharAt5 >= 55296 && 57343 >= cCharAt5) || j2 > j3 - 3) {
                                if (j2 > j3 - 4) {
                                    if (55296 <= cCharAt5 && cCharAt5 <= 57343 && ((i5 = i13 + 1) == length2 || !Character.isSurrogatePair(cCharAt5, str.charAt(i5)))) {
                                        throw new C6888rh1(i13, length2);
                                    }
                                ...
                                if (i14 != length2) {
                                    ...
                                    if (Character.isSurrogatePair(cCharAt5, cCharAt6)) {
                                        ...
                                        AbstractC1053Ng1.k(bArr, j2, (byte) ((codePoint2 >>> 18) | 240));
                                        AbstractC1053Ng1.k(bArr, j2 + 1, (byte) (((codePoint2 >>> 12) & 63) | 128));
                                        long j4 = 3 + j2;
                                        AbstractC1053Ng1.k(bArr, j2 + 2, (byte) (((codePoint2 >>> 6) & 63) | 128));
                                        j2 += 4;
                                        AbstractC1053Ng1.k(bArr, j4, (byte) ((codePoint2 & 63) | 128));
                                        i13 = i14;
                                    } else {
                                        i13 = i14;
                                    }
                                }
                                throw new C6888rh1(i13 - 1, length2);
                            }
                            AbstractC1053Ng1.k(bArr, j2, (byte) ((cCharAt5 >>> '\f') | 480));
                            long j5 = j2 + 2;
                            AbstractC1053Ng1.k(bArr, j2 + 1, (byte) (((cCharAt5 >>> 6) & 63) | 128));
                            j2 += 3;
                            AbstractC1053Ng1.k(bArr, j5, (byte) ((cCharAt5 & '?') | 128));
                        } else {
                            str2 = str4;
                            str3 = str5;
                            long j6 = j2 + j;
                            AbstractC1053Ng1.k(bArr, j2, (byte) ((cCharAt5 >>> 6) | 960));
                            j2 += 2;
                            AbstractC1053Ng1.k(bArr, j6, (byte) ((cCharAt5 & '?') | 128));
                        }
                        i13++;
                        str4 = str2;
                        str5 = str3;
    ...
    */
    public final int b(byte[] r23, int r24, int r25) {
        /*
            Method dump skipped, instructions count: 468
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.C6507ph1.b(byte[], int, int):int");
    }
}
