...
public final class C6013n60 implements InterfaceC5361jh1, Y60, U91 {
    public static final C0572Hc b = new C0572Hc("camerax.core.imageAnalysis.backpressureStrategy", InterfaceC3518e60.class, null);
    public static final C0572Hc c = new C0572Hc("camerax.core.imageAnalysis.imageQueueDepth", Integer.TYPE, null);
    public static final C0572Hc d = new C0572Hc("camerax.core.imageAnalysis.imageReaderProxyProvider", InterfaceC5443k70.class, null);
    public static final C0572Hc e = new C0572Hc("camerax.core.imageAnalysis.outputImageFormat", InterfaceC4091h60.class, null);
    public static final C0572Hc f = new C0572Hc("camerax.core.imageAnalysis.onePixelShiftEnabled", Boolean.class, null);
    public static final C0572Hc g = new C0572Hc("camerax.core.imageAnalysis.outputImageRotationEnabled", Boolean.class, null);
    public final C0873Ky0 a;

    public C6013n60(C0873Ky0 c0873Ky0) {
        this.a = c0873Ky0;
    }
    ...
    @Override // defpackage.Y60
    public final /* synthetic */ int n0(int i) {
        return X60.f(this, i);
    }
