...
public final class C0679Il1 {
    public static final C0679Il1 k;
    ...
    static {
        float[] fArr = AbstractC3795fZ.e;
        float fG = (float) ((AbstractC3795fZ.g() * 63.66197723675813d) / 100.0d);
        float[][] fArr2 = AbstractC3795fZ.c;
        float f = fArr[0];
        float[] fArr3 = fArr2[0];
        float f2 = fArr3[0] * f;
        float f3 = fArr[1];
        ...
        float f10 = 1.0f / ((5.0f * fG) + 1.0f);
        float f11 = f10 * f10 * f10 * f10;
        float f12 = 1.0f - f11;
        float fCbrt = (0.1f * f12 * f12 * ((float) Math.cbrt(fG * 5.0d))) + (f11 * fG);
        float fG2 = AbstractC3795fZ.g() / fArr[1];
        double d2 = fG2;
        ...
        k = new C0679Il1(fG2, ((fArr8[2] * 0.05f) + (fArr8[0] * 2.0f) + fArr8[1]) * fPow, fPow, fPow, f9, 1.0f, fArr6, fCbrt, (float) Math.pow(fCbrt, 0.25d), fSqrt);
    }

    public C0679Il1(float f, float f2, float f3, float f4, float f5, float f6, float[] fArr, float f7, float f8, float f9) {
        this.f = f;
        this.a = f2;
        this.b = f3;
        this.c = f4;
