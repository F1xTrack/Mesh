...
public enum EnumC4301iC1 {
    ...
    public static final HashMap w1 = new HashMap();
    public final int a;

    static {
        for (EnumC4301iC1 enumC4301iC1 : values()) {
            w1.put(Integer.valueOf(enumC4301iC1.a), enumC4301iC1);
        }
    }
