...
public final class C3444dj extends AbstractC7507ux {
    public final C2568cj j;

    public C3444dj(ReactApplicationContext reactApplicationContext) {
        super(reactApplicationContext);
        this.j = new C2568cj(this);
    }

    @Override // defpackage.AbstractC7507ux
    public final void c() {
        IntentFilter intentFilter = new IntentFilter();
        intentFilter.addAction("android.net.conn.CONNECTIVITY_CHANGE");
        int i = Build.VERSION.SDK_INT;
        ReactApplicationContext reactApplicationContext = this.d;
        C2568cj c2568cj = this.j;
        if (i < 34 || reactApplicationContext.getApplicationInfo().targetSdkVersion < 34) {
            reactApplicationContext.registerReceiver(c2568cj, intentFilter);
        } else {
            reactApplicationContext.registerReceiver(c2568cj, intentFilter, 4);
        }
        c2568cj.a = true;
        f();
    }
    ...
    public final void d() {
        C2568cj c2568cj = this.j;
        if (c2568cj.a) {
            this.d.unregisterReceiver(c2568cj);
            c2568cj.a = false;
        }
    }
    ...
    */
    public final void f() {
        /*
            ...
            r0 = 0
            r1 = 5
            android.net.ConnectivityManager r2 = r9.a     // Catch: java.lang.SecurityException -> L52
        ...
        L56:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.C3444dj.f():void");
    }
}
