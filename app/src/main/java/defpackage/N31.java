    ...
    */
    public static java.util.ArrayList m(java.lang.String r12) {
        ...
        L3b:
            r12 = r4
        L3c:
            byte[] r5 = defpackage.AbstractC7522v10.a
            if (r12 >= r0) goto L4c
            r6 = r3[r12]
            r5 = r5[r12]
            if (r6 == r5) goto L49
        ...
        Lba:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.N31.m(java.lang.String):java.util.ArrayList");
    }
    ...
    @Override // defpackage.K31
    public final void j(XmlPullParser xmlPullParser) throws L31 {
        int i = 0;
        ...
        if (iIntValue == 2) {
            ...
            c6475pX.k = AbstractC1865Xr0.n("video/mp4");
            c6475pX.r = K31.i(xmlPullParser, "MaxWidth");
            c6475pX.s = K31.i(xmlPullParser, "MaxHeight");
            c6475pX.o = arrayListM;
        } else if (iIntValue == 1) {
            if (str == null) {
                str = "audio/mp4a-latm";
            }
            int i2 = K31.i(xmlPullParser, "Channels");
            int i3 = K31.i(xmlPullParser, "SamplingRate");
            ArrayList arrayListM2 = m(xmlPullParser.getAttributeValue(null, "CodecPrivateData"));
            boolean zIsEmpty = arrayListM2.isEmpty();
            ArrayList arrayListSingletonList = arrayListM2;
            if (zIsEmpty) {
                arrayListSingletonList = arrayListM2;
                if ("audio/mp4a-latm".equals(str)) {
                    int i4 = -1;
                    for (int i5 = 0; i5 < 13; i5++) {
                        if (i3 == AbstractC1993Zi.a[i5]) {
                            i4 = i5;
                        }
                    }
                    int i6 = -1;
                    while (i < 16) {
                        if (i2 == AbstractC1993Zi.b[i]) {
                            i6 = i;
                        }
                        i++;
                    }
                    if (i3 == -1 || i6 == -1) {
                        throw new IllegalArgumentException(AbstractC8235ym.f(i3, "Invalid sample rate or number of channels: ", i2, ", "));
                    }
                    arrayListSingletonList = Collections.singletonList(AbstractC1993Zi.a(2, i4, i6));
                }
            }
            c6475pX.k = AbstractC1865Xr0.n("audio/mp4");
            c6475pX.z = i2;
            c6475pX.A = i3;
            c6475pX.o = arrayListSingletonList;
        } else if (iIntValue == 3) {
            ...
            c6475pX.k = AbstractC1865Xr0.n("application/mp4");
            c6475pX.f = i;
        } else {
            c6475pX.k = AbstractC1865Xr0.n("application/mp4");
        }
        c6475pX.a = xmlPullParser.getAttributeValue(null, "Index");
        c6475pX.b = (String) c("Name");
        c6475pX.l = AbstractC1865Xr0.n(str);
        c6475pX.g = K31.i(xmlPullParser, "Bitrate");
        c6475pX.d = (String) c("Language");
        this.e = new C6666qX(c6475pX);
    }
}
