...
public class MenuC2403br0 extends E6 implements Menu {
    public final MenuC0225Cq0 c;

    public MenuC2403br0(Context context, MenuC0225Cq0 menuC0225Cq0) {
        super(context);
    ...
    public final void removeGroup(int i) {
        if (((L01) this.b) != null) {
            ...
            while (true) {
                ...
                if (((InterfaceMenuItemC8301z61) l01.i(i2)).getGroupId() == i) {
                    ((L01) this.b).k(i2);
                    i2--;
                }
                i2++;
    ...
    public final void removeItem(int i) {
        if (((L01) this.b) != null) {
            ...
            while (true) {
                ...
                if (((InterfaceMenuItemC8301z61) l01.i(i2)).getItemId() == i) {
                    ((L01) this.b).k(i2);
                    break;
                }
                i2++;
