...
public final class C1172Ou0 extends AbstractC7507ux {
    public final C1094Nu0 j;
    public Network k;
    public NetworkCapabilities l;

    public C1172Ou0(ReactApplicationContext reactApplicationContext) {
        super(reactApplicationContext);
        this.k = null;
        this.l = null;
        this.j = new C1094Nu0(0, this);
    }
    ...
    public final void c() {
        ...
        try {
            this.k = connectivityManager.getActiveNetwork();
            f(0);
    ...
    public final void f(int i) {
        new Handler(Looper.getMainLooper()).postDelayed(new DE(26, this), i);
    }
    ...
    */
    public final void g() {
        ...
        L35:
            r8 = 0
            if (r0 == 0) goto L3e
            android.net.ConnectivityManager r9 = r11.a     // Catch: java.lang.SecurityException -> L3e
        ...
        La4:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.C1172Ou0.g():void");
    }
}
