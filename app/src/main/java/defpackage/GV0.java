...
public final class GV0 extends SQLiteOpenHelper {
    ...
    public static final List e = Arrays.asList(new FV0(0), new FV0(1), new FV0(2), new FV0(3), new FV0(4), new FV0(5), new FV0(6));
    public final int a;
    public boolean b;
    ...
    public static void a(SQLiteDatabase sQLiteDatabase, int i, int i2) throws SQLException {
        List list = e;
        if (i2 > list.size()) {
            StringBuilder sbM = AbstractC1705Vq.m("Migration from ", " to ", i, i2, " was requested, but cannot be performed. Only ");
            sbM.append(list.size());
            sbM.append(" migrations are provided");
            throw new IllegalArgumentException(sbM.toString());
        }
        while (i < i2) {
            switch (((FV0) list.get(i)).a) {
                case 0:
