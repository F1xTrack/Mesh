...
public abstract class N1 {
    public static P1 a(boolean z, int i, int i2, int i3, int i4, boolean z2, String str, String str2) {
    ...
    public static Q1 b(AccessibilityNodeInfo accessibilityNodeInfo, int i, int i2) {
        AccessibilityNodeInfo child = accessibilityNodeInfo.getChild(i, i2);
        if (child != null) {
            return new Q1(child, 0);
        }
        return null;
    }
    ...
    public static Q1 f(AccessibilityNodeInfo accessibilityNodeInfo, int i) {
        AccessibilityNodeInfo parent = accessibilityNodeInfo.getParent(i);
        if (parent != null) {
            return new Q1(parent, 0);
        }
        return null;
    }
