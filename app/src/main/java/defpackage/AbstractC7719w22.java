...
public abstract class AbstractC7719w22 {
    public static CallInvokerHolderImpl a(ReactApplicationContext reactApplicationContext) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        try {
            try {
    ...
    public static void b(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws DH1 {
        if (!f(b2)) {
  ...
  0x0016: PHI (r2v3 byte) = (r2v2 byte), (r2v9 byte) binds: [B:9:0x0011, B:11:0x0015] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public static void c(byte r2, byte r3, byte r4, char[] r5, int r6) throws defpackage.DH1 {
        /*
            boolean r0 = f(r3)
            if (r0 != 0) goto L2c
            r0 = -96
        ...
        L2c:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.AbstractC7719w22.c(byte, byte, byte, char[], int):void");
    }

    public static void d(byte b, byte b2, char[] cArr, int i) throws DH1 {
        if (b < -62 || f(b2)) {
            throw new DH1("Protocol message had invalid UTF-8.");
        }
