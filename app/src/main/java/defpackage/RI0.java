...
public abstract class RI0 {
    ...
    public static Uri a(ReactContext reactContext, File file) {
        ...
        for (int i = 0; i < arrayList.size(); i++) {
            try {
                uriD = FT.d(reactContext, (String) arrayList.get(i), file);
            } catch (Exception e) {
    ...
    */
    public static java.lang.String b(android.content.Context r9, android.net.Uri r10, java.lang.String r11, java.lang.String[] r12) throws java.lang.Throwable {
        /*
            ...
            android.database.Cursor r9 = r8.g()     // Catch: java.lang.Throwable -> L34 java.lang.Exception -> L36
            if (r9 == 0) goto L2e
        ...
        L46:
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.RI0.b(android.content.Context, android.net.Uri, java.lang.String, java.lang.String[]):java.lang.String");
    }
        ...
        if (DocumentsContract.isDocumentUri(context, uri)) {
            if ("com.android.externalstorage.documents".equals(uri.getAuthority())) {
                ...
                if (!TextUtils.isEmpty(str)) {
                    StringBuilder sbQ = AbstractC8235ym.q("/storage/", str, "/");
