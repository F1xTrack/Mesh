...
public abstract class GM1 {
    ...
    */
    public static double a(double r8, double r10, double r12, java.lang.String r14) {
        /*
            r0 = 2
            r1 = 0
        ...
        Lcb:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.GM1.a(double, double, double, java.lang.String):double");
    }

    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    public static double b(C8372zU0 c8372zU0, double d, double d2, double d3) {
        double d4;
        if (c8372zU0 == null) {
            return ConfigValue.DOUBLE_DEFAULT_VALUE;
        }
        int i = AbstractC8134yE0.a[c8372zU0.b.ordinal()];
        double d5 = c8372zU0.a;
        switch (i) {
            case 1:
            case 2:
                d3 = 1.0d;
    ...
    public static int f(ReadableArray readableArray, float[] fArr, float f) {
