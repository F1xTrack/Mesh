...
public final class C0770Jq {
    ...
    */
    public static int c(int r4, int r5, int r6, int r7) {
        /*
            r0 = 4
            defpackage.YN1.d(r4, r0)
            defpackage.YN1.d(r5, r0)
            defpackage.YN1.d(r6, r0)
            defpackage.YN1.d(r7, r0)
            r0 = 0
            r1 = 1
        ...
        L2e:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.C0770Jq.c(int, int, int, int):int");
    }
