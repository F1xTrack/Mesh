...
public final class C5780lu {
    ...
    public C5780lu(InputStream inputStream) {
        this.e = inputStream;
    }
    ...
    public final C1919Yj0 e() {
        int iK = k();
        int i = this.b;
        int i2 = this.d;
        if (iK > i - i2 || iK <= 0) {
            return iK == 0 ? AbstractC0596Hk.a : new C1919Yj0(h(iK));
        }
        byte[] bArr = new byte[iK];
        System.arraycopy(this.a, i2, bArr, 0, iK);
        C1919Yj0 c1919Yj0 = new C1919Yj0(bArr);
        this.d += iK;
        return c1919Yj0;
    }
    ...
    public final K0 g(InterfaceC5261jA0 interfaceC5261jA0, DR dr) throws Y90 {
        int iK = k();
        if (this.i >= 64) {
        ...
        int iD = d(iK);
        this.i++;
        K0 k0 = (K0) interfaceC5261jA0.a(this, dr);
        a(0);
        this.i--;
        c(iD);
        return k0;
    ...
    public final long j() throws Y90 {
        int i = this.d;
        if (this.b - i < 8) {
            p(8);
            i = this.d;
    ...
    */
    public final long l() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.C5780lu.l():long");
    }

    public final long m() throws Y90 {
        long j = 0;
    ...
    public final void p(int i) throws Y90 {
        if (!s(i)) {
            throw Y90.a();
        }
    }

    public final boolean q(int i, J9 j9) throws IOException {
        int iN;
        int i2 = i & 7;
        if (i2 == 0) {
            long jL = l();
    ...
    public final void r(int i) throws Y90 {
        int i2 = this.b;
        int i3 = this.d;
        int i4 = i2 - i3;
        if (i <= i4 && i >= 0) {
