...
public abstract class AbstractC7528v22 {
    public static final C0369Em0 a(List list) {
        Object obj;
        ArrayList arrayList = new ArrayList();
        for (Object obj2 : list) {
            String name = ((C0369Em0) obj2).a.getName();
        ...
        if (it.hasNext()) {
            Object next = it.next();
            if (it.hasNext()) {
                String name2 = ((C0369Em0) next).a.getName();
                O90.e(name2, "file.name");
                int i = Integer.parseInt(name2);
                do {
                    Object next2 = it.next();
                    String name3 = ((C0369Em0) next2).a.getName();
