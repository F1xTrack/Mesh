...
public abstract class AL0 {
    public static void a(String str) {
        ...
        ((DeviceEventManagerModule.RCTDeviceEventEmitter) C7394uL0.b.getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter.class)).emit("ReactNativeBlobUtilMessage", writableMapCreateMap);
    }
    ...
    public static String b(String str) {
        ...
        if (!DocumentsContract.isDocumentUri(reactApplicationContext, uri2)) {
            if (RemoteMessageConst.Notification.CONTENT.equalsIgnoreCase(uri2.getScheme())) {
                return "com.google.android.apps.photos.content".equals(uri2.getAuthority()) ? uri2.getLastPathSegment() : AbstractC3755fL1.a(reactApplicationContext, uri2, null, null);
            }
        ...
        if ("com.android.providers.downloads.documents".equals(uri2.getAuthority())) {
            try {
                ...
                if (documentId == null || !documentId.startsWith("raw:/")) {
                    return AbstractC3755fL1.a(reactApplicationContext, ContentUris.withAppendedId(Uri.parse("content://downloads/public_downloads"), ((documentId == null || !documentId.startsWith("msf:")) ? Long.valueOf(documentId) : Long.valueOf(documentId.split(StringUtils.PROCESS_POSTFIX_DELIMITER)[1])).longValue()), null, null);
                }
        ...
        if ("com.android.providers.media.documents".equals(uri2.getAuthority())) {
            ...
            return AbstractC3755fL1.a(reactApplicationContext, uri, "_id=?", new String[]{strArrSplit2[1]});
        }
        if (RemoteMessageConst.Notification.CONTENT.equalsIgnoreCase(uri2.getScheme())) {
            return "com.google.android.apps.photos.content".equals(uri2.getAuthority()) ? uri2.getLastPathSegment() : AbstractC3755fL1.a(reactApplicationContext, uri2, null, null);
        }
