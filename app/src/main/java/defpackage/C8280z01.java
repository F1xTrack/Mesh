...
public final class C8280z01 {
    ...
    public final C8280z01 a(int i) {
        ...
        return new C8280z01(iArr4, new Random(random.nextLong()));
    }

    public C8280z01(int[] iArr, Random random) {
        this.b = iArr;
        this.a = random;
