...
public abstract class AbstractC7255tc1 {
    ...
    public static boolean c(int i) {
        ...
        throw new IllegalArgumentException(AbstractC7209tN0.u(i, "Invalid rotation degrees: "));
    }
    ...
    public static Size g(Size size, int i) {
        AbstractC3377dM1.d("Invalid rotation degrees: " + i, i % 90 == 0);
