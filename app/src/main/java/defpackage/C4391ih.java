...
public final class C4391ih implements InterfaceC0502Ge1, L00, InterfaceC6625qJ0 {
    public final JavaScriptTypedArray a;

    public C4391ih(JavaScriptTypedArray javaScriptTypedArray) {
    ...
    public final Object get(int i) {
        ...
        return new C0037Af1(this.a.read8Byte(i * 8));
    }
