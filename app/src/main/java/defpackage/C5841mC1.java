...
public final class C5841mC1 implements GeofencingApi {
    ...
    public final PendingResult removeGeofences(GoogleApiClient googleApiClient, PendingIntent pendingIntent) {
        return googleApiClient.execute(new C2281bC1(googleApiClient, pendingIntent));
    }
    ...
    public final PendingResult removeGeofences(GoogleApiClient googleApiClient, List list) {
        return googleApiClient.execute(new C2471cC1(googleApiClient, list));
    }
}
