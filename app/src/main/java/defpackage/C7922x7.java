...
public final class C7922x7 {
    ...
    public final C7351u7 k;

    public C7922x7(TextView textView) {
        this.i = textView;
    ...
    public final int c(RectF rectF) {
        ...
        while (i3 <= i) {
            ...
            StaticLayout staticLayoutA = AbstractC7160t7.a(text, (Layout.Alignment) e(textView, Layout.Alignment.ALIGN_NORMAL, "getLayoutAlignment"), Math.round(rectF.right), maxLines, this.i, this.h, this.k);
