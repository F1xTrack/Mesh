...
public final class C6094nX0 extends SSLSocketFactory {
    public final SSLContext a;
    public String[] b;

    public C6094nX0(C8001xX0 c8001xX0) throws KeyManagementException {
        this.a = null;
        SSLContext sSLContext = Build.VERSION.SDK_INT >= 29 ? SSLContext.getInstance("TLSv1.3") : SSLContext.getInstance("TLSv1.2");
        this.a = sSLContext;
        sSLContext.init(null, new X509TrustManager[]{c8001xX0}, null);
    }
    ...
    public final Socket createSocket(String str, int i) throws IOException {
        ...
        if (socketCreateSocket instanceof SSLSocket) {
            ...
            this.b = (String[]) ((SSLSocket) socketCreateSocket).getEnabledCipherSuites().clone();
        }
