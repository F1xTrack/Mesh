...
public abstract class AbstractC3887g21 {
    ...
    public static final int a(S91 s91) throws Resources.NotFoundException {
        ...
        boolean zC = AbstractC2144aU1.c(s91);
        O90.f("Current IME: " + packageName, "message");
        Pair pair = (Pair) a.get(packageName);
        if (pair == null) {
        ...
        TypedArray typedArrayObtainStyledAttributes = s91.obtainStyledAttributes(iIntValue, OG0.a);
        ...
        try {
            ...
            return Color.argb(Color.alpha(color), AbstractC5686lO1.c(Color.red(color) + i, 0, KotlinVersion.MAX_COMPONENT_VALUE), AbstractC5686lO1.c(Color.green(color) + i, 0, KotlinVersion.MAX_COMPONENT_VALUE), AbstractC5686lO1.c(Color.blue(color) + i, 0, KotlinVersion.MAX_COMPONENT_VALUE));
        } catch (Throwable th) {
            typedArrayObtainStyledAttributes.recycle();
            throw th;
        }
