...
public abstract class AbstractC6284oX extends AbstractC1760Wi0 {
    public Drawable p;
    public final Rect q;
    public final Rect r;
    public int s;
    ...
    public AbstractC6284oX(Context context, AttributeSet attributeSet) {
        ...
        this.u = false;
        int[] iArr = NG0.j;
        DJ1.a(context, attributeSet, 0, 0);
        DJ1.b(context, attributeSet, iArr, 0, 0, new int[0]);
