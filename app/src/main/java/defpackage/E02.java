...
public abstract class E02 {
    ...
    */
    public static android.graphics.Matrix b(android.graphics.RectF r22, android.graphics.RectF r23, java.lang.String r24, int r25) {
        /*
            Method dump skipped, instructions count: 201
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.E02.b(android.graphics.RectF, android.graphics.RectF, java.lang.String, int):android.graphics.Matrix");
    }
    ...
    public static byte[] c(InputStream inputStream, int i) throws IOException {
        ...
        while (i2 < i) {
            ...
            if (i3 < 0) {
                throw new IllegalStateException(AbstractC7209tN0.u(i, "Not enough bytes to read: "));
            }
            i2 += i3;
        }
        return bArr;
