...
public abstract class AbstractC0300Dp0 {
    ...
    public static long c(long j, long j2) {
        ...
        throw new ArithmeticException(NX.i(AbstractC8235ym.p("overflow: checkedAdd(", j, ", "), j2, ")"));
    }
    ...
    public static long d(long j, long j2, RoundingMode roundingMode) {
        ...
        int i = ((int) ((j ^ j2) >> 63)) | 1;
        switch (AbstractC8233yl0.a[roundingMode.ordinal()]) {
            case 1:
                if (j4 == 0) {
                    return j3;
                }
    ...
    public static long e(long j, long j2) {
        AbstractC8451zu1.b(j, "a");
        AbstractC8451zu1.b(j2, "b");
        if (j == 0) {
            return j2;
        }
        if (j2 == 0) {
