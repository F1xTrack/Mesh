...
public final class I01 extends AbstractC1360Rf {
    public int n;
    public boolean o;
    public int p;
    public long q;
    ...
    public final C6675qa a(C6675qa c6675qa) throws C6865ra {
        if (c6675qa.c == 2) {
            return c6675qa.a == -1 ? C6675qa.e : c6675qa;
        }
    ...
    public final void m(boolean z) {
        ...
        if (i == bArr.length || z) {
            ...
            YN1.g(length % this.n == 0, "bytesConsumed is not aligned to frame size: %s" + length);
            YN1.f(i >= iL);
            this.u -= length;
    ...
    public final void n(int i, int i2) {
        ...
        YN1.b("sizeToOutput is not aligned to frame size: " + i, i % this.n == 0);
        YN1.f(this.t < this.s.length);
        byte[] bArr3 = this.v;
        YN1.b("byteOutput size is not aligned to frame size " + i, i % this.n == 0);
        if (i2 != 3) {
