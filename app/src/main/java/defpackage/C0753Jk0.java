...
public final class C0753Jk0 implements InterfaceC0831Kk0 {
    ...
    public C0753Jk0(Locale... localeArr) {
        ...
        for (int i = 0; i < localeArr.length; i++) {
            ...
            if (locale == null) {
                throw new NullPointerException(AbstractC8235ym.g(i, "list[", "] is null"));
            }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof C0753Jk0)) {
            return false;
        }
        Locale[] localeArr = ((C0753Jk0) obj).a;
