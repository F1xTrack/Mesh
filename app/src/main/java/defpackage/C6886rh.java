...
public final class C6886rh {
    public static final C6886rh d = new C6886rh(-3, -9223372036854775807L, -1);
    public static C6886rh e;
    public long a;
    public long b;
    public int c;

    public C6886rh(int i, long j, long j2) {
        this.c = i;
        this.a = j;
        this.b = j2;
    }
