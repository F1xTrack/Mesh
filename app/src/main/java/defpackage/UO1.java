...
public abstract class UO1 {
    public static Typeface a(Typeface typeface, int i, int i2, String str, AssetManager assetManager) {
        C7582vK0 c7582vK0 = new C7582vK0(i, i2);
        if (str != null) {
            if (CC0.g == null) {
                CC0.g = new CC0(2);
            }
            return CC0.g.Z0(str, c7582vK0, assetManager);
        }
        if (typeface == null) {
    ...
    public static Bitmap b(int i, byte[] bArr) throws IOException {
        int i2 = 0;
        Bitmap bitmapDecodeByteArray = BitmapFactory.decodeByteArray(bArr, 0, i, null);
        if (bitmapDecodeByteArray == null) {
            throw C5643lA0.a(new IllegalStateException(), "Could not decode image data");
        }
        ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(bArr);
        try {
            C7979xQ c7979xQ = new C7979xQ(byteArrayInputStream);
            byteArrayInputStream.close();
            switch (c7979xQ.f(1, "Orientation")) {
                case 3:
                case 4:
                    i2 = 180;
                    break;
    ...
    */
    public static int e(java.lang.String r2) {
        ...
        Laa:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.UO1.e(java.lang.String):int");
    }
}
