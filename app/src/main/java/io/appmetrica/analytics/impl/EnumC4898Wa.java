...
public enum EnumC4898Wa {
    ...
    /* renamed from: K */
    public static final HashMap f30948K = new HashMap();
    ...
    static {
        for (EnumC4898Wa enumC4898Wa : values()) {
            f30948K.put(Integer.valueOf(enumC4898Wa.f30974a), enumC4898Wa);
        }
    }

    EnumC4898Wa(int i, String str) {
        this.f30974a = i;
        this.f30975b = str;
    }

    /* renamed from: a */
    public final int m19947a() {
        return this.f30974a;
    }

    /* renamed from: a */
    public static EnumC4898Wa m19946a(int i) {
        EnumC4898Wa enumC4898Wa = (EnumC4898Wa) f30948K.get(Integer.valueOf(i));
        return enumC4898Wa == null ? EVENT_TYPE_UNDEFINED : enumC4898Wa;
    }
}
