...
public final class C5250kg implements Function {

    /* renamed from: a */
    public final /* synthetic */ C5534w0 f32077a;

    public C5250kg(C5534w0 c5534w0) {
        this.f32077a = c5534w0;
    }

    @Override // io.appmetrica.analytics.coreapi.internal.backport.Function
    public final Object apply(Object obj) {
        String str = (String) obj;
        C5534w0 c5534w0 = this.f32077a;
        ...
        C5013b4 c5013b4 = new C5013b4("", "", 5897, 0, orCreatePublicLogger);
        if (str != null) {
            c5013b4.m20149f(str);
        }
        c5013b4.f30773m = bundle;
        c5013b4.f30763c = this.f32077a.f32751f.f32792f;
        return c5013b4;
    }
}
