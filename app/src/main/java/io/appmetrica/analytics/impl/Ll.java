...
public final class Ll extends Sl {
    ...
    public final ProtobufStateStorage a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new C4454bf("startup_state", iBinaryDataHelper, new C4976x8(c5037zl, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArrA, bArrA2)), new C4607hl());
    }
