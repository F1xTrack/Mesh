...
public final class C5172hd implements Function {

    /* renamed from: a */
    public final C5197id f31856a;

    /* renamed from: b */
    public final C5147gd f31857b;

    public C5172hd(C5197id c5197id, C5147gd c5147gd) {
        this.f31856a = c5197id;
        this.f31857b = c5147gd;
    }
    ...
    */
    public final java.lang.String apply(java.io.File r5) {
        /*
            ...
            byte[] r1 = p000.NP1.m5672f(r5)     // Catch: java.lang.Throwable -> L1a
            io.appmetrica.analytics.impl.AbstractC5182hn.m20510a(r5)     // Catch: java.lang.Throwable -> L41
            goto L1e
        L19:
            r5 = r0
        L1a:
        ...
        L2a:
            if (r1 == 0) goto L41
            io.appmetrica.analytics.impl.gd r5 = r4.f31857b     // Catch: java.lang.Throwable -> L41
            io.appmetrica.analytics.impl.jd r2 = new io.appmetrica.analytics.impl.jd     // Catch: java.lang.Throwable -> L41
            io.appmetrica.analytics.impl.id r3 = r4.f31856a     // Catch: java.lang.Throwable -> L41
            ...
            java.lang.String r0 = io.appmetrica.analytics.coreutils.internal.p028io.Base64Utils.compressBase64(r5)     // Catch: java.lang.Throwable -> L41
        L41:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: io.appmetrica.analytics.impl.C5172hd.apply(java.io.File):java.lang.String");
    }
}
