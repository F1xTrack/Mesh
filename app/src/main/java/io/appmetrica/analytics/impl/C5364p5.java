...
public final class C5364p5 implements ModuleAdRevenueProcessor, ModuleAdRevenueProcessorsHolder {

    /* renamed from: a */
    public final ArrayList f32381a = new ArrayList();

    @Override // io.appmetrica.analytics.modulesapi.internal.client.adrevenue.ModuleAdRevenueProcessor
    public final String getDescription() {
        return AbstractC7167xu.m25962H(this.f32381a, null, "Composite processor with " + this.f32381a.size() + " children: [", "]", C5339o5.f32318a, 25);
    }
    ...
    public final boolean process(Object... objArr) {
        ...
        Iterator it = this.f32381a.iterator();
        while (true) {
            if (!it.hasNext()) {
                next = null;
                break;
    ...
    public final void register(ModuleAdRevenueProcessor moduleAdRevenueProcessor) {
        this.f32381a.add(moduleAdRevenueProcessor);
    }
}
