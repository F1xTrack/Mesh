...
public final class C5402qi {
    ...
    */
    public static io.appmetrica.analytics.coreapi.internal.model.ScreenInfo m20978a(android.content.Context r5) {
        /*
            r0 = 30
            r1 = 0
            boolean r0 = io.appmetrica.analytics.coreutils.internal.AndroidUtils.isApiAchieved(r0)     // Catch: java.lang.Throwable -> L2f
            if (r0 == 0) goto Le
            android.view.Display r0 = p000.AbstractC8329Tn1.m7756d(r5)     // Catch: java.lang.Throwable -> Le
            goto Lf
        Le:
            r0 = r1
        Lf:
        ...
        L1d:
            ...
            io.appmetrica.analytics.impl.pi r4 = new io.appmetrica.analytics.impl.pi     // Catch: java.lang.Throwable -> L2f
        ...
        L52:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: io.appmetrica.analytics.impl.C5402qi.m20978a(android.content.Context):io.appmetrica.analytics.coreapi.internal.model.ScreenInfo");
    }
}
