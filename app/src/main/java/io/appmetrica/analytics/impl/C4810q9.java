...
public final class C4810q9 extends MessageNano {
    public static volatile C4810q9[] e;
    public boolean a;
    public int b;
    public int c;
    public int[] d;
    ...
    public final C4810q9 mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
    ...
    public static C4810q9 b(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new C4810q9().mergeFrom(codedInputByteBufferNano);
    }

    public static C4810q9 a(byte[] bArr) throws InvalidProtocolBufferNanoException {
