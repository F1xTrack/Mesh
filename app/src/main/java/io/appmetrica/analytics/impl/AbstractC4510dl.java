...
public abstract class AbstractC4510dl {
    public static final Set a = defpackage.J8.F(new String[]{"appmetrica_clids", "appmetrica_device_id_hash", StartupParamsCallback.APPMETRICA_DEVICE_ID, "appmetrica_get_ad_url", "appmetrica_report_ad_url", StartupParamsCallback.APPMETRICA_UUID});
    ...
    */
    public static final boolean a(io.appmetrica.analytics.impl.C4583gl r5, java.util.Collection r6, java.util.Map r7, defpackage.InterfaceC5908mZ r8) {
        /*
            r0 = 1
            if (r6 == 0) goto Lad
        ...
        L4c:
            ...
            goto L8d
        L55:
            io.appmetrica.analytics.impl.T3 r1 = io.appmetrica.analytics.impl.AbstractC4510dl.c
        ...
        L8d:
            ...
            if (r1 != 0) goto Lac
            long r1 = r5.o
            io.appmetrica.analytics.impl.El r3 = r5.A
            int r3 = r3.a
            long r3 = (long) r3
            long r1 = r1 + r3
            io.appmetrica.analytics.coreutils.internal.time.SystemTimeProvider r3 = io.appmetrica.analytics.impl.AbstractC4510dl.b
        ...
        Lad:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: io.appmetrica.analytics.impl.AbstractC4510dl.a(io.appmetrica.analytics.impl.gl, java.util.Collection, java.util.Map, mZ):boolean");
    }
}
