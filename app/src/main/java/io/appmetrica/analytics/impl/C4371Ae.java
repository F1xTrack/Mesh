...
public final class C4371Ae implements InterfaceC5252ki {

    /* renamed from: a */
    public final Context f29852a;

    /* renamed from: b */
    public final String f29853b = "content://" + m19198a() + "/preload_info";

    /* renamed from: c */
    public final String f29854c = "tracking_id";

    /* renamed from: d */
    public final String f29855d = "additional_parameters";

    public C4371Ae(Context context) {
        this.f29852a = context;
    }

    /* renamed from: a */
    public final String m19198a() {
    ...
    */
    public final io.appmetrica.analytics.impl.C4543He invoke() {
        /*
            r11 = this;
            r0 = 1
            android.content.Context r1 = r11.f29852a
            ...
            io.appmetrica.analytics.impl.AbstractC5527vi.m21161a(r1, r0)
            return r2
        L15:
            android.content.Context r1 = r11.f29852a     // Catch: java.lang.Throwable -> La6
            android.content.ContentResolver r4 = r1.getContentResolver()     // Catch: java.lang.Throwable -> La6
            java.lang.String r1 = r11.f29853b     // Catch: java.lang.Throwable -> La6
            ...
            if (r4 == 0) goto L96
            java.lang.String r4 = r11.f29854c     // Catch: java.lang.Throwable -> La7
            ...
            java.lang.String r4 = r11.f29855d     // Catch: java.lang.Throwable -> La7
            int r4 = r1.getColumnIndexOrThrow(r4)     // Catch: java.lang.Throwable -> La7
        ...
        L6f:
            ...
            io.appmetrica.analytics.impl.AbstractC5527vi.m21161a(r0, r3)     // Catch: java.lang.Throwable -> La7
            goto La7
        L77:
            ...
            io.appmetrica.analytics.impl.AbstractC5527vi.m21161a(r4, r5)     // Catch: java.lang.Throwable -> La7
            io.appmetrica.analytics.impl.He r3 = new io.appmetrica.analytics.impl.He     // Catch: java.lang.Throwable -> La7
            boolean r4 = android.text.TextUtils.isEmpty(r6)     // Catch: java.lang.Throwable -> La7
            r8 = r4 ^ 1
            io.appmetrica.analytics.impl.P7 r10 = io.appmetrica.analytics.impl.EnumC4728P7.f30606d     // Catch: java.lang.Throwable -> La7
            r9 = 0
            r5 = r3
            r5.<init>(r6, r7, r8, r9, r10)     // Catch: java.lang.Throwable -> La7
            io.appmetrica.analytics.impl.AbstractC5182hn.m20509a(r1)
            return r3
        L96:
        ...
        La7:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: io.appmetrica.analytics.impl.C4371Ae.invoke():io.appmetrica.analytics.impl.He");
    }
}
