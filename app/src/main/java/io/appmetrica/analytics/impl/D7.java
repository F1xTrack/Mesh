...
public final class D7 implements InterfaceC4860sc {
    public Location a;
    public Boolean b;
    public Boolean c;
    ...
    public final void a(boolean z) {
        ...
        if (nh != null) {
            Boolean bool = this.c;
            if (hn.a(boolValueOf)) {
                nh.a.b.setLocationTracking(z);
            }
            if (hn.a(bool)) {
                nh.a.b.setDataSendingEnabled(bool.booleanValue());
            }
            T5 t5A = T5.a();
            T4 t4 = nh.a;
    ...
    public final void setDataSendingEnabled(boolean z) {
        ...
        if (nh != null) {
            Boolean bool = this.b;
            if (hn.a(bool)) {
                nh.a.b.setLocationTracking(bool.booleanValue());
            }
            if (hn.a(boolValueOf)) {
                nh.a.b.setDataSendingEnabled(z);
            }
            T5 t5A = T5.a();
            T4 t4 = nh.a;
            nh.a(Nh.a(t5A, t4), t4, 1, null);
