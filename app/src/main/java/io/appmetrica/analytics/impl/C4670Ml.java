...
public final class C4670Ml extends AbstractC4813Sl {
    ...
    public final ProtobufStateStorage mo19602a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new C5024bf("app_permissions_state", iBinaryDataHelper, new C5567x8(c4961z1, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArrM21182a, bArrM21182a2)), new C4865V1(new C4409C2()));
    }
