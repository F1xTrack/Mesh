...
public final class C4923v3 implements CacheControlHttpsConnectionPerformer.Client {
    public final NetworkClientWithCacheControl a;

    public C4923v3(NetworkClientWithCacheControl networkClientWithCacheControl) {
