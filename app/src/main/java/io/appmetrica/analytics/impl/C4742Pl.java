...
public final class C4742Pl extends AbstractC4813Sl {
    ...
    public final ProtobufStateStorage mo19602a(Context context, IBinaryDataHelper iBinaryDataHelper) {
        ...
        return new C5024bf("clids_info", iBinaryDataHelper, new C5567x8(c4724p3, new AESEncrypter(AESEncrypter.DEFAULT_ALGORITHM, bArrM21182a, bArrM21182a2)), new C4604K3());
    }
