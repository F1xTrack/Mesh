...
public final class C4716mb implements Ea, Closeable {
    public final HashMap a = new HashMap();
    public final HashMap b = new HashMap();
    public final String c = "preferences";
    public final C4692lb d;
    public volatile boolean e;
    public final InterfaceC4998y6 f;

    public C4716mb(InterfaceC4998y6 interfaceC4998y6) {
        this.f = interfaceC4998y6;
        Locale locale = Locale.US;
        C4692lb c4692lb = new C4692lb(this, AbstractC7209tN0.u(ThreadFactoryC4477cd.a(), "IAA-DW-"));
        this.d = c4692lb;
        c4692lb.start();
    }
    ...
    */
    public static void a(io.appmetrica.analytics.impl.C4716mb r13) {
        /*
            ...
            r13.getClass()
            r3 = 0
            io.appmetrica.analytics.impl.y6 r4 = r13.f     // Catch: java.lang.Throwable -> L85
        ...
        L86:
            ...
            io.appmetrica.analytics.impl.y6 r13 = r13.f
            r13.a(r4)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: io.appmetrica.analytics.impl.C4716mb.a(io.appmetrica.analytics.impl.mb):void");
    }
    ...
    public static void a(C4716mb c4716mb, HashMap map) {
                ...
                try {
                    ...
                    for (int i2 = 0; i2 < size; i2++) {
                        ...
                        if (contentValues2.getAsString("value") == null) {
                            sQLiteDatabaseA.delete(c4716mb.c, "key = ?", new String[]{contentValues2.getAsString("key")});
                        } else {
                            sQLiteDatabaseA.insertWithOnConflict(c4716mb.c, null, contentValues2, 5);
                        }
                    }
    ...
    @Override // io.appmetrica.analytics.impl.Ea
    public final synchronized Ea a(String str, String str2) {
        a(str, (Object) str2);
        return this;
    }
    ...
    @Override // io.appmetrica.analytics.impl.Ea
    public final synchronized Ea a(int i, String str) {
