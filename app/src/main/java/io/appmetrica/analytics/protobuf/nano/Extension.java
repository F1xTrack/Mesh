...
public class Extension<M extends ExtendableMessageNano<M>, T> {
    ...
    public /* synthetic */ Extension(int i, Class cls, int i2, boolean z, C56841 c56841) {
        this(i, cls, i2, z);
    }
    ...
    public Object readData(CodedInputByteBufferNano codedInputByteBufferNano) {
        ...
        try {
            ...
            throw new IllegalArgumentException(AbstractC11153tN0.m24910v(componentType, "Error creating instance of class "), e2);
        } catch (InstantiationException e3) {
            throw new IllegalArgumentException(AbstractC11153tN0.m24910v(componentType, "Error creating instance of class "), e3);
        }
    }
