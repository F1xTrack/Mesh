    ...
    public final void run() {
        ...
        while (this.b.isRunning() && zOnCreateNetworkTask && exponentialBackoffPolicy.canBeExecuted(this.a.getRetryPolicyConfig())) {
            ...
            if (networkTask.onPerformRequest()) {
                ...
                if (url == null || TextUtils.isEmpty(AbstractC7538v51.Y(url).toString())) {
                    ...
                    while (it.hasNext()) {
                        ...
                        builderAddHeader.addHeader((String) entry.getKey(), AbstractC8069xu.H((Iterable) entry.getValue(), StringUtils.COMMA, null, null, null, 62));
                    }
