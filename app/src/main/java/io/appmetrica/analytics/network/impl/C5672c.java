...
public final class C5672c implements Call {

    /* renamed from: a */
    public final NetworkClient f33058a;

    /* renamed from: b */
    public final Request f33059b;

    /* renamed from: c */
    public final C5673d f33060c;

    public C5672c(NetworkClient networkClient, Request request, C5673d c5673d) {
        this.f33058a = networkClient;
        this.f33059b = request;
        this.f33060c = c5673d;
    }

    /* renamed from: a */
    public final void m21288a(HttpsURLConnection httpsURLConnection) throws ProtocolException {
        Iterator<T> it = this.f33059b.getHeaders().entrySet().iterator();
        while (it.hasNext()) {
            Map.Entry entry = (Map.Entry) it.next();
            httpsURLConnection.addRequestProperty((String) entry.getKey(), (String) entry.getValue());
        }
        Integer readTimeout = this.f33058a.getReadTimeout();
        if (readTimeout != null) {
            httpsURLConnection.setReadTimeout(readTimeout.intValue());
        }
        Integer connectTimeout = this.f33058a.getConnectTimeout();
        if (connectTimeout != null) {
            httpsURLConnection.setConnectTimeout(connectTimeout.intValue());
        }
        Boolean useCaches = this.f33058a.getUseCaches();
        if (useCaches != null) {
            httpsURLConnection.setUseCaches(useCaches.booleanValue());
        }
        Boolean instanceFollowRedirects = this.f33058a.getInstanceFollowRedirects();
        if (instanceFollowRedirects != null) {
            httpsURLConnection.setInstanceFollowRedirects(instanceFollowRedirects.booleanValue());
        }
        httpsURLConnection.setRequestMethod(this.f33059b.getMethod());
        SSLSocketFactory sslSocketFactory = this.f33058a.getSslSocketFactory();
    ...
    */
    public final io.appmetrica.analytics.network.internal.Response execute() {
        /*
            r15 = this;
            io.appmetrica.analytics.network.impl.d r0 = r15.f33060c     // Catch: java.lang.Throwable -> Lc9
            io.appmetrica.analytics.network.internal.Request r1 = r15.f33059b     // Catch: java.lang.Throwable -> Lc9
        ...
        L23:
            ...
            r0.<init>(r1)
            io.appmetrica.analytics.network.internal.Request r1 = r15.f33059b
        ...
        L49:
            ...
            byte[] r3 = new byte[r1]
            byte[] r4 = new byte[r1]
            r15.m21288a(r0)     // Catch: java.lang.Throwable -> Lb7
            io.appmetrica.analytics.network.internal.Request r5 = r15.f33059b     // Catch: java.lang.Throwable -> Lb7
            java.lang.String r5 = r5.getMethod()     // Catch: java.lang.Throwable -> Lb7
            java.lang.String r6 = "POST"
            boolean r5 = p000.O90.m5963a(r5, r6)     // Catch: java.lang.Throwable -> Lb7
            r6 = 1
            if (r5 == 0) goto L84
            r0.setDoOutput(r6)     // Catch: java.lang.Throwable -> Lb7
            java.io.OutputStream r5 = r0.getOutputStream()     // Catch: java.lang.Throwable -> Lb7
            if (r5 == 0) goto L84
            io.appmetrica.analytics.network.internal.Request r7 = r15.f33059b     // Catch: java.lang.Throwable -> L79
            ...
            p000.AbstractC8729aT1.m9749a(r5, r2)     // Catch: java.lang.Throwable -> Lb7
            goto L84
        L79:
            r6 = move-exception
        ...
        L7b:
            r7 = move-exception
            p000.AbstractC8729aT1.m9749a(r5, r6)     // Catch: java.lang.Throwable -> Lb7
        ...
        L84:
            ...
            io.appmetrica.analytics.network.internal.NetworkClient r8 = r15.f33058a     // Catch: java.lang.Throwable -> Lb1
            ...
            byte[] r3 = io.appmetrica.analytics.network.impl.AbstractC5674e.m21290a(r8, r9)     // Catch: java.lang.Throwable -> Lb1
            io.appmetrica.analytics.network.internal.NetworkClient r8 = r15.f33058a     // Catch: java.lang.Throwable -> Lb1
            int r8 = r8.getMaxResponseSize()     // Catch: java.lang.Throwable -> Lb1
            io.appmetrica.analytics.network.impl.b r9 = new io.appmetrica.analytics.network.impl.b     // Catch: java.lang.Throwable -> Lb1
            r9.<init>(r0)     // Catch: java.lang.Throwable -> Lb1
            byte[] r4 = io.appmetrica.analytics.network.impl.AbstractC5674e.m21290a(r8, r9)     // Catch: java.lang.Throwable -> Lb1
            r14 = r2
            r11 = r3
            r12 = r4
            r10 = r5
        ...
        Lc9:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: io.appmetrica.analytics.network.impl.C5672c.execute():io.appmetrica.analytics.network.internal.Response");
    }

    public C5672c(NetworkClient networkClient, Request request) {
        this(networkClient, request, new C5673d());
    }
}
