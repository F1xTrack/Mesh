...
public final class CollectionUtils {
    ...
    public static final <T> List<T> arrayListCopyOfNullableCollection(Collection<? extends T> input) {
        if (input != null) {
            return AbstractC7167xu.m25982b0(input);
        }
        return null;
    }
    ...
    public static final <T> T getFromMapIgnoreCase(Map<String, ? extends T> map, String key) {
        ...
        while (true) {
            ...
            if (charSequence != null && charSequence.length() != 0 && D51.m1551j((String) entry.getKey(), key)) {
                break;
            }
        }
    ...
    public static final Set<Integer> hashSetFromIntArray(int[] input) {
        O90.m5968f(input, "<this>");
        HashSet hashSet = new HashSet(AbstractC11205tn0.m24983b(input.length));
        for (int i : input) {
    ...
    public static final <K, V> Map<K, V> mapCopyOfNullableMap(Map<K, ? extends V> input) {
        if (input != null) {
            return AbstractC11077sn0.m24787o(input);
        }
        return null;
    }
    ...
    public static final List<Integer> toIntList(int[] array) {
        return AbstractC0576J8.m4172C(array);
    }
    ...
    public static final <T> Set<T> unmodifiableSetOf(T... values) {
        O90.m5968f(values, "<this>");
        HashSet hashSet = new HashSet(AbstractC11205tn0.m24983b(values.length));
        AbstractC0576J8.m4171B(values, hashSet);
