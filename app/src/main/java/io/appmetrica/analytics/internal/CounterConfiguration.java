...
public class CounterConfiguration implements Parcelable {
    public static final Parcelable.Creator<CounterConfiguration> CREATOR = new C5634b();

    /* renamed from: a */
    private final ContentValues f32945a;
    ...
    private void m21253a(String str) {
        if (AbstractC5182hn.m20511a(str)) {
            setApiKey(str);
        }
    }

    /* renamed from: b */
    private void m21256b(String str) {
    ...
    /* renamed from: c */
    private void m21257c(Integer num) {
        if (AbstractC5182hn.m20511a(num)) {
            this.f32945a.put("MAX_REPORTS_IN_DB_COUNT", num);
        }
    }

    /* renamed from: d */
    private void m21258d(Integer num) {
        if (AbstractC5182hn.m20511a(num)) {
    ...
    public synchronized void applyFromConfig(AppMetricaConfig appMetricaConfig) {
        try {
            m21253a(appMetricaConfig.apiKey);
            m21258d(appMetricaConfig.sessionTimeout);
            if (AbstractC5182hn.m20511a(appMetricaConfig.location)) {
            ...
            if (AbstractC5182hn.m20511a(appMetricaConfig.deviceType)) {
                setDeviceType(appMetricaConfig.deviceType);
            }
            m21252a(appMetricaConfig.dispatchPeriodSeconds);
            m21255b(appMetricaConfig.maxReportsCount);
            m21254b(appMetricaConfig.logs);
            ...
            m21251a(appMetricaConfig.dataSendingEnabled);
            m21257c(appMetricaConfig.maxReportsInDatabaseCount);
            Boolean bool = appMetricaConfig.nativeCrashReporting;
            if (AbstractC5182hn.m20511a(bool)) {
                this.f32945a.put("CFG_NATIVE_CRASHES_ENABLED", bool);
            }
    ...
    public String getApiKey() {
        return this.f32945a.getAsString("CFG_API_KEY");
    }

    public String getAppBuildNumber() {
        return this.f32945a.getAsString("CFG_APP_VERSION_CODE");
    }

    public String getAppVersion() {
        return this.f32945a.getAsString("CFG_APP_VERSION");
    }

    public Boolean getDataSendingEnabled() {
        return this.f32945a.getAsBoolean("CFG_DATA_SENDING_ENABLED");
    }

    public String getDeviceType() {
        return this.f32945a.getAsString("CFG_DEVICE_SIZE_TYPE");
    }

    public Integer getDispatchPeriod() {
        return this.f32945a.getAsInteger("CFG_DISPATCH_PERIOD");
    }

    public Location getManualLocation() {
        if (this.f32945a.containsKey("CFG_MANUAL_LOCATION")) {
            return LocationUtils.bytesToLocation(this.f32945a.getAsByteArray("CFG_MANUAL_LOCATION"));
        }
        return null;
    }

    public Integer getMaxReportsCount() {
        return this.f32945a.getAsInteger("CFG_MAX_REPORTS_COUNT");
    }

    public Integer getMaxReportsInDbCount() {
        return this.f32945a.getAsInteger("MAX_REPORTS_IN_DB_COUNT");
    }

    public Boolean getReportNativeCrashesEnabled() {
        return this.f32945a.getAsBoolean("CFG_NATIVE_CRASHES_ENABLED");
    }

    public CounterConfigurationReporterType getReporterType() {
        return CounterConfigurationReporterType.fromStringValue(this.f32945a.getAsString("CFG_REPORTER_TYPE"));
    }

    public Integer getSessionTimeout() {
        return this.f32945a.getAsInteger("CFG_SESSION_TIMEOUT");
    }

    public String getUuid() {
        return this.f32945a.getAsString("CFG_UUID");
    }

    public Boolean isFirstActivationAsUpdate() {
        return this.f32945a.getAsBoolean("CFG_IS_FIRST_ACTIVATION_AS_UPDATE");
    }

    public Boolean isLocationTrackingEnabled() {
        return this.f32945a.getAsBoolean("CFG_LOCATION_TRACKING");
    }

    public Boolean isLogEnabled() {
        return this.f32945a.getAsBoolean("CFG_IS_LOG_ENABLED");
    }

    public synchronized Boolean isRevenueAutoTrackingEnabled() {
        return this.f32945a.getAsBoolean("CFG_REVENUE_AUTO_TRACKING_ENABLED");
    }

    public synchronized void setApiKey(String str) {
        this.f32945a.put("CFG_API_KEY", str);
    }

    public synchronized void setAppBuildNumber(int i) {
        this.f32945a.put("CFG_APP_VERSION_CODE", String.valueOf(i));
    }

    public final synchronized void setCustomAppVersion(String str) {
        this.f32945a.put("CFG_APP_VERSION", str);
    }

    public final synchronized void setDataSendingEnabled(boolean z) {
        this.f32945a.put("CFG_DATA_SENDING_ENABLED", Boolean.valueOf(z));
    }

    public final synchronized void setDeviceType(String str) {
        ContentValues contentValues = this.f32945a;
    ...
    public synchronized void setDispatchPeriod(int i) {
        this.f32945a.put("CFG_DISPATCH_PERIOD", Integer.valueOf(i));
    }

    public final synchronized void setFirstActivationAsUpdate(boolean z) {
        this.f32945a.put("CFG_IS_FIRST_ACTIVATION_AS_UPDATE", Boolean.valueOf(z));
    }

    public synchronized void setLocationTracking(boolean z) {
        this.f32945a.put("CFG_LOCATION_TRACKING", Boolean.valueOf(z));
    }

    public synchronized void setLogEnabled(boolean z) {
        this.f32945a.put("CFG_IS_LOG_ENABLED", Boolean.valueOf(z));
    }

    public final synchronized void setManualLocation(Location location) {
        this.f32945a.put("CFG_MANUAL_LOCATION", LocationUtils.locationToBytes(location));
    }
    ...
    public void setMaxReportsInDbCount(int i) {
        this.f32945a.put("MAX_REPORTS_IN_DB_COUNT", Integer.valueOf(i));
    }

    public synchronized void setReporterType(CounterConfigurationReporterType counterConfigurationReporterType) {
        this.f32945a.put("CFG_REPORTER_TYPE", counterConfigurationReporterType.getStringValue());
    }

    public synchronized void setRevenueAutoTrackingEnabled(boolean z) {
        this.f32945a.put("CFG_REVENUE_AUTO_TRACKING_ENABLED", Boolean.valueOf(z));
    }

    public synchronized void setSessionTimeout(int i) {
        this.f32945a.put("CFG_SESSION_TIMEOUT", Integer.valueOf(i));
    }

    public synchronized void setUuid(String str) {
        this.f32945a.put("CFG_UUID", str);
    }
    ...
    public synchronized String toString() {
        return "CounterConfiguration{mParamsMapping=" + this.f32945a + '}';
    }

    @Override // android.os.Parcelable
    public synchronized void writeToParcel(Parcel parcel, int i) {
        Bundle bundle = new Bundle();
        bundle.putParcelable("io.appmetrica.analytics.internal.CounterConfiguration.data", this.f32945a);
        parcel.writeBundle(bundle);
    }

    public CounterConfiguration(CounterConfiguration counterConfiguration) {
        synchronized (counterConfiguration) {
            this.f32945a = new ContentValues(counterConfiguration.f32945a);
        }
    }

    /* renamed from: a */
    private void m21252a(Integer num) {
        if (AbstractC5182hn.m20511a(num)) {
    ...
    /* renamed from: b */
    private void m21255b(Integer num) {
        if (AbstractC5182hn.m20511a(num)) {
    ...
    /* renamed from: a */
    private void m21251a(Boolean bool) {
        if (AbstractC5182hn.m20511a(bool)) {
    ...
    /* renamed from: b */
    private void m21254b(Boolean bool) {
        if (AbstractC5182hn.m20511a(bool)) {
    ...
    public CounterConfiguration() {
        this.f32945a = new ContentValues();
    }
    ...
    public CounterConfiguration(ReporterConfig reporterConfig) {
        this();
        synchronized (this) {
            m21253a(reporterConfig.apiKey);
            m21258d(reporterConfig.sessionTimeout);
            m21252a(reporterConfig.dispatchPeriodSeconds);
            m21255b(reporterConfig.maxReportsCount);
            m21254b(reporterConfig.logs);
            m21251a(reporterConfig.dataSendingEnabled);
            m21257c(reporterConfig.maxReportsInDatabaseCount);
            m21256b(reporterConfig.apiKey);
        }
    }

    private CounterConfiguration(ContentValues contentValues) {
        this.f32945a = contentValues;
    }
}
