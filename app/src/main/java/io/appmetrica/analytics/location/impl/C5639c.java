...
public final class C5639c implements LastKnownLocationExtractorProvider {

    /* renamed from: a */
    public final String f32959a;

    public C5639c(String str) {
        this.f32959a = str;
    }
    ...
    public final LastKnownLocationExtractor getExtractor(Context context, PermissionExtractor permissionExtractor, IHandlerExecutor iHandlerExecutor, LocationListener locationListener) {
        return new C5638b(context, new SinglePermissionStrategy(permissionExtractor, "android.permission.ACCESS_COARSE_LOCATION"), locationListener, iHandlerExecutor);
    }
