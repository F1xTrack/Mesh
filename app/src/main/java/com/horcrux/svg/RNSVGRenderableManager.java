...
@InterfaceC9101dL0(name = "RNSVGRenderableModule")
...
class RNSVGRenderableManager extends NativeSvgRenderableModuleSpec {
    ...
    public WritableMap getBBox(Double d, ReadableMap readableMap) {
        ...
        try {
            ...
            writableMapCreateMap.putDouble(Snapshot.WIDTH, rectF.width() / f);
            writableMapCreateMap.putDouble(Snapshot.HEIGHT, rectF.height() / f);
    ...
    public WritableMap getCTM(Double d) {
        ...
        writableMapCreateMap.putDouble(UcumUtils.UCUM_DAYS, r6[4]);
        writableMapCreateMap.putDouble("e", r6[2] / f);
    ...
    public void getRawResource(String str, Promise promise) throws Resources.NotFoundException, IOException {
        try {
            ...
            InputStream inputStreamOpenRawResource = resources.openRawResource(resources.getIdentifier(str, Core.RAW, reactApplicationContext.getPackageName()));
            try {
    ...
    public WritableMap getScreenCTM(Double d) {
        ...
        writableMapCreateMap.putDouble(UcumUtils.UCUM_DAYS, r0[4]);
        writableMapCreateMap.putDouble("e", r0[2] / f);
