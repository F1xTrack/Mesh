...
public class Snapshot {
    ...
    public Snapshot(View view, C11856yu0 c11856yu0) {
        ...
        try {
            this.viewManager = c11856yu0.resolveViewManager(view.getId());
            this.parentViewManager = c11856yu0.resolveViewManager(this.parent.getId());
        } catch (C8810b60 | NullPointerException unused) {
        }
    ...
    private void addBasicConfig(HashMap<String, Object> map) {
        ...
        map.put(BORDER_RADIUS, Float.valueOf(this.borderRadii.full));
        map.put(BORDER_TOP_LEFT_RADIUS, Float.valueOf(this.borderRadii.topLeft));
        map.put(BORDER_TOP_RIGHT_RADIUS, Float.valueOf(this.borderRadii.topRight));
        map.put(BORDER_BOTTOM_LEFT_RADIUS, Float.valueOf(this.borderRadii.bottomLeft));
        map.put(BORDER_BOTTOM_RIGHT_RADIUS, Float.valueOf(this.borderRadii.bottomRight));
    }
    ...
    private View findTransformedView(View view) {
        ...
        while (true) {
            ...
            z = !zEquals;
            if (!zEquals || view2.getClass().getSimpleName().equals("RV0")) {
                break;
            }
            z2 = z;
        }
    ...
    public Snapshot(View view) {
        ...
        if (viewFindTransformedView != null) {
            ...
            int i2 = this.width;
            this.originX = (int) (f - ((i2 - (viewFindTransformedView.getScaleX() * i2)) / 2.0f));
            float f2 = this.originY;
            int i3 = this.height;
            this.originY = (int) (f2 - ((i3 - (viewFindTransformedView.getScaleY() * i3)) / 2.0f));
        }
