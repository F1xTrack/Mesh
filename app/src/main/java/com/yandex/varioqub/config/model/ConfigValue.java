...
@Metadata(m22266d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0006\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0015\u0018\u0000  2\u00020\u0001:\u0001 B%\b\u0000\u0012\b\u0010\u0013\u001a\u0004\u0018\u00010\u0002\u0012\u0006\u0010\u0018\u001a\u00020\f\u0012\b\b\u0002\u0010\u001d\u001a\u00020\b¢\u0006\u0004\b\u001e\u0010\u001fJ\u0006\u0010\u0003\u001a\u00020\u0002J\u0006\u0010\u0005\u001a\u00020\u0004J\u0006\u0010\u0007\u001a\u00020\u0006J\u0006\u0010\t\u001a\u00020\bJ\u0013\u0010\u000b\u001a\u00020\u00062\b\u0010\n\u001a\u0004\u0018\u00010\u0001H\u0096\u0002J\b\u0010\r\u001a\u00020\fH\u0016J\b\u0010\u000e\u001a\u00020\u0002H\u0016R\u0019\u0010\u0013\u001a\u0004\u0018\u00010\u00028\u0006¢\u0006\f\n\u0004\b\u000f\u0010\u0010\u001a\u0004\b\u0011\u0010\u0012R\u0017\u0010\u0018\u001a\u00020\f8\u0006¢\u0006\f\n\u0004\b\u0014\u0010\u0015\u001a\u0004\b\u0016\u0010\u0017R\u0017\u0010\u001d\u001a\u00020\b8\u0006¢\u0006\f\n\u0004\b\u0019\u0010\u001a\u001a\u0004\b\u001b\u0010\u001c¨\u0006!"}, m22267d2 = {"Lcom/yandex/varioqub/config/model/ConfigValue;", "", "", "asString", "", "asDouble", "", "asBoolean", "", "asLong", "other", "equals", "", "hashCode", "toString", "a", "Ljava/lang/String;", "getValue", "()Ljava/lang/String;", "value", "b", "I", "getSourceType", "()I", "sourceType", "c", "J", "getTestId", "()J", "testId", "<init>", "(Ljava/lang/String;IJ)V", "Companion", "config_release"}, m22268k = 1, m22269mv = {1, 6, 0})
...
public final class ConfigValue {
    ...
    public final boolean asBoolean() {
        ...
        throw new IllegalArgumentException(AbstractC1374Vq.m8593l(new StringBuilder("Value "), this.value, " cannot be converted to type Boolean"));
    }
    ...
    public final double asDouble() {
        ...
        try {
            ...
            throw new IllegalArgumentException(AbstractC1374Vq.m8593l(new StringBuilder("Value "), this.value, " cannot be converted to type Double"));
        }
    }
    ...
    public final long asLong() {
        ...
        try {
            ...
            throw new IllegalArgumentException(AbstractC1374Vq.m8593l(new StringBuilder("Value "), this.value, " cannot be converted to type Long"));
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!ConfigValue.class.equals(other != null ? other.getClass() : null)) {
            return false;
        }
        if (other == null) {
        ...
        return O90.m5963a(this.value, configValue.value) && this.sourceType == configValue.sourceType && this.testId == configValue.testId;
    }
    ...
    public int hashCode() {
        String str = this.value;
        int iHashCode = (((str != null ? str.hashCode() : 0) * 31) + this.sourceType) * 31;
        long j = this.testId;
    ...
    public String toString() {
        ...
        sb.append(", testId=");
        return AbstractC11153tN0.m24913y(sb, this.testId, ')');
    }
