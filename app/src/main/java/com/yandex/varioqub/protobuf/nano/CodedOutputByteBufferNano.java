...
public final class CodedOutputByteBufferNano {
    ...
    public static int computeFieldSize(int i, int i2, Object obj) {
        switch (i2) {
            ...
            default:
                throw new IllegalArgumentException(AbstractC11153tN0.m24909u(i2, "Unknown type: "));
        }
    }
            ...
            if (cCharAt < 2048) {
                ...
                if (55296 <= cCharAt && cCharAt <= 57343) {
                    if (Character.codePointAt(charSequence, i) < 65536) {
                        throw new IllegalArgumentException(AbstractC11153tN0.m24909u(i, "Unpaired surrogate at index "));
                    }
                    i++;
                }
            }
    ...
    public void writeField(int i, int i2, Object obj) throws IOException {
        switch (i2) {
            ...
            case 18:
                ...
                return;
            default:
                throw new IOException(AbstractC11153tN0.m24909u(i2, "Unknown type: "));
        }
    }
