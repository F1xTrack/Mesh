...
public class CompassHeadingSubscription implements SensorEventListener {
    ...
    private static native void headingChanged(NativeObject nativeObject, float f, float f2, float f3, long j, long j2);
    ...
    private void sendHeading(int i, long j) {
        ...
        headingChanged(this.nativeObject, fNormalizeAngle, normalizeAngle(getDeclination() + fNormalizeAngle), i, TimeHelpers.eventNanosToTimestampMills(j), TimeHelpers.eventNanosToMills(j));
    }
