...
class GLRenderThread extends Thread {
    ...
    private void initGL() {
        ...
        checkEglError("eglMakeCurrent() failed");
        this.f25552gl = (GL10) this.eglContext.getGL();
    }
    ...
    */
    public void run() {
        /*
            ...
            javax.microedition.khronos.opengles.GL10 r1 = r4.f25552gl
        ...
        L2d:
            ...
            javax.microedition.khronos.opengles.GL10 r2 = r4.f25552gl     // Catch: java.lang.Throwable -> L16
        ...
        L4a:
            ...
            javax.microedition.khronos.opengles.GL10 r2 = r4.f25552gl
            r1.onDrawFrame(r2)
            if (r0 != 0) goto Lc
