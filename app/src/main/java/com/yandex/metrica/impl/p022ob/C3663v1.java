...
public class C3663v1 {
    /* renamed from: b */
    private Location m16941b(String str) {
    ...
    /* renamed from: c */
    private PreloadInfo m16942c(String str) throws JSONException {
        if (TextUtils.isEmpty(str)) {
            return null;
        }
        JSONObject jSONObject = new JSONObject(str);
        PreloadInfo.Builder builderNewBuilder = PreloadInfo.newBuilder(jSONObject.has("trackid") ? jSONObject.optString("trackid") : null);
        HashMap<String, String> mapM17298d = C3762ym.m17298d(jSONObject.optString("params"));
        if (mapM17298d != null && mapM17298d.size() > 0) {
    ...
    /* renamed from: a */
    public String m16944a(YandexMetricaConfig yandexMetricaConfig) {
        String string;
        try {
            ...
            jSONObject.put("location", m16940a(yandexMetricaConfig.location));
            ...
            if (preloadInfo == null) {
                ...
                try {
                    ...
                    jSONObject2.put("params", C3762ym.m17302e(preloadInfo.getAdditionalParams()));
            ...
            jSONObject.put("error_environment", C3762ym.m17302e(yandexMetricaConfig.errorEnvironment));
    ...
    /* renamed from: a */
    public YandexMetricaConfig m16943a(String str) {
        YandexMetricaConfig yandexMetricaConfig;
        HashMap<String, String> mapM17298d;
        if (TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                builderNewConfigBuilder.withLocation(m16941b(jSONObject.optString("location")));
                builderNewConfigBuilder.withPreloadInfo(m16942c(jSONObject.optString("preload_info")));
                ...
                if (jSONObject.has("error_environment") && (mapM17298d = C3762ym.m17298d(jSONObject.optString("error_environment"))) != null) {
                    for (Map.Entry<String, String> entry : mapM17298d.entrySet()) {
    ...
    /* renamed from: a */
    private String m16940a(Location location) {
        if (location == null) {
            return null;
        }
        try {
