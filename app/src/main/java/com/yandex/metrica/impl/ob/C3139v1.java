...
public class C3139v1 {
    ...
    private PreloadInfo c(String str) throws JSONException {
        ...
        HashMap<String, String> mapD = C3240ym.d(jSONObject.optString("params"));
        ...
        try {
            ...
            if (preloadInfo == null) {
                ...
                try {
                    ...
                    jSONObject2.put("params", C3240ym.e(preloadInfo.getAdditionalParams()));
            ...
            jSONObject.put("error_environment", C3240ym.e(yandexMetricaConfig.errorEnvironment));
    ...
    public YandexMetricaConfig a(String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                if (jSONObject.has("error_environment") && (mapD = C3240ym.d(jSONObject.optString("error_environment"))) != null) {
                    for (Map.Entry<String, String> entry : mapD.entrySet()) {
