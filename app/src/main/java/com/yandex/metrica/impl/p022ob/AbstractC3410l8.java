...
public abstract class AbstractC3410l8 {

    /* renamed from: a */
    private static final C2742L0 f24184a = new C2742L0();

    /* renamed from: a */
    public static String[] m16386a(Context context, String str) throws PackageManager.NameNotFoundException {
        try {
            PackageInfo packageInfo = context.getPackageManager().getPackageInfo(context.getPackageName(), (C2968U2.m15243a(24) ? 8192 : 0) | 1024);
