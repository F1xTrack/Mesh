...
public enum EnumC3377k1 {
    ...
    /* renamed from: d0 */
    static final HashMap<Integer, EnumC3377k1> f23874d0 = new HashMap<>();
    ...
    static {
        EnumC3377k1[] enumC3377k1ArrValues = values();
        for (int i = 0; i < 53; i++) {
            EnumC3377k1 enumC3377k1 = enumC3377k1ArrValues[i];
            f23874d0.put(Integer.valueOf(enumC3377k1.f23898a), enumC3377k1);
        }
    }

    EnumC3377k1(int i, String str) {
        this.f23898a = i;
        this.f23899b = str;
    }

    /* renamed from: a */
    public String m16249a() {
        return this.f23899b;
    }
    ...
    /* renamed from: a */
    public static EnumC3377k1 m16248a(int i) {
        EnumC3377k1 enumC3377k1 = f23874d0.get(Integer.valueOf(i));
        return enumC3377k1 == null ? EVENT_TYPE_UNDEFINED : enumC3377k1;
    }
}
