...
public enum EnumC2865k1 {
    ...
    static final HashMap<Integer, EnumC2865k1> d0 = new HashMap<>();
    private final int a;
    private final String b;

    static {
        EnumC2865k1[] enumC2865k1ArrValues = values();
        for (int i = 0; i < 53; i++) {
            EnumC2865k1 enumC2865k1 = enumC2865k1ArrValues[i];
            d0.put(Integer.valueOf(enumC2865k1.a), enumC2865k1);
        }
    }

    EnumC2865k1(int i, String str) {
        this.a = i;
        this.b = str;
    }
    ...
    public static EnumC2865k1 a(int i) {
        EnumC2865k1 enumC2865k1 = d0.get(Integer.valueOf(i));
        return enumC2865k1 == null ? EVENT_TYPE_UNDEFINED : enumC2865k1;
    }
}
