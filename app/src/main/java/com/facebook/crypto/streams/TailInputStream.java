...
public class TailInputStream extends FilterInputStream {
    ...
    private int readTail(byte[] bArr, int i, int i2) throws IOException {
        ...
        if (i2 < i3) {
            ...
            int i6 = ((FilterInputStream) this).in.read(this.mTail, i5, this.mTailTength - i5);
            if (i6 != -1) {
                return extractTail(bArr, i2, i6 + i5, i);
            }
        ...
        int i7 = ((FilterInputStream) this).in.read(bArr, this.mCount + i, i2 - i3);
        if (i7 == -1) {
            this.mEOF = true;
            return -1;
        }
        int i8 = this.mCount;
        if (i8 > 0) {
            System.arraycopy(this.mTail, 0, bArr, i, i8);
        }
        int i9 = this.mCount + i7;
        int i10 = ((FilterInputStream) this).in.read(this.mTail, 0, this.mTailTength);
        if (i10 == -1) {
            this.mEOF = true;
        } else {
            i4 = i10;
        }
        return extractTail(bArr, i9, i4, i);
    }
