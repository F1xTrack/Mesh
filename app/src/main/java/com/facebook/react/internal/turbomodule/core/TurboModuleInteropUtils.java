...
class TurboModuleInteropUtils {
        ...
        for (Method method : methodsFromModule) {
            ...
            if (reactMethod != null || "getConstants".equals(name2)) {
                if (hashSet.contains(name2)) {
                    throw new ParsingException(name, AbstractC7222ym.m26245v("Module exports two methods to JavaScript with the same name: \"", name2));
                }
                hashSet.add(name2);
    ...
    public static class ParsingException extends RuntimeException {
        public ParsingException(String str, String str2) {
            super(AbstractC1374Vq.m8590i("Unable to parse @ReactMethod annotations from native module: ", str, ". Details: ", str2));
        }

        /* JADX WARN: Illegal instructions before constructor call */
        public ParsingException(String str, String str2, String str3) {
            StringBuilder sbM2541x = F91.m2541x("Unable to parse @ReactMethod annotation from native module method: ", str, ".", str2, "(). Details: ");
            sbM2541x.append(str3);
            super(sbM2541x.toString());
        }
    }
}
