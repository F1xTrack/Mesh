...
public class Arguments {
    ...
    public class C18821 extends AbstractList {
        final /* synthetic */ Object val$objects;

        public C18821(Object obj) {
            obj = obj;
        }
    ...
    public static /* synthetic */ class C18832 {
            ...
            if (obj == null) {
                ...
                if (cls == Boolean.class) {
                    ...
                    if (cls != WritableNativeArray.class) {
                        throw new RuntimeException(AbstractC11153tN0.m24910v(cls, "Cannot convert argument of type "));
                    }
    ...
    public static Bundle toBundle(ReadableMap readableMap) {
        ...
        while (readableMapKeySetIteratorKeySetIterator.hasNextKey()) {
            ...
            switch (C18832.$SwitchMap$com$facebook$react$bridge$ReadableType[readableMap.getType(strNextKey).ordinal()]) {
                case 1:
                ...
                case 6:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException(AbstractC7222ym.m26234k("Could not convert object with key: ", strNextKey, "."));
            }
        }
        return bundle;
    }
    ...
    public static ArrayList toList(ReadableArray readableArray) {
        ...
        for (int i = 0; i < readableArray.size(); i++) {
            switch (C18832.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i).ordinal()]) {
                case 1:
                    arrayList.add(null);
                    break;
                case 2:
