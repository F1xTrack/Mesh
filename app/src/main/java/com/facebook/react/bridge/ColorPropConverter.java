...
public class ColorPropConverter {
    ...
    public static Integer getColor(Object obj, Context context) {
        ...
        try {
            ...
            AbstractC3929dS.m17685r("Error extracting color from WideGamut", new Object[0]);
        }
    ...
    private static int resolveResource(Context context, String str) {
        ...
        int identifier = context.getResources().getIdentifier(strArrSplit2[1], str2, packageName);
        Resources resources = context.getResources();
        Resources.Theme theme = context.getTheme();
        ThreadLocal threadLocal = ES0.f2702a;
        return AS0.m183a(resources, identifier, theme);
    }
    ...
    public static Integer getColor(Object obj, Context context, int i) {
        try {
            ...
            AbstractC3929dS.m17685r("Error converting ColorValue", new Object[0]);
