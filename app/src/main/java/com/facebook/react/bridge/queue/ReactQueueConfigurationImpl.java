...
public class ReactQueueConfigurationImpl implements ReactQueueConfiguration {
    ...
    public static ReactQueueConfigurationImpl create(ReactQueueConfigurationSpec reactQueueConfigurationSpec, QueueThreadExceptionHandler queueThreadExceptionHandler) {
        ...
        map.put(messageQueueThreadSpecMainThreadSpec, messageQueueThreadImplCreate);
        MessageQueueThreadImpl messageQueueThreadImplCreate2 = (MessageQueueThreadImpl) map.get(reactQueueConfigurationSpec.getJSQueueThreadSpec());
        ...
        MessageQueueThreadImpl messageQueueThreadImplCreate3 = (MessageQueueThreadImpl) map.get(reactQueueConfigurationSpec.getNativeModulesQueueThreadSpec());
