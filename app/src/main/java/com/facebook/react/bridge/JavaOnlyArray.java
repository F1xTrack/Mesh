...
public class JavaOnlyArray implements ReadableArray, WritableArray {
    ...
    public static JavaOnlyArray deepClone(ReadableArray readableArray) {
        ...
        for (int i = 0; i < size; i++) {
            switch (C19001.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i).ordinal()]) {
                case 1:
    ...
    /* renamed from: of */
    public static JavaOnlyArray m10961of(Object... objArr) {
    ...
    public long getLong(int i) {
        return ((Number) this.mBackingList.get(i)).longValue();
    }
    ...
    public void pushLong(long j) {
        this.mBackingList.add(Long.valueOf(j));
    }
