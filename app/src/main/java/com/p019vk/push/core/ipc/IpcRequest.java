...
public abstract class IpcRequest<T, V> {
    ...
    public static final class AsyncRequest<T, V> extends IpcRequest<T, V> {
        ...
        public AsyncRequest(Function2 function2, String str, Function2 function22, Logger logger, InterfaceC6497nZ interfaceC6497nZ, InterfaceC0493Hp interfaceC0493Hp) {
            super(interfaceC6497nZ, interfaceC0493Hp, str, null);
            O90.m5968f(function2, "ipcCall");
            O90.m5968f(str, "ipcCallName");
            O90.m5968f(function22, "transformSuccessResult");
            O90.m5968f(logger, "logger");
            O90.m5968f(interfaceC6497nZ, "transformErrorResult");
            O90.m5968f(interfaceC0493Hp, "continuation");
        ...
        @Override // com.p019vk.push.core.ipc.IpcRequest
        public void execute(T service, final AppInfo host, final InterfaceC6497nZ onRequestFinished) {
            O90.m5968f(host, "host");
            O90.m5968f(onRequestFinished, "onRequestFinished");
            ...
            this.ipcCall.invoke(service, new AsyncCallback.Stub() { // from class: com.vk.push.core.ipc.IpcRequest$AsyncRequest$execute$1
                ...
                public void onResult(AidlResult<?> result) {
                    Object objInvoke;
                    O90.m5968f(result, "result");
                    Exception excExceptionOrNull = result.exceptionOrNull();
                    IpcRequest.AsyncRequest asyncRequest = this.f20459a;
    ...
    public static final class SimpleRequest<T, V> extends IpcRequest<T, V> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public SimpleRequest(Function2 function2, String str, Logger logger, InterfaceC6497nZ interfaceC6497nZ, InterfaceC0493Hp interfaceC0493Hp) {
            super(interfaceC6497nZ, interfaceC0493Hp, str, null);
            O90.m5968f(function2, "ipcCall");
            O90.m5968f(str, "ipcCallName");
            O90.m5968f(logger, "logger");
        ...
        @Override // com.p019vk.push.core.ipc.IpcRequest
        public void execute(T service, AppInfo host, InterfaceC6497nZ onRequestFinished) {
            O90.m5968f(host, "host");
            O90.m5968f(onRequestFinished, "onRequestFinished");
            Logger.DefaultImpls.info$default(this.logger, getIpcCallName() + " ipc request is starting", null, 2, null);
    ...
    public IpcRequest(InterfaceC6497nZ interfaceC6497nZ, InterfaceC0493Hp interfaceC0493Hp, String str, DefaultConstructorMarker defaultConstructorMarker) {
        this.transformErrorResult = interfaceC6497nZ;
        this.continuation = interfaceC0493Hp;
        this.ipcCallName = str;
    }

    public static /* synthetic */ void execute$default(IpcRequest ipcRequest, Object obj, AppInfo appInfo, InterfaceC6497nZ interfaceC6497nZ, int i, Object obj2) throws RemoteException {
        if (obj2 != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: execute");
        }
        if ((i & 4) != 0) {
            interfaceC6497nZ = C6228jI.f35024F;
        }
        ipcRequest.execute(obj, appInfo, interfaceC6497nZ);
    }

    public abstract void execute(T service, AppInfo host, InterfaceC6497nZ onRequestFinished) throws RemoteException;

    public final InterfaceC0493Hp getContinuation() {
    ...
    public final InterfaceC6497nZ getTransformErrorResult() {
