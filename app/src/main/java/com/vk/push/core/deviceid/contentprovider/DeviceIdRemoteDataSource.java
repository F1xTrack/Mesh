...
@Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0000\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005J\"\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006H\u0096@ø\u0001\u0000ø\u0001\u0001ø\u0001\u0002ø\u0001\u0002¢\u0006\u0004\b\b\u0010\t\u0082\u0002\u000f\n\u0002\b!\n\u0005\b¡\u001e0\u0001\n\u0002\b\u0019¨\u0006\u000b"}, d2 = {"Lcom/vk/push/core/deviceid/contentprovider/DeviceIdRemoteDataSource;", "Lcom/vk/push/core/deviceid/DeviceIdReadOnlyDataSource;", "Landroid/content/Context;", "context", "<init>", "(Landroid/content/Context;)V", "LPS0;", "", "getDeviceId-IoAF18A", "(LVy;)Ljava/lang/Object;", "getDeviceId", "core_release"}, k = 1, mv = {1, 7, 1}, xi = 48)
...
public final class DeviceIdRemoteDataSource implements DeviceIdReadOnlyDataSource {
    ...
    public static final boolean access$hasProvider(DeviceIdRemoteDataSource deviceIdRemoteDataSource, PackageInfo packageInfo) {
        ...
        for (ProviderInfo providerInfo : providerInfoArr) {
            ...
            O90.e(str2, "it.packageName");
            if (O90.a(str, companion.getAuthority(str2))) {
                return true;
            }
        }
        return false;
    ...
    public static Uri b(String str) {
        ...
        O90.e(uriBuild, "Builder().scheme(\"conten…ty))\n            .build()");
        return uriBuild;
    }
  ...
  0x0079: PHI (r7v4 android.database.Cursor) = (r7v3 android.database.Cursor), (r7v10 android.database.Cursor) binds: [B:86:0x0085, B:79:0x0077] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public final java.lang.Object a(java.lang.String r6, defpackage.InterfaceC1729Vy r7) throws java.lang.Throwable {
        /*
            r5 = this;
            boolean r0 = r7 instanceof defpackage.C5478kJ
            if (r0 == 0) goto L13
            r0 = r7
            kJ r0 = (defpackage.C5478kJ) r0
            int r1 = r0.d
        ...
        L18:
            ...
            if (r2 == 0) goto L36
            if (r2 != r3) goto L2e
            com.vk.push.core.deviceid.contentprovider.DeviceIdRemoteDataSource r6 = r0.a
            defpackage.RQ1.d(r7)     // Catch: java.lang.Throwable -> L2a java.lang.Exception -> L2c
            goto L5a
        L2a:
            r6 = move-exception
            goto L7f
        ...
        L36:
            ...
            r0.a = r5     // Catch: java.lang.Throwable -> L2a java.lang.Exception -> L2c
            r0.d = r3     // Catch: java.lang.Throwable -> L2a java.lang.Exception -> L2c
            r2 = 10000(0x2710, double:4.9407E-320)
            java.lang.Object r7 = defpackage.GY1.a(r2, r7, r0)     // Catch: java.lang.Throwable -> L2a java.lang.Exception -> L2c
            if (r7 != r1) goto L59
            return r1
        L59:
            r6 = r5
        ...
        L88:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.vk.push.core.deviceid.contentprovider.DeviceIdRemoteDataSource.a(java.lang.String, Vy):java.lang.Object");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public java.lang.Object mo74getDeviceIdIoAF18A(defpackage.InterfaceC1729Vy r8) {
        /*
            r7 = this;
            boolean r0 = r8 instanceof defpackage.C5287jJ
            if (r0 == 0) goto L13
            r0 = r8
            jJ r0 = (defpackage.C5287jJ) r0
            int r1 = r0.e
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r3 = r1 & r2
            if (r3 == 0) goto L13
        ...
        L18:
            ...
            com.vk.push.core.deviceid.contentprovider.DeviceIdRemoteDataSource r4 = r0.a
        ...
        L36:
            defpackage.RQ1.d(r8)
            android.content.Context r8 = r7.a     // Catch: java.lang.Throwable -> L2b
            ...
            defpackage.O90.e(r8, r2)     // Catch: java.lang.Throwable -> L2b
            java.lang.Iterable r8 = (java.lang.Iterable) r8     // Catch: java.lang.Throwable -> L2b
            M8 r8 = defpackage.AbstractC8069xu.t(r8)     // Catch: java.lang.Throwable -> L2b
            ...
            jI r8 = defpackage.C5284jI.o     // Catch: java.lang.Throwable -> L2b
            Ac1 r8 = defpackage.AbstractC4175hY0.l(r2, r8)     // Catch: java.lang.Throwable -> L2b
        ...
        L72:
            ...
            android.content.Context r6 = r4.a     // Catch: java.lang.Throwable -> L2b
            java.lang.String r6 = r6.getPackageName()     // Catch: java.lang.Throwable -> L2b
            boolean r6 = defpackage.O90.a(r8, r6)     // Catch: java.lang.Throwable -> L2b
            if (r6 == 0) goto L8d
            return r5
        L8d:
            java.lang.String r5 = "packageName"
            defpackage.O90.e(r8, r5)     // Catch: java.lang.Throwable -> L2b
            r0.a = r4     // Catch: java.lang.Throwable -> L2b
            r0.b = r2     // Catch: java.lang.Throwable -> L2b
            r0.e = r3     // Catch: java.lang.Throwable -> L2b
            java.lang.Object r8 = r4.a(r8, r0)     // Catch: java.lang.Throwable -> L2b
            if (r8 != r1) goto L9f
            return r1
        L9f:
            java.lang.String r8 = (java.lang.String) r8     // Catch: java.lang.Throwable -> L2b
        ...
        La5:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.vk.push.core.deviceid.contentprovider.DeviceIdRemoteDataSource.mo74getDeviceIdIoAF18A(Vy):java.lang.Object");
    }
}
