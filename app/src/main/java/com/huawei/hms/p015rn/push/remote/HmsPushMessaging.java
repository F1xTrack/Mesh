package com.huawei.hms.p015rn.push.remote;
...
import com.huawei.hms.p015rn.push.utils.MapUtils;
...
public class HmsPushMessaging extends ReactContextBaseJavaModule implements ActivityEventListener, LifecycleEventListener {
    ...
    public static /* synthetic */ void lambda$subscribe$2(Promise promise, Task task) {
        if (task.mo8877g()) {
            ...
            HMSLogger.getInstance(getContext()).sendSingleEvent("subscribe", task.mo8874d().getMessage());
            ResultUtils.handleResult(false, task.mo8874d().getLocalizedMessage(), promise);
        }
    }
    ...
    public static /* synthetic */ void lambda$turnOffPush$1(Promise promise, Task task) {
        if (task.mo8877g()) {
            ...
            HMSLogger.getInstance(getContext()).sendSingleEvent("turnOffPush", task.mo8874d().getMessage());
            ResultUtils.handleResult(false, task.mo8874d().getLocalizedMessage(), promise);
        }
    }
    ...
    public static /* synthetic */ void lambda$turnOnPush$0(Promise promise, Task task) {
        if (task.mo8877g()) {
            ...
            HMSLogger.getInstance(getContext()).sendSingleEvent("turnOnPush", task.mo8874d().getMessage());
            ResultUtils.handleResult(false, task.mo8874d().getLocalizedMessage(), promise);
        }
    }
    ...
    public static /* synthetic */ void lambda$unsubscribe$3(Promise promise, Task task) {
        if (task.mo8877g()) {
            ...
            HMSLogger.getInstance(getContext()).sendSingleEvent("unsubscribe", task.mo8874d().getMessage());
            ResultUtils.handleResult(false, task.mo8874d().getLocalizedMessage(), promise);
        }
    }
    ...
    public void subscribe(String str, Promise promise) {
        ...
        try {
            HmsMessaging.getInstance(ActivityUtils.getRealActivity(getCurrentActivity(), getContext())).subscribe(str).mo8871a(new I30(5, promise));
        } catch (Exception e) {
            ResultUtils.handleResult(false, e.getLocalizedMessage(), promise);
        }
    }
    ...
    public void turnOffPush(Promise promise) {
        ...
        try {
            HmsMessaging.getInstance(ActivityUtils.getRealActivity(getCurrentActivity(), getContext())).turnOffPush().mo8871a(new I30(4, promise));
        } catch (Exception e) {
            ResultUtils.handleResult(false, e.getLocalizedMessage(), promise);
        }
    }
    ...
    public void turnOnPush(Promise promise) {
        ...
        try {
            HmsMessaging.getInstance(ActivityUtils.getRealActivity(getCurrentActivity(), getContext())).turnOnPush().mo8871a(new I30(3, promise));
        } catch (Exception e) {
            ResultUtils.handleResult(false, e.getLocalizedMessage(), promise);
        }
    }
    ...
    public void unsubscribe(String str, Promise promise) {
        ...
        try {
            HmsMessaging.getInstance(ActivityUtils.getRealActivity(getCurrentActivity(), getContext())).unsubscribe(str).mo8871a(new I30(2, promise));
        } catch (Exception e) {
            ResultUtils.handleResult(false, e.getLocalizedMessage(), promise);
        }
    }
