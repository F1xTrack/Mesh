...
import com.huawei.hms.p015rn.push.receiver.HmsLocalNotificationScheduledPublisher;
import com.huawei.hms.p015rn.push.utils.BundleUtils;
import com.huawei.hms.p015rn.push.utils.NotificationConfigUtils;
...
public class HmsLocalNotificationController {
    ...
    private PendingIntent buildScheduleNotificationIntent(Bundle bundle) throws NumberFormatException {
        try {
            int i = Integer.parseInt(BundleUtils.get(bundle, NotificationConstants.f19487ID));
    ...
    private void createChannel(NotificationManager notificationManager, String str, String str2, String str3, Uri uri, int i, long[] jArr) {
        if (Build.VERSION.SDK_INT >= 26 && notificationManager != null && notificationManager.getNotificationChannel(str) == null) {
            ...
            NotificationChannel notificationChannelM10644d = AbstractC8962cI0.m10644d(i, str, str2);
            notificationChannelM10644d.setDescription(str3);
            notificationChannelM10644d.enableLights(true);
            notificationChannelM10644d.enableVibration(true);
            notificationChannelM10644d.setVibrationPattern(jArr);
            if (uri != null) {
                notificationChannelM10644d.setSound(uri, new AudioAttributes.Builder().setContentType(4).setUsage(5).build());
            } else {
                notificationChannelM10644d.setSound(null, null);
            }
            notificationManager.createNotificationChannel(notificationChannelM10644d);
        }
    }
    ...
    public void cancelNotificationsWithIdTag(ReadableArray readableArray) {
        for (int i = 0; i < readableArray.size(); i++) {
            ...
            String string = map.getString(NotificationConstants.f19487ID);
    ...
    public void checkRequiredParams(Bundle bundle, Promise promise, String str) {
        ...
        } else if (BundleUtils.get(bundle, NotificationConstants.f19487ID) == null) {
            if (promise != null) {
    ...
    public WritableArray getScheduledNotifications() {
        ...
        while (it.hasNext()) {
            try {
                ...
                WritableMap writableMapCreateMap = Arguments.createMap();
                writableMapCreateMap.putString(NotificationConstants.f19487ID, notificationAttributesFromJson.getId());
    ...
    */
    public void lambda$localNotificationNow$0(android.os.Bundle r33, android.graphics.Bitmap r34, android.graphics.Bitmap r35, com.facebook.react.bridge.Promise r36) throws org.json.JSONException, java.lang.NumberFormatException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huawei.hms.p015rn.push.local.HmsLocalNotificationController.lambda$localNotificationNow$0(android.os.Bundle, android.graphics.Bitmap, android.graphics.Bitmap, com.facebook.react.bridge.Promise):void");
    }
