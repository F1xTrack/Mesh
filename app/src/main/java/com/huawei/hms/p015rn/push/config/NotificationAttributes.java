package com.huawei.hms.p015rn.push.config;
...
public class NotificationAttributes {
    ...
    public NotificationAttributes(Bundle bundle) {
        this.f19486id = BundleUtils.get(bundle, NotificationConstants.f19487ID);
    ...
    public Bundle toBundle() {
        ...
        BundleUtils.set(bundle, NotificationConstants.f19487ID, this.f19486id);
    ...
    public JSONObject toJson() throws JSONException {
        ...
        try {
            jSONObject.put(NotificationConstants.f19487ID, this.f19486id);
    ...
    private NotificationAttributes(JSONObject jSONObject) {
        try {
            this.f19486id = jSONObject.has(NotificationConstants.f19487ID) ? jSONObject.getString(NotificationConstants.f19487ID) : null;
