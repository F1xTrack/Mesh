...
public class Util {
    ...
    /* renamed from: a */
    private static boolean f19664a = false;
    ...
    public static String getAppName(Context context, String str) {
        if (context == null) {
            HMSLog.m12620e("Util", "In getAppName, context is null.");
            return "";
        }
        PackageManager packageManager = context.getPackageManager();
        if (packageManager == null) {
            HMSLog.m12620e("Util", "In getAppName, Failed to get 'PackageManager' instance.");
            return "";
        }
        try {
            if (TextUtils.isEmpty(str)) {
            ...
            HMSLog.m12620e("Util", "In getAppName, Failed to get app name.");
            return "";
        }
    }
    ...
    public static int getHmsVersion(Context context) {
        ...
        PackageManager packageManager = context.getPackageManager();
        if (packageManager == null) {
            HMSLog.m12620e("Util", "In getHmsVersion, Failed to get 'PackageManager' instance.");
            return 0;
        }
        try {
            ...
            HMSLog.m12622i("Util", "In getHmsVersion, Failed to read meta data for the HMS VERSION.");
            return 0;
        } catch (AndroidException unused) {
            HMSLog.m12620e("Util", "In getHmsVersion, Failed to read meta data for the HMS VERSION.");
            return 0;
        } catch (RuntimeException e) {
            HMSLog.m12621e("Util", "In getHmsVersion, Failed to read meta data for the HMS VERSION.", e);
            return 0;
        }
    }
    ...
    public static String getServiceActionMetadata(Context context) {
        ...
        try {
            ...
            AbstractC0852NX.m5766o(e, new StringBuilder("Exception when getServiceActionMetadata. "), "Util");
            resolveInfoResolveService = null;
        }
        if (resolveInfoResolveService != null) {
            f19667d = PackageConstants.INTERNAL_SERVICES_ACTION;
    ...
    public static boolean isAvailableLibExist(Context context) {
        ...
        synchronized (f19666c) {
            if (!f19664a) {
                PackageManager packageManager = context.getPackageManager();
                if (packageManager == null) {
                    HMSLog.m12620e("Util", "In isAvailableLibExist, Failed to get 'PackageManager' instance.");
                } else {
                    try {
                        ApplicationInfo applicationInfo = packageManager.getPackageInfo(context.getPackageName(), 128).applicationInfo;
                        if (applicationInfo != null && (bundle = applicationInfo.metaData) != null && (obj = bundle.get("availableLoaded")) != null && String.valueOf(obj).equalsIgnoreCase("yes")) {
                            HMSLog.m12622i("Util", "available exist: true");
                        }
                    } catch (AndroidException unused) {
                        HMSLog.m12620e("Util", "In isAvailableLibExist, Failed to read meta data for the availableLoaded.");
                    } catch (RuntimeException e) {
                        HMSLog.m12621e("Util", "In isAvailableLibExist, Failed to read meta data for the availableLoaded.", e);
                    }
                    z = false;
                    f19665b = z;
                    f19664a = true;
        ...
        HMSLog.m12622i("Util", "available exist: " + f19665b);
        return f19665b;
    }
    ...
    public static void unBindServiceCatchException(Context context, ServiceConnection serviceConnection) {
        try {
            HMSLog.m12622i("Util", "Trying to unbind service from " + serviceConnection);
            context.unbindService(serviceConnection);
        } catch (Exception e) {
            AbstractC0852NX.m5766o(e, new StringBuilder("On unBindServiceException:"), "Util");
        }
    }
}
