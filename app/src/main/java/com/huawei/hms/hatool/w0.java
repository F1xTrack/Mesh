...
public class w0 {
    ...
    public static String c(String str, String str2) {
        ...
        if ("maint".equals(str2)) {
            ...
            if (TextUtils.isEmpty(strO)) {
                strO = AbstractC8100y3.b("HiAnalytics_Sdk_Public_Sp_Key", d.a(q0.i(), "Privacy_MY", "public_key_maint", ""));
                q0.d(strO);
            }
        } else {
            strO = q0.o();
            if (TextUtils.isEmpty(strO)) {
                strO = AbstractC8100y3.b("HiAnalytics_Sdk_Public_Sp_Key", d.a(q0.i(), "Privacy_MY", "public_key_oper", ""));
                q0.e(strO);
            }
        }
    ...
    private static void d(String str, String str2) {
        try {
            ...
            d.b(q0.i(), "Privacy_MY", "public_key_oper", AbstractC8100y3.d("HiAnalytics_Sdk_Public_Sp_Key", strOptString));
            d.b(q0.i(), "Privacy_MY", "public_key_maint", AbstractC8100y3.d("HiAnalytics_Sdk_Public_Sp_Key", strOptString2));
