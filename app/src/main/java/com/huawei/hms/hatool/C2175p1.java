...
public class C2175p1 {
    ...
    public static String m12173a(String str) {
        ...
        try {
            ...
            C2186v.m12268b("hmsSdk", "url don't starts with https");
            return null;
        } catch (URISyntaxException e) {
            C2186v.m12268b("hmsSdk", "getHostByURI error : " + e.getMessage());
            return null;
        }
    }

    /* renamed from: b */
    public static boolean m12176b(String str) {
        if (C2173p.f19264a.booleanValue()) {
            return true;
        }
        for (String str2 : f19272a) {
            if (m12175a(str, str2, 2)) {
                return true;
            }
        }
        return false;
    ...
    /* renamed from: a */
    private static String m12174a(String str, int i) {
    ...
    /* renamed from: a */
    public static boolean m12175a(String str, String str2, int i) {
        String string;
        StringBuilder sb;
        String strM12173a = m12173a(str);
        if (TextUtils.isEmpty(strM12173a) || TextUtils.isEmpty(str2)) {
            string = "url or whitelistHash is null";
        } else {
            String strM12174a = m12174a(strM12173a, i);
            if (!TextUtils.isEmpty(strM12174a)) {
                if (str2.equals(CB1.m1003c(strM12173a))) {
                    return true;
                }
                if (!str2.equals(CB1.m1003c(strM12174a))) {
                    return false;
                }
                try {
                    String strSubstring = strM12173a.substring(0, strM12173a.length() - strM12174a.length());
