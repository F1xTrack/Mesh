...
public class k extends u0 {
    ...
    public static f0 a(String str, String str2, String str3, String str4) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        f0 f0VarA = u0.a(str, str2, str3, str4);
        String strA = j.a().a(a1.c(str2, str3));
        long jCurrentTimeMillis = System.currentTimeMillis();
        String strC = CB1.c(q0.f() + strA + jCurrentTimeMillis);
