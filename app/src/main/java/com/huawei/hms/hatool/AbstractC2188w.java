...
public abstract class AbstractC2188w {
    ...
    /* renamed from: a */
    public static C2168n0 m12278a(String str, byte[] bArr, Map<String, String> map) {
        return m12279a(str, bArr, map, "POST");
    }

    /* renamed from: b */
    private static String m12282b(HttpURLConnection httpURLConnection) throws IOException {
        InputStream inputStream = null;
        try {
            try {
                inputStream = httpURLConnection.getInputStream();
                return C2160k1.m12087a(inputStream);
            } catch (IOException unused) {
                C2186v.m12276f("hmsSdk", "When Response Content From Connection inputStream operation exception! " + httpURLConnection.getResponseCode());
                C2160k1.m12088a((Closeable) inputStream);
                return "";
            }
        } finally {
            C2160k1.m12088a((Closeable) inputStream);
    ...
    */
    public static com.huawei.hms.hatool.C2168n0 m12279a(java.lang.String r6, byte[] r7, java.util.Map<java.lang.String, java.lang.String> r8, java.lang.String r9) throws java.lang.Throwable {
        /*
            Method dump skipped, instructions count: 341
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huawei.hms.hatool.AbstractC2188w.m12279a(java.lang.String, byte[], java.util.Map, java.lang.String):com.huawei.hms.hatool.n0");
    }

    /* renamed from: a */
    private static HttpURLConnection m12280a(String str, int i, Map<String, String> map, String str2) throws ProtocolException, a {
        if (TextUtils.isEmpty(str)) {
            C2186v.m12268b("hmsSdk", "CreateConnection: invalid urlPath.");
            return null;
        }
        HttpURLConnection httpURLConnection = (HttpURLConnection) ((URLConnection) FirebasePerfUrlConnection.instrument(new URL(str).openConnection()));
        m12281a(httpURLConnection);
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private static void m12281a(java.net.HttpURLConnection r2) throws com.huawei.hms.hatool.AbstractC2188w.a {
        /*
            ...
            android.content.Context r1 = com.huawei.hms.hatool.AbstractC2177q0.m12197i()     // Catch: java.lang.IllegalAccessException -> L11 java.io.IOException -> L17 java.security.GeneralSecurityException -> L1a java.security.KeyStoreException -> L1d java.security.NoSuchAlgorithmException -> L20
            mX0 r0 = p000.C10277mX0.m22836a(r1)     // Catch: java.lang.IllegalAccessException -> L11 java.io.IOException -> L17 java.security.GeneralSecurityException -> L1a java.security.KeyStoreException -> L1d java.security.NoSuchAlgorithmException -> L20
            goto L24
        L11:
            java.lang.String r1 = "getSocketFactory(): Illegal Access Exception "
        L13:
            com.huawei.hms.hatool.C2186v.m12276f(r0, r1)
            goto L23
        L17:
        ...
        L3b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huawei.hms.hatool.AbstractC2188w.m12281a(java.net.HttpURLConnection):void");
    }
}
