...
public class TransactionIdCreater {
    /* renamed from: a */
    private static SecureRandom m11626a() {
        try {
            return SecureRandom.getInstance("SHA1PRNG");
        } catch (Exception unused) {
            HMSLog.m12620e("TransactionIdCreater", "SecureRandom getInstance happpened NoSuchAlgorithmException!");
    ...
    public static String getId(String str, String str2) {
        ...
        sb.append(String.format(locale, "%06d", Integer.valueOf(m11626a().nextInt(1000000))));
        return sb.toString();
    }
}
