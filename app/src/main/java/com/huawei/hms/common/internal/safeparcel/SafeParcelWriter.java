...
public class SafeParcelWriter {
    ...
    /* renamed from: a */
    private static void m11633a(Parcel parcel, int i, int i2) {
        if (parcel == null) {
            return;
        }
        if (i2 < 65535) {
    ...
    /* renamed from: b */
    private static void m11635b(Parcel parcel, int i) {
        if (parcel == null) {
            return;
        }
    ...
    public static void writeBigDecimal(Parcel parcel, int i, BigDecimal bigDecimal, boolean z) {
        ...
        if (bigDecimal == null) {
            ...
            int iM11632a = m11632a(parcel, i);
            parcel.writeByteArray(bigDecimal.unscaledValue().toByteArray());
            parcel.writeInt(bigDecimal.scale());
            m11635b(parcel, iM11632a);
        }
    }
    ...
    /* renamed from: a */
    private static int m11632a(Parcel parcel, int i) {
        parcel.writeInt(i | (-65536));
        parcel.writeInt(0);
    ...
    /* renamed from: a */
    private static <P extends Parcelable> void m11634a(Parcel parcel, P p, int i) {
        if (parcel == null) {
            return;
        }
        int iDataPosition = parcel.dataPosition();
