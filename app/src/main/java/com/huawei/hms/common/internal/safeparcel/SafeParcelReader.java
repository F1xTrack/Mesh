...
public class SafeParcelReader {
    ...
    /* renamed from: a */
    private static boolean m11630a(int i, int i2) {
        long j = i + i2;
        return j > 2147483647L || j < -2147483648L;
    }

    /* renamed from: b */
    private static void m11631b(Parcel parcel, int i, int i2) {
        ...
        sb.append(" got ");
        sb.append(size);
        throw new ParseException(AbstractC11153tN0.m24914z(sb, " (0x", hexString, ")"), parcel);
    }
    ...
    public static BigDecimal createBigDecimal(Parcel parcel, int i) {
        ...
        m11628a(parcel, size, iDataPosition);
    ...
    public static Parcel[] createParcelArray(Parcel parcel, int i) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            ...
            if (i4 == 0) {
                ...
                m11628a(parcel, i4, iDataPosition2);
                Parcel parcelObtain = Parcel.obtain();
    ...
    public static SparseArray<Parcel> createParcelSparseArray(Parcel parcel, int i) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            ...
            if (i5 == 0) {
                ...
                int iDataPosition2 = parcel.dataPosition();
                m11628a(parcel, i5, iDataPosition2);
                Parcel parcelObtain = Parcel.obtain();
    ...
    public static void ensureAtEnd(Parcel parcel, int i) {
        if (parcel.dataPosition() != i) {
            throw new ParseException(AbstractC11153tN0.m24909u(i, "Overread allowed size end="), parcel);
        }
    }
    ...
    public static int validateObjectHeader(Parcel parcel) {
        ...
        if (i < iDataPosition || i > parcel.dataSize()) {
            throw new ParseException(AbstractC7222ym.m26229f(iDataPosition, "invalid start=", i, " end="), parcel);
        }
        return i;
    }

    /* renamed from: a */
    private static void m11629a(Parcel parcel, int i, int i2, int i3) {
        if (i2 == i3) {
            return;
        }
    ...
    /* renamed from: a */
    private static void m11628a(Parcel parcel, int i, int i2) {
        if (i < 0 || m11630a(i, i2)) {
    ...
    /* renamed from: a */
    private static void m11627a(Parcel parcel, int i) {
        if (i > 1024) {
