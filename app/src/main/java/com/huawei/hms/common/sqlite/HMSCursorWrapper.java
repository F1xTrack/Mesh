...
public class HMSCursorWrapper extends CursorWrapper implements CrossProcessCursor {
    ...
    /* renamed from: a */
    private AbstractWindowedCursor f18982a;
    ...
    public HMSCursorWrapper(Cursor cursor) {
        ...
        if (wrappedCursor instanceof AbstractWindowedCursor) {
            this.f18982a = (AbstractWindowedCursor) wrappedCursor;
            return;
        }
    ...
    public void fillWindow(int i, CursorWindow cursorWindow) {
        this.f18982a.fillWindow(i, cursorWindow);
    }

    @Override // android.database.CrossProcessCursor
    public CursorWindow getWindow() {
        return this.f18982a.getWindow();
    }
    ...
    public boolean onMove(int i, int i2) {
        return this.f18982a.onMove(i, i2);
    }

    public void setWindow(CursorWindow cursorWindow) {
        this.f18982a.setWindow(cursorWindow);
    }
}
