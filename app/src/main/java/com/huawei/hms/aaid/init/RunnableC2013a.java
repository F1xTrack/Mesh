...
public class RunnableC2013a implements Runnable {
    ...
    public RunnableC2013a(Context context) {
        this.f18686a = context;
    }

    /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Can't find top splitter block for handler:B:55:0x008e
    ...
    public void run() {
        /*
            ...
            r3 = 0
            android.content.Context r4 = r8.f18686a     // Catch: java.lang.Exception -> L27 com.huawei.hms.common.ApiException -> L29
            ...
            android.content.Context r5 = r8.f18686a     // Catch: java.lang.Exception -> L27 com.huawei.hms.common.ApiException -> L29
            ...
            com.huawei.hms.support.log.HMSLog.m12622i(r1, r4)     // Catch: java.lang.Exception -> L27 com.huawei.hms.common.ApiException -> L29
        ...
        L29:
            ...
            com.huawei.hms.support.log.HMSLog.m12620e(r1, r4)     // Catch: java.lang.Exception -> L27
        L33:
            android.content.Context r4 = r8.f18686a     // Catch: java.lang.Exception -> L27 android.content.pm.PackageManager.NameNotFoundException -> L8e
            ...
            android.content.Context r5 = r8.f18686a     // Catch: java.lang.Exception -> L27 android.content.pm.PackageManager.NameNotFoundException -> L8e
            ...
            com.huawei.hms.opendevice.k r2 = new com.huawei.hms.opendevice.k     // Catch: java.lang.Exception -> L27 android.content.pm.PackageManager.NameNotFoundException -> L8e
            r2.<init>()     // Catch: java.lang.Exception -> L27 android.content.pm.PackageManager.NameNotFoundException -> L8e
            android.content.Context r3 = r8.f18686a     // Catch: java.lang.Exception -> L27 android.content.pm.PackageManager.NameNotFoundException -> L8e
            boolean r2 = r2.m12366a(r3, r5, r4)     // Catch: java.lang.Exception -> L27 android.content.pm.PackageManager.NameNotFoundException -> L8e
            if (r2 != 0) goto L97
            java.lang.String r2 = "start service failed"
            com.huawei.hms.support.log.HMSLog.m12620e(r1, r2)     // Catch: java.lang.Exception -> L27 android.content.pm.PackageManager.NameNotFoundException -> L8e
            goto L97
        L8a:
            com.huawei.hms.support.log.HMSLog.m12622i(r1, r0)     // Catch: java.lang.Exception -> L27 android.content.pm.PackageManager.NameNotFoundException -> L8e
            goto L97
        L8e:
            com.huawei.hms.support.log.HMSLog.m12622i(r1, r0)     // Catch: java.lang.Exception -> L27
            goto L97
        L92:
            java.lang.String r2 = "Push init failed"
            com.huawei.hms.support.log.HMSLog.m12621e(r1, r2, r0)
        L97:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huawei.hms.aaid.init.RunnableC2013a.run():void");
    }
}
