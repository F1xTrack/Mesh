...
public class EmuiUtil {
    ...
    public static int getEMUIVersionCode() throws NoSuchFieldException {
        ...
        if (staticFieldObj != null) {
            try {
                ...
                Logger.m11683e(TAG, "getEMUIVersionCode ClassCastException:", e);
            }
        } else {
            iIntValue = 0;
        }
        Logger.m11680d(TAG, "the emui version code is::" + iIntValue);
        return iIntValue;
    }

    private static void initEmuiType() throws NoSuchFieldException {
        int eMUIVersionCode = getEMUIVersionCode();
        Logger.m11680d(TAG, "getEmuiType emuiVersionCode=" + eMUIVersionCode);
        ...
        if (emuiType == -1) {
            Logger.m11685i(TAG, "emuiType is unkown");
        }
    }
    ...
    public static boolean isUpPVersion() {
        try {
            ...
            Logger.m11680d(TAG, "no such method for com.huawei.android.os.BuildEx.VERSION");
        } catch (Throwable unused2) {
            Logger.m11680d(TAG, "com.huawei.android.os.BuildEx.VERSION has other exception");
        }
        Logger.m11680d(TAG, "com.huawei.android.os.BuildEx : false");
        return false;
    }
}
