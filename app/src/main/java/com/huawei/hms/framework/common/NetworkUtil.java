...
import p000.AbstractC11457vl0;
import p000.AbstractC6420mL;
...
public class NetworkUtil {
    ...
    private static String[] getDnsServerIpsFromConnectionManager(Context context) {
        ...
        if (context != null && (connectivityManager = (ConnectivityManager) ContextCompat.getSystemService(context, "connectivity")) != null) {
            try {
                ...
                Logger.m11685i(TAG, "getActiveNetworkInfo failed, exception:".concat(e.getClass().getSimpleName()));
            } catch (RuntimeException e2) {
                Logger.m11685i(TAG, "getActiveNetworkInfo failed, exception:".concat(e2.getClass().getSimpleName()));
            }
        }
    ...
    public static String getHost(String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            int i = AbstractC11457vl0.f44515a;
        ...
        try {
            ...
            int i2 = AbstractC11457vl0.f44515a;
        ...
        int i3 = AbstractC11457vl0.f44515a;
        if (!TextUtils.isEmpty("url don't starts with http or https")) {
            TextUtils.isEmpty("url don't starts with http or https");
        }
        return "";
    }
    ...
    public static int getInfoWithReflect(SignalStrength signalStrength, String str) {
        try {
            ...
            Logger.m11685i(TAG, str + " : cannot access");
            return Integer.MAX_VALUE;
        } catch (NoSuchMethodException unused2) {
            Logger.m11685i(TAG, str + " : function not found");
            return Integer.MAX_VALUE;
        } catch (InvocationTargetException unused3) {
            Logger.m11685i(TAG, str + " : InvocationTargetException");
            return Integer.MAX_VALUE;
        } catch (Throwable th) {
            String str2 = TAG;
            StringBuilder sbM5762k = AbstractC0852NX.m5762k(str, " : throwable:");
            sbM5762k.append(th.getClass());
            Logger.m11685i(str2, sbM5762k.toString());
            return Integer.MAX_VALUE;
        }
    }
    ...
    public static int getLteCqi(Context context) {
        ...
        try {
            ...
            Logger.m11685i(TAG, "getLteCqi: throwable:" + th.getClass());
        }
        if (Build.VERSION.SDK_INT <= 28) {
    ...
    public static int getLteRsrp(Context context) {
        ...
        try {
            ...
            Logger.m11685i(TAG, "getLteRsrp: throwable:" + th.getClass());
        }
        if (Build.VERSION.SDK_INT <= 28) {
    ...
    public static int getLteRsrq(Context context) {
        ...
        try {
            ...
            Logger.m11685i(TAG, "getLteRsrq: throwable:" + th.getClass());
        }
        if (Build.VERSION.SDK_INT <= 28) {
    ...
    public static int getLteRssi(Context context) {
        ...
        try {
            ...
            Logger.m11685i(TAG, "getLteRssi: throwable:" + th.getClass());
        }
        return Integer.MAX_VALUE;
    }
    ...
    public static int getLteRssnr(Context context) {
        ...
        try {
            ...
            Logger.m11685i(TAG, "getLteRssnr: throwable:" + th.getClass());
        }
        if (Build.VERSION.SDK_INT <= 28) {
    ...
    public static String getMNC(Context context) {
        ...
        if (telephonyManager == null) {
            Logger.m11682e(TAG, "getSubscriptionOperatorType: other error!");
            return "unknown";
        }
    ...
    public static int getMobileRsrp(Context context) {
        ...
        try {
            ...
            Logger.m11685i(TAG, "getDbm: throwable:" + th.getClass());
            return Integer.MAX_VALUE;
        }
    }
    ...
    private static int getMobileSingalStrengthUpPPlatfrom(Context context) {
        ...
        try {
            ...
            Logger.m11685i(TAG, "getMobileSingalStrength: throwable:" + th.getClass());
        }
        if (networkType == 3) {
            ...
            if (cellSignalStrengths.size() > 0) {
                ...
                List cellSignalStrengths2 = signalStrength.getCellSignalStrengths(AbstractC6420mL.m22798w());
                if (cellSignalStrengths2.size() > 0) {
                    dbm = AbstractC6420mL.m22786k(cellSignalStrengths2.get(0)).getDbm();
                } else {
            ...
            if (networkType != 4) {
                if (networkType == 5) {
                    List cellSignalStrengths4 = signalStrength.getCellSignalStrengths(AbstractC6420mL.m22787l());
                    if (cellSignalStrengths4.size() > 0) {
                        dbm = AbstractC6420mL.m22785j(cellSignalStrengths4.get(0)).getDbm();
                    }
                }
                return dbm;
            }
    ...
    public static String getNetWorkNSAorSA() {
        try {
            ...
            String str = TAG;
            Logger.m11687v(str, "phoneId " + default4GSlotId);
            boolean zIsNsaState = hwTelephonyManager.isNsaState(default4GSlotId);
            Logger.m11687v(str, "isNsa " + zIsNsaState);
            return zIsNsaState ? STR_NSA : STR_SA;
        } catch (Throwable unused) {
            Logger.m11687v(TAG, "isNsaState error");
            return null;
        }
    }
            ...
            if (systemService instanceof ConnectivityManager) {
                try {
                    ...
                    if (activeNetworkInfo != null) {
                        ...
                        Logger.m11685i(TAG, "getNetworkStatus networkIsConnected netInfo is null!");
                    }
                } catch (RuntimeException e) {
                    Logger.m11685i(TAG, "getNetworkStatus exception" + e.getClass().getSimpleName() + e.getMessage());
                }
            } else {
                Logger.m11685i(TAG, "getNetworkStatus ConnectivityManager is null!");
            }
        }
        return detailedState;
    }
    ...
    public static int getNrCsiRsrp(Context context) {
        ...
        try {
            ...
            Logger.m11685i(TAG, "getNrCsiRsrp: throwable:" + th.getClass());
        }
        if (Build.VERSION.SDK_INT <= 28 || (signalStrength = getSignalStrength(context)) == null) {
            return Integer.MAX_VALUE;
        }
        List cellSignalStrengths = signalStrength.getCellSignalStrengths(AbstractC6420mL.m22787l());
        if (cellSignalStrengths.size() > 0) {
            return AbstractC6420mL.m22785j(cellSignalStrengths.get(0)).getCsiRsrp();
        }
        return Integer.MAX_VALUE;
    }
    ...
    public static int getNrCsiRsrq(Context context) {
        ...
        try {
            ...
            Logger.m11685i(TAG, "getNrCsiRsrq: throwable:" + th.getClass());
        }
        if (Build.VERSION.SDK_INT <= 28 || (signalStrength = getSignalStrength(context)) == null) {
            return Integer.MAX_VALUE;
        }
        List cellSignalStrengths = signalStrength.getCellSignalStrengths(AbstractC6420mL.m22787l());
        if (cellSignalStrengths.size() > 0) {
            return AbstractC6420mL.m22785j(cellSignalStrengths.get(0)).getCsiRsrq();
        }
        return Integer.MAX_VALUE;
    }
    ...
    public static int getNrCsiSinr(Context context) {
        ...
        try {
            ...
            Logger.m11685i(TAG, "getNrCsiSinr: throwable:" + th.getClass());
        }
        if (Build.VERSION.SDK_INT <= 28 || (signalStrength = getSignalStrength(context)) == null) {
            return Integer.MAX_VALUE;
        }
        List cellSignalStrengths = signalStrength.getCellSignalStrengths(AbstractC6420mL.m22787l());
        if (cellSignalStrengths.size() > 0) {
            return AbstractC6420mL.m22785j(cellSignalStrengths.get(0)).getCsiSinr();
        }
        return Integer.MAX_VALUE;
    }
    ...
    public static Map<String, Integer> getNrSignalInfo(Context context) {
        ...
        try {
            if (Build.VERSION.SDK_INT > 28) {
                List cellSignalStrengths = signalStrength.getCellSignalStrengths(AbstractC6420mL.m22787l());
                if (cellSignalStrengths.size() > 0) {
                    map.put(SignalType.NR_DBM, Integer.valueOf(AbstractC6420mL.m22785j(cellSignalStrengths.get(0)).getDbm()));
                    map.put(SignalType.NR_CSIRSRP, Integer.valueOf(AbstractC6420mL.m22785j(cellSignalStrengths.get(0)).getCsiRsrp()));
                    map.put(SignalType.NR_CSIRSRQ, Integer.valueOf(AbstractC6420mL.m22785j(cellSignalStrengths.get(0)).getCsiRsrq()));
                    map.put(SignalType.NR_CSISINR, Integer.valueOf(AbstractC6420mL.m22785j(cellSignalStrengths.get(0)).getCsiSinr()));
                    map.put(SignalType.NR_SSRSRP, Integer.valueOf(AbstractC6420mL.m22785j(cellSignalStrengths.get(0)).getSsRsrp()));
                    map.put(SignalType.NR_SSRSRQ, Integer.valueOf(AbstractC6420mL.m22785j(cellSignalStrengths.get(0)).getSsRsrq()));
                    map.put(SignalType.NR_SSSINR, Integer.valueOf(AbstractC6420mL.m22785j(cellSignalStrengths.get(0)).getSsSinr()));
                }
            }
        } catch (Throwable th) {
            Logger.m11685i(TAG, "getLteRssi: throwable:" + th.getClass());
    ...
    public static int getNrSsRsrp(Context context) {
        ...
        try {
            ...
            Logger.m11685i(TAG, "getNrSsRsrp: throwable:" + th.getClass());
        }
        if (Build.VERSION.SDK_INT <= 28 || (signalStrength = getSignalStrength(context)) == null) {
            return Integer.MAX_VALUE;
        }
        List cellSignalStrengths = signalStrength.getCellSignalStrengths(AbstractC6420mL.m22787l());
        if (cellSignalStrengths.size() > 0) {
            return AbstractC6420mL.m22785j(cellSignalStrengths.get(0)).getSsRsrp();
        }
        return Integer.MAX_VALUE;
    }
    ...
    public static int getNrSsRsrq(Context context) {
        ...
        try {
            ...
            Logger.m11685i(TAG, "getNrSsRsrq: throwable:" + th.getClass());
        }
        if (Build.VERSION.SDK_INT <= 28 || (signalStrength = getSignalStrength(context)) == null) {
            return Integer.MAX_VALUE;
        }
        List cellSignalStrengths = signalStrength.getCellSignalStrengths(AbstractC6420mL.m22787l());
        if (cellSignalStrengths.size() > 0) {
            return AbstractC6420mL.m22785j(cellSignalStrengths.get(0)).getSsRsrq();
        }
        return Integer.MAX_VALUE;
    }
    ...
    public static int getNrSsSinr(Context context) {
        ...
        try {
            ...
            Logger.m11685i(TAG, "getNrSsSinr: throwable:" + th.getClass());
        }
        if (Build.VERSION.SDK_INT <= 28 || (signalStrength = getSignalStrength(context)) == null) {
            return Integer.MAX_VALUE;
        }
        List cellSignalStrengths = signalStrength.getCellSignalStrengths(AbstractC6420mL.m22787l());
        if (cellSignalStrengths.size() > 0) {
            return AbstractC6420mL.m22785j(cellSignalStrengths.get(0)).getSsSinr();
        }
        return Integer.MAX_VALUE;
    }
    ...
    public static String getWifiGatewayIp(Context context) {
        ...
        try {
            ...
            Logger.m11685i(TAG, "getWifiGatewayIp error!" + e.getClass().getSimpleName() + e.getMessage());
            return " ";
        }
    }
    ...
    public static int getWifiRssi(Context context) {
        ...
        if (Build.VERSION.SDK_INT < 31) {
            ...
            try {
                ...
                Logger.m11685i(TAG, "getWifiRssiLevel did not has permission!" + e.getClass().getSimpleName() + e.getMessage());
                return INVALID_RSSI;
            }
        }
        try {
            ...
            Logger.m11685i(TAG, "getWifiRssiLevel did not has permission!" + e2.getClass().getSimpleName() + e2.getMessage());
            return rssi;
        }
    }
    ...
    public static boolean isChangeToConnected(NetworkInfo networkInfo, NetworkInfo networkInfo2) {
        ...
        Logger.m11687v(TAG, "Find network state changed to connected");
        return true;
    }
    ...
    public static boolean isConnectTypeChange(NetworkInfo networkInfo, NetworkInfo networkInfo2) {
        ...
        Logger.m11687v(TAG, "Find activity network changed");
        return true;
    }
    ...
    public static int netWork(Context context) {
        int networkType = getNetworkType(context);
        Logger.m11687v(TAG, "networkType " + networkType);
        if (networkType == 4) {
        ...
        if (context != null && Build.VERSION.SDK_INT >= 24 && ContextCompat.checkSelfPermission(context, "android.permission.ACCESS_NETWORK_STATE")) {
            ...
            if (systemService instanceof ConnectivityManager) {
                ...
                try {
                    ...
                    Logger.m11683e(TAG, "SystemServer error:", e);
                }
            }
        }
    ...
    public static int getNetworkType(NetworkInfo networkInfo, Context context) {
        ...
        Logger.m11687v(TAG, "getHwNetworkType return is: " + subtype);
        if (subtype == 0) {
