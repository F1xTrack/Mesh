...
public class PackageManagerCompat {
    ...
    public static String getAppPackageName(Context context) {
        ...
        try {
            ...
            Logger.m11689w(TAG, "Failed to get Package managers Package Info");
            return "";
        }
    }
    ...
    private static Bundle getBundleFromApp(Context context) throws PackageManager.NameNotFoundException {
        ...
        try {
            ...
            Logger.m11690w(TAG, "NameNotFoundException:", e);
            return bundle;
        }
    }
    ...
    private static Bundle getBundleFromKit(Context context) {
        ...
        if (context == null) {
            Logger.m11687v(TAG, "the kitContext is null");
            return Bundle.EMPTY;
        }
        if (context.getApplicationInfo() == null) {
            Logger.m11687v(TAG, "the kit applicationInfo is null");
            return Bundle.EMPTY;
        }
        Logger.m11685i(TAG, "kitContext: " + context.getPackageName());
    ...
    public static String getMetaDataFromKit(Context context, String str, String str2) {
        try {
            ...
            Logger.m11687v(TAG, "the kit metaData is runtimeException");
            return str2;
        }
    }
