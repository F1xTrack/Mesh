...
public class CountryCodeBean {
    ...
    private void getProductCountryCode() throws ClassNotFoundException {
        ...
        String str = TAG;
        Logger.m11685i(str, "countryCode by ro.product.locale.region is: " + this.countryCode);
        if (TextUtils.isEmpty(this.countryCode) || GrsBaseInfo.CountryCodeSource.UNKNOWN.equals(this.countryCode)) {
            ...
            if (!TextUtils.isEmpty(property) && (iLastIndexOf = property.lastIndexOf("-")) != -1) {
                ...
                Logger.m11685i(str, "countryCode by ro.product.locale is: " + this.countryCode);
            }
        }
    ...
    private void getRegionSettingCountryCode() {
        ...
        Logger.m11685i(TAG, "countryCode by system's region setting is: " + this.countryCode);
    ...
    private void getVendorCountryCode() {
        ...
        String str = TAG;
        Logger.m11685i(str, "countryCode by ro.hw.country is: " + this.countryCode);
        if (SPECIAL_COUNTRYCODE_EU.equalsIgnoreCase(this.countryCode) || SPECIAL_COUNTRYCODE_LA.equalsIgnoreCase(this.countryCode)) {
            ...
            Logger.m11685i(str, "special country of UK to map GB.");
    ...
    private void init(Context context, boolean z) {
        ...
        try {
            ...
            if (isCodeValidate()) {
                Logger.m11685i(TAG, "get issue_country code from VENDOR_COUNTRY");
                return;
            }
            getSimCountryCode(context);
            if (isCodeValidate()) {
                Logger.m11685i(TAG, "get issue_country code from SIM_COUNTRY");
                return;
            }
            getLocaleCountryCode();
            if (isCodeValidate()) {
                Logger.m11685i(TAG, "get issue_country code from LOCALE_INFO");
            }
        } catch (Exception unused) {
            Logger.m11689w(TAG, "get CountryCode error");
        }
    }
    ...
    private void getSimCountryCode(Context context, boolean z) {
        ...
        if (telephonyManager != null) {
            ...
            Logger.m11685i(str, sb.toString());
        }
        checkCodeLenth();
    }
}
