...
public class ReflectionUtils {
    ...
    public static boolean checkCompatible(String str) {
        try {
            ...
            Logger.m11689w(TAG, str + "ClassNotFoundException");
            return false;
        }
    }
    ...
    public static Field getField(Object obj, String str) throws NoSuchFieldException {
        if (obj != null && !TextUtils.isEmpty(str)) {
            try {
                ...
                Logger.m11683e(TAG, "Exception in getField :: IllegalArgumentException:", e);
            } catch (NoSuchFieldException e2) {
                Logger.m11683e(TAG, "Exception in getField :: NoSuchFieldException:", e2);
            } catch (SecurityException e3) {
                Logger.m11683e(TAG, "not security int method getField,SecurityException:", e3);
            }
        }
        return null;
    }
    ...
    public static Object getFieldObj(Object obj, String str) throws NoSuchFieldException {
        ...
        try {
            ...
            Logger.m11683e(TAG, "Exception in getFieldObj :: IllegalAccessException:", e);
            return null;
        } catch (IllegalArgumentException e2) {
            Logger.m11683e(TAG, "Exception in getFieldObj :: IllegalArgumentException:", e2);
            return null;
        } catch (NoSuchFieldException e3) {
            Logger.m11683e(TAG, "Exception in getFieldObj :: NoSuchFieldException:", e3);
            return null;
        } catch (SecurityException e4) {
            Logger.m11683e(TAG, "not security int method getFieldObj,SecurityException:", e4);
            return null;
        }
    }
    ...
    public static Method getMethod(Class<?> cls, String str, Class<?>... clsArr) {
        if (cls == null || str == null) {
            Logger.m11689w(TAG, "targetClass is  null pr name is null:");
            return null;
        }
        try {
            return cls.getDeclaredMethod(str, clsArr);
        } catch (NoSuchMethodException e) {
            Logger.m11683e(TAG, "NoSuchMethodException:", e);
            return null;
        } catch (SecurityException e2) {
            Logger.m11683e(TAG, "SecurityException:", e2);
            return null;
        }
    }
    ...
    public static Object getStaticFieldObj(String str, String str2) throws NoSuchFieldException {
        ...
        try {
            ...
            Logger.m11683e(TAG, "not security int method getStaticFieldObj,SecurityException:", e4);
            return null;
        }
    }
    ...
    private static Object invoke(Object obj, Method method, Object... objArr) throws UnsupportedOperationException {
        ...
        try {
            ...
            Logger.m11683e(TAG, "RuntimeException in invoke:", e);
            return null;
        } catch (Exception e2) {
            Logger.m11683e(TAG, "Exception in invoke:", e2);
            return null;
        }
    }
    ...
    public static boolean checkCompatible(String str, String str2, Class<?>... clsArr) throws NoSuchMethodException, SecurityException {
        try {
            if (str != null && str2 != null) {
                ...
                Logger.m11687v(TAG, "has method : ".concat(str2));
                return true;
            }
            Logger.m11689w(TAG, "targetClass is  null or name is null:");
            return false;
        } catch (RuntimeException unused) {
            Logger.m11689w(TAG, str + " RuntimeException");
            return false;
        } catch (Exception unused2) {
            Logger.m11689w(TAG, str2 + " NoSuchMethodException");
            return false;
        }
    }
