...
public class GrsApi {
    ...
    public static void ayncGetGrsUrl(String str, String str2, IQueryUrlCallBack iQueryUrlCallBack) {
        if (iQueryUrlCallBack == null) {
            Logger.m11689w(TAG, "IQueryUrlCallBack is must not null for process continue.");
            return;
        }
    ...
    public static void ayncGetGrsUrls(String str, IQueryUrlsCallBack iQueryUrlsCallBack) {
        if (iQueryUrlsCallBack == null) {
            Logger.m11689w(TAG, "IQueryUrlsCallBack is must not null for process continue.");
            return;
        }
        GrsClient grsClient2 = grsClient;
    ...
    public static void clearSp() {
        if (grsClient == null) {
            Logger.m11689w(TAG, "GrsApi.clearSp return because grsClient is null.");
        }
    }
    ...
    public static boolean forceExpire() {
        ...
        Logger.m11689w(TAG, "GrsApi.forceExpire return false because grsClient is null.");
        return false;
    }

    @Deprecated
    public static CountryCodeBean getCountryCode(Context context, boolean z) {
        return C2091a.m11692a(context, z);
    }

    @Deprecated
    public static int grsSdkInit(Context context, GrsBaseInfo grsBaseInfo) {
        Logger.m11689w(TAG, "GrsApi.grsSdkInit is @Deprecated,  And Only Application Can Call Once");
    ...
    public static String synGetGrsUrl(String str, String str2) {
        ...
        Logger.m11689w(TAG, "GrsApi.synGetGrsUrl method maybe grsSdkInit has not completed and grsClient is null.");
        return null;
    }
    ...
    public static Map<String, String> synGetGrsUrls(String str) {
        ...
        Logger.m11689w(TAG, "GrsApi.synGetGrsUrls method maybe grsSdkInit has not completed and grsClient is null.");
        return new HashMap();
    }
}
