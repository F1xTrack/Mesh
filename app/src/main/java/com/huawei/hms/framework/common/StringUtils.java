...
public class StringUtils {
    ...
    public static String byte2Str(byte[] bArr) {
        ...
        try {
            ...
            Logger.m11689w("StringUtils.byte2str error: UnsupportedEncodingException", anonymizeMessage(e.getMessage()));
            return "";
        }
    }
    ...
    public static String replace(String str, CharSequence charSequence, CharSequence charSequence2) {
        if (isAegisStringLibraryLoaded || checkCompatible(SAFE_STRING_PATH)) {
            try {
                ...
                Logger.m11689w(TAG, "SafeString.substring error");
            }
        }
    ...
    public static byte[] str2Byte(String str) {
        ...
        try {
            ...
            Logger.m11689w("StringUtils.str2Byte error: UnsupportedEncodingException", anonymizeMessage(e.getMessage()));
            return new byte[0];
        }
    }
    ...
    public static boolean stringToBoolean(String str, boolean z) {
        ...
        try {
            ...
            Logger.m11689w(TAG, "String to Integer catch NumberFormatException." + anonymizeMessage(e.getMessage()));
            return z;
        }
    }
    ...
    public static long stringToLong(String str, long j) {
        ...
        try {
            ...
            Logger.m11689w(TAG, "String to Long catch NumberFormatException." + anonymizeMessage(e.getMessage()));
            return j;
        }
    }
    ...
    public static byte[] getBytes(String str) {
        ...
        try {
            ...
            Logger.m11689w(TAG, "the content has error while it is converted to bytes");
            return bArr;
        }
    }
