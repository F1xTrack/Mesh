...
public class BindingFailedResolution implements IBridgeActivityDelegate, ServiceConnection {
    ...
    public class C2029a implements Handler.Callback {
        public C2029a() {
        }
        ...
        public boolean handleMessage(Message message) {
            ...
            HMSLog.m12622i(BindingFailedResolution.TAG, "selfDestroyHandle：MSG_SELF_DESTROY_TIMEOUT");
    ...
    public class C2030b implements Handler.Callback {
        public C2030b() {
        }
        ...
        public boolean handleMessage(Message message) {
            ...
            HMSLog.m12620e(BindingFailedResolution.TAG, "In connect, bind core try timeout");
    ...
    public class C2031c implements AbstractDialog.Callback {
        public C2031c() {
        }
    ...
    public static class C2032d extends AbstractPromptDialog {
        private C2032d() {
        }
        ...
        public String onGetMessageString(Context context) {
            ...
            if (TextUtils.isEmpty(appName2)) {
                appName2 = PackageConstants.SERVICES_PACKAGE;
            }
        ...
        public /* synthetic */ C2032d(C2029a c2029a) {
            this();
        }
    }
    ...
    private void bindCoreService(boolean z) {
        ...
        if (activity == null) {
            HMSLog.m12620e(TAG, "In connect, bind core try fail");
        ...
        try {
            ...
            if (TextUtils.isEmpty(hMSPackageNameForMultiService)) {
                HMSLog.m12620e(TAG, "servicePackageName is empty, Service is invalid.");
                fireStartResult(false);
            ...
            HMSLog.m12620e(TAG, "IllegalArgumentException when bindCoreService intent.setPackage");
            fireStartResult(false);
            noticeBindResult(z, 8);
        }
    }
    ...
    public void finishBridgeActivity(int i) {
        ...
        HMSLog.m12622i(TAG, "finishBridgeActivity：" + i);
    ...
    private void postConnDelayHandle() {
        ...
        if (handler != null) {
            ...
            this.mConnectTimeoutHandler = new Handler(Looper.getMainLooper(), new C2030b());
        }
    ...
    private void selfDestroyHandle() {
        ...
        if (handler != null) {
            ...
            this.selfDestroyHandler = new Handler(Looper.getMainLooper(), new C2029a());
        }
    ...
    private void showPromptdlg() {
        ...
        C2032d c2032d = this.promptdlg;
        if (c2032d == null) {
            this.promptdlg = new C2032d(null);
        } else {
            c2032d.dismiss();
        }
        HMSLog.m12622i(TAG, "showPromptdlg to resolve conn error");
        this.promptdlg.show(activity, new C2031c());
    }

    private void tryStartHmsActivity(Activity activity) {
        String hMSPackageNameForMultiService = HMSPackageManager.getInstance(activity.getApplicationContext()).getHMSPackageNameForMultiService();
        if (TextUtils.isEmpty(hMSPackageNameForMultiService)) {
            HMSLog.m12623w(TAG, "servicePackageName is empty, Service is invalid.");
            Handler handler = this.selfDestroyHandler;
            if (handler != null) {
                handler.removeMessages(3);
        ...
        HMSLog.m12622i(TAG, "onBridgeActivityCreate：try to start HMS");
        try {
            activity.startActivityForResult(intent, getRequestCode());
        } catch (Throwable th) {
            HMSLog.m12620e(TAG, "ActivityNotFoundException：" + th.getMessage());
    ...
    public void onBridgeActivityCreate(Activity activity) {
        if (activity == null) {
            HMSLog.m12620e(TAG, "activity is null");
            selfDestroyHandle();
            return;
        }
        if (activity.isFinishing()) {
            HMSLog.m12620e(TAG, "activity is finishing");
            return;
        }
        ...
        if (intent != null && intent.hasExtra(FailedBinderCallBack.CALLER_ID)) {
            ...
            try {
                ...
                AbstractC0852NX.m5766o(e, new StringBuilder("getExtras for callId exception:"), TAG);
            }
            this.callBack = FailedBinderCallBack.getInstance().getCallBack(Long.valueOf(longExtra));
        }
        this.curActivity = activity;
        BindingFailedResolveMgr.f18787b.m11486a(activity);
        selfDestroyHandle();
    ...
    public void onBridgeActivityDestroy() {
        ...
        BindingFailedResolveMgr.f18787b.m11487b(this.curActivity);
    ...
    public boolean onBridgeActivityResult(int i, int i2, Intent intent) {
        ...
        HMSLog.m12622i(TAG, "onBridgeActivityResult");
        Handler handler = this.selfDestroyHandler;
        if (handler != null) {
            handler.removeMessages(3);
            this.selfDestroyHandler = null;
    ...
    public void onBridgeConfigurationChanged() {
        ...
        HMSLog.m12622i(TAG, "re show prompt dialog");
        showPromptdlg();
    }

    @Override // com.huawei.hms.activity.IBridgeActivityDelegate
    public void onKeyUp(int i, KeyEvent keyEvent) {
        HMSLog.m12622i(TAG, "On key up when resolve conn error");
    }
    ...
    public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        HMSLog.m12622i(TAG, "test connect success, try to reConnect and reply message");
