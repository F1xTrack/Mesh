...
public class ResolutionDelegate implements IBridgeActivityDelegate {
    ...
    public void onBridgeActivityCreate(Activity activity) {
        Bundle extras;
        if (activity == null || activity.isFinishing()) {
            HMSLog.m12620e(TAG, "activity is null or finishing");
            return;
        }
        ...
        try {
            ...
            AbstractC0852NX.m5766o(e, new StringBuilder("getExtras exception:"), TAG);
            extras = null;
        }
        if (extras != null) {
    ...
    public boolean onBridgeActivityResult(int i, int i2, Intent intent) {
        ...
        if (i2 == -1 && iIsHuaweiMobileServicesAvailable == 0) {
            HMSLog.m12622i(TAG, "Make service available success.");
        } else {
