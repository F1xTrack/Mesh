...
public abstract class HuaweiApiAvailability {
    ...
    public abstract Task checkApiAccessible(HuaweiApi<?> huaweiApi, HuaweiApi<?>... huaweiApiArr);

    public abstract Task checkApiAccessible(HuaweiApiCallable huaweiApiCallable, HuaweiApiCallable... huaweiApiCallableArr);
    ...
    public abstract Task getHuaweiServicesReady(Activity activity);
