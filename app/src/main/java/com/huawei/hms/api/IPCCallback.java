...
public class IPCCallback extends IAIDLCallback.Stub {
    ...
    private final DatagramTransport.InterfaceC2262a mCallback;
    private final Class<? extends IMessageEntity> mResponseClass;

    public IPCCallback(Class<? extends IMessageEntity> cls, DatagramTransport.InterfaceC2262a interfaceC2262a) {
        this.mResponseClass = cls;
        this.mCallback = interfaceC2262a;
    }
    ...
    public void call(DataBuffer dataBuffer) throws RemoteException {
        ...
        if (dataBuffer == null || TextUtils.isEmpty(dataBuffer.URI)) {
            HMSLog.m12620e(TAG, "In call, URI cannot be empty.");
        ...
        DatagramTransport.InterfaceC2262a interfaceC2262a = this.mCallback;
        if (interfaceC2262a != null) {
            if (dataBuffer.header == null) {
                interfaceC2262a.mo12574a(0, iMessageEntityNewResponseInstance);
                return;
            }
            ResponseHeader responseHeader = new ResponseHeader();
            messageCodecFind.decode(dataBuffer.header, responseHeader);
            this.mCallback.mo12574a(responseHeader.getStatusCode(), iMessageEntityNewResponseInstance);
        }
    }
    ...
    public IMessageEntity newResponseInstance() {
        ...
        try {
            ...
            HMSLog.m12620e(TAG, "In newResponseInstance, instancing exception." + e.getMessage());
            return null;
        }
    }
}
