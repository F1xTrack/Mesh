...
public abstract class HuaweiApiClient implements AidlApiClient {
    ...
    public static final class Builder {
        ...
        /* renamed from: b */
        private final List<Scope> f18794b = new ArrayList();

        /* renamed from: c */
        private final List<PermissionInfo> f18795c = new ArrayList();

        /* renamed from: d */
        private final Map<Api<?>, Api.ApiOptions> f18796d = new HashMap();

        /* renamed from: e */
        private OnConnectionFailedListener f18797e;

        /* renamed from: f */
        private ConnectionCallbacks f18798f;

        /* renamed from: g */
        private int f18799g;

        /* renamed from: h */
        private Activity f18800h;
        ...
        /* renamed from: a */
        private void m11497a(Context context) {
            HMSBIInitializer.getInstance(context).initBI();
        }

        public Builder addApi(Api<? extends Api.ApiOptions.NotRequiredOptions> api) {
            this.f18796d.put(api, null);
            if (HuaweiApiAvailability.HMS_API_NAME_GAME.equals(api.getApiName())) {
                HiAnalyticsUtil.getInstance().onEvent(this.f18793a.getApplicationContext(), HiAnalyticsConstant.KeyAndValue.GAME_INIT_KEY, HiAnalyticsConstant.REPORT_VAL_SEPARATOR + System.currentTimeMillis());
            }
            return this;
        }
        ...
        public Builder allowLifeCycleManagement(Activity activity, int i, OnConnectionFailedListener onConnectionFailedListener) {
            ...
            this.f18799g = i;
            this.f18800h = (Activity) Preconditions.checkNotNull(activity, "activity must not be Null.");
            return this;
        }
        ...
        public HuaweiApiClient build() {
            ...
            HuaweiApiClientImpl huaweiApiClientImpl = new HuaweiApiClientImpl(this.f18793a);
            huaweiApiClientImpl.setScopes(this.f18794b);
            huaweiApiClientImpl.setPermissionInfos(this.f18795c);
            huaweiApiClientImpl.setApiMap(this.f18796d);
            huaweiApiClientImpl.setConnectionCallbacks(this.f18798f);
            huaweiApiClientImpl.setConnectionFailedListener(this.f18797e);
            huaweiApiClientImpl.setAutoLifecycleClientId(this.f18799g);
            if (this.f18799g >= 0) {
                m11498a(huaweiApiClientImpl);
            }
        ...
        /* renamed from: a */
        private void m11498a(HuaweiApiClient huaweiApiClient) {
            AutoLifecycleFragment.getInstance(this.f18800h).startAutoMange(this.f18799g, huaweiApiClient);
        }
        ...
        public <O extends Api.ApiOptions.HasOptions> Builder addApiWithScope(Api<O> api, O o, Scope... scopeArr) {
            ...
            Checker.checkNonNull(scopeArr, "Scopes must not be null");
            this.f18796d.put(api, o);
            if (api.getOptions() != null) {
                this.f18794b.addAll(api.getOptions().getScopeList(o));
                this.f18795c.addAll(api.getOptions().getPermissionInfoList(o));
            }
            this.f18794b.addAll(new ArrayList(Arrays.asList(scopeArr)));
            return this;
        }
