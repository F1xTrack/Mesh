...
public class OpenDeviceTaskApiCall extends TaskApiCall<OpenDeviceHmsClient, OdidResult> {
    ...
    @Override // com.huawei.hms.common.internal.TaskApiCall
    public void doExecute(OpenDeviceHmsClient openDeviceHmsClient, ResponseErrorCode responseErrorCode, String str, T81 t81) throws IllegalArgumentException {
        if (responseErrorCode == null) {
            t81.m7576a(new ApiException(new Status(1)));
            return;
        }
        ...
        if (responseErrorCode.getErrorCode() != 0) {
            HMSLog.m12622i("OpenDeviceTaskApiCall", "onResult, returnCode: " + responseErrorCode.getErrorCode());
            t81.m7576a(new ApiException(new Status(responseErrorCode.getErrorCode(), responseErrorCode.getErrorReason())));
            return;
        }
        HMSLog.m12622i("OpenDeviceTaskApiCall", "onResult, success");
