...
public class UpdateAdapter implements IBridgeActivityDelegate {
    ...
    public static Object invokeMethod(String str, String str2, Object[] objArr) {
        try {
            ...
            StringBuilder sbX = F91.x("invoke ", str, ".", str2, " fail. ");
            sbX.append(th.getMessage());
            HMSLog.e("UpdateAdapter", sbX.toString());
            return null;
        }
    }
    ...
    public boolean onBridgeActivityResult(int i, int i2, Intent intent) {
        ...
        AbstractC8235ym.u(i2, "onBridgeActivityResult ", "UpdateAdapter");
