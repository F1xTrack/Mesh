...
public class JsonUtil {
    ...
    /* renamed from: a */
    private static void m12533a(JSONObject jSONObject, String str, Object obj, Bundle bundle) {
        if (obj == null) {
            HMSLog.m12623w("JsonUtil", "transfer jsonObject to bundle failed, defaultValue is null.");
            return;
        }
        ...
        if (obj instanceof int[]) {
            ...
            HMSLog.m12623w("JsonUtil", "transfer jsonObject to bundle failed, invalid data type.");
        } else {
    ...
    public static int getInt(JSONObject jSONObject, String str, int i) {
        ...
        try {
            ...
            HMSLog.m12623w("JsonUtil", "JSONException: get " + str + " error.");
            return i;
        }
    }
    ...
    public static void transferJsonObjectToBundle(JSONObject jSONObject, Bundle bundle, HashMap<String, Object> map) {
        for (Map.Entry<String, Object> entry : map.entrySet()) {
            m12533a(jSONObject, entry.getKey(), entry.getValue(), bundle);
        }
    }
}
