...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @SafeParcelable.VersionField(m11122id = 1000)
    final int zaa;
    Bundle zab;
    int[] zac;
    int zad;
    ...
    @SafeParcelable.Field(getter = "getColumns", m11119id = 1)
    private final String[] zag;

    @SafeParcelable.Field(getter = "getWindows", m11119id = 2)
    private final CursorWindow[] zah;

    @SafeParcelable.Field(getter = "getStatusCode", m11119id = 3)
    private final int zai;

    @SafeParcelable.Field(getter = "getMetadata", m11119id = 4)
    ...
    */
    ...
    public DataHolder(@SafeParcelable.Param(m11120id = 1000) int i, @SafeParcelable.Param(m11120id = 1) String[] strArr, @SafeParcelable.Param(m11120id = 2) CursorWindow[] cursorWindowArr, @SafeParcelable.Param(m11120id = 3) int i2, @SafeParcelable.Param(m11120id = 4) Bundle bundle) {
        this.zae = false;
        this.zak = true;
        this.zaa = i;
        this.zag = strArr;
