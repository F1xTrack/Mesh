...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    */
    ...
    public ActivityRecognitionResult(@SafeParcelable.Param(m11120id = 1) List list, @SafeParcelable.Param(m11120id = 2) long j, @SafeParcelable.Param(m11120id = 3) long j2, @SafeParcelable.Param(m11120id = 4) int i, @SafeParcelable.Param(m11120id = 5) Bundle bundle) {
