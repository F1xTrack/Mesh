...
public class FastParser<T extends FastJsonResponse> {
    ...
    */
    ...
    public final double zaj(BufferedReader bufferedReader) throws ParseException, IOException {
        ...
        return iZam == 0 ? ConfigValue.DOUBLE_DEFAULT_VALUE : Double.parseDouble(new String(this.zaq, 0, iZam));
    }
    ...
    private final void zaw(int i) throws ParseException {
        if (this.zat.isEmpty()) {
            throw new ParseException(AbstractC7222ym.m26230g(i, "Expected state ", " but had empty stack"));
        }
        int iIntValue = ((Integer) this.zat.pop()).intValue();
        if (iIntValue != i) {
            throw new ParseException(AbstractC7222ym.m26229f(i, "Expected state ", iIntValue, " but had "));
        }
    }
