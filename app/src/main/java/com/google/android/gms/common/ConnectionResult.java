...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", m11119id = 2)
    private final int zzb;

    @SafeParcelable.Field(getter = "getResolution", m11119id = 3)
    private final PendingIntent zzc;

    @SafeParcelable.Field(getter = "getErrorMessage", m11119id = 4)
    ...
    public ConnectionResult(@SafeParcelable.Param(m11120id = 1) int i, @SafeParcelable.Param(m11120id = 2) int i2, @SafeParcelable.Param(m11120id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(m11120id = 4) String str) {
        this.zza = i;
        this.zzb = i2;
