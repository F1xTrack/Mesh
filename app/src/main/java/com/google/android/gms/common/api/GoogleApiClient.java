...
public abstract class GoogleApiClient {
    ...
    public abstract void stopAutoManage(AbstractActivityC1730l abstractActivityC1730l);
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
            ...
            this.zah = new C7119x8();
            this.zaj = new C7119x8();
            this.zal = -1;
            this.zao = GoogleApiAvailability.getInstance();
            this.zap = AbstractC8503Ww1.f13459a;
        ...
        public GoogleApiClient build() {
            ...
            for (Api api2 : this.zaj.keySet()) {
                ...
                c7119x8.put(api2, Boolean.valueOf(z2));
                ...
                c7119x82.put(api2.zab(), clientBuildClient);
                if (abstractClientBuilder.getPriority() == 1) {
                    z = obj != null;
                }
                if (clientBuildClient.providesSignIn()) {
                    if (api != null) {
                        throw new IllegalStateException(AbstractC1374Vq.m8589h(api2.zad(), " cannot be used with ", api.zad()));
                    }
                    api = api2;
                }
            }
            if (api != null) {
                if (z) {
                    throw new IllegalStateException(AbstractC7222ym.m26234k("With using ", api.zad(), ", GamesOptions can only be specified within GoogleSignInOptions.Builder"));
                }
            ...
            zabe zabeVar = new zabe(this.zai, new ReentrantLock(), this.zan, clientSettingsZaa, this.zao, this.zap, c7119x8, this.zaq, this.zar, c7119x82, this.zal, zabe.zad(c7119x82.values(), true), arrayList);
        ...
        public Builder enableAutoManage(AbstractActivityC1730l abstractActivityC1730l, int i, OnConnectionFailedListener onConnectionFailedListener) {
            LifecycleActivity lifecycleActivity = new LifecycleActivity((Activity) abstractActivityC1730l);
        ...
        public final ClientSettings zaa() {
            F01 f01 = F01.f3011a;
            Map map = this.zaj;
            Api api = AbstractC8503Ww1.f13460b;
            if (map.containsKey(api)) {
                f01 = (F01) this.zaj.get(api);
            }
            return new ClientSettings(this.zaa, this.zab, this.zah, this.zad, this.zae, this.zaf, this.zag, f01, false);
        }

        public Builder enableAutoManage(AbstractActivityC1730l abstractActivityC1730l, OnConnectionFailedListener onConnectionFailedListener) {
            enableAutoManage(abstractActivityC1730l, 0, onConnectionFailedListener);
            return this;
        }
