...
public final class zaad {
    ...
    private final void zah(boolean z, Status status) {
        ...
        for (Map.Entry entry2 : map2.entrySet()) {
            if (z || ((Boolean) entry2.getValue()).booleanValue()) {
                ((S81) entry2.getKey()).m7185c(new ApiException(status));
            }
        }
    }
    ...
    public final void zad(S81 s81, boolean z) {
        this.zab.put(s81, Boolean.valueOf(z));
        s81.f10598a.mo11135b(new zaac(this, s81));
    }
