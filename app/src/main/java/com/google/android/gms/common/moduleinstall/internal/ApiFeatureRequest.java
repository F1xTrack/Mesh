...
public class ApiFeatureRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getApiFeatures", m11119id = 1)
    private final List zab;

    @SafeParcelable.Field(getter = "getIsUrgent", m11119id = 2)
    private final boolean zac;

    @SafeParcelable.Field(getter = "getFeatureRequestSessionId", m11119id = 3)
    private final String zad;

    @SafeParcelable.Field(getter = "getCallingPackage", m11119id = 4)
    private final String zae;

    @SafeParcelable.Constructor
    public ApiFeatureRequest(@SafeParcelable.Param(m11120id = 1) List list, @SafeParcelable.Param(m11120id = 2) boolean z, @SafeParcelable.Param(m11120id = 3) String str, @SafeParcelable.Param(m11120id = 4) String str2) {
