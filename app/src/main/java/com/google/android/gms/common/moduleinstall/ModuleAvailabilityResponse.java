...
public class ModuleAvailabilityResponse extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "areModulesAvailable", m11119id = 1)
    private final boolean zaa;

    @SafeParcelable.Field(getter = "getAvailabilityStatus", m11119id = 2)
    ...
    @KeepForSdk
    public ModuleAvailabilityResponse(@SafeParcelable.Param(m11120id = 1) boolean z, @SafeParcelable.Param(m11120id = 2) int i) {
        this.zaa = z;
        this.zab = i;
    }
