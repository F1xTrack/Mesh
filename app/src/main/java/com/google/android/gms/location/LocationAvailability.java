...
public final class LocationAvailability extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNSUCCESSFUL", m11119id = 4)
    int zzc;

    @SafeParcelable.Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNKNOWN", getter = "getCellStatus", m11119id = 1)
    private final int zzd;

    @SafeParcelable.Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNKNOWN", getter = "getWifiStatus", m11119id = 2)
    private final int zze;

    @SafeParcelable.Field(defaultValueUnchecked = "0", getter = "getElapsedRealtimeNs", m11119id = 3)
    private final long zzf;

    @SafeParcelable.Field(getter = "getBatchedStatus", m11119id = 5)
    ...
    public LocationAvailability(@SafeParcelable.Param(m11120id = 4) int i, @SafeParcelable.Param(m11120id = 1) int i2, @SafeParcelable.Param(m11120id = 2) int i3, @SafeParcelable.Param(m11120id = 3) long j, @SafeParcelable.Param(m11120id = 5) zzac[] zzacVarArr, @SafeParcelable.Param(m11120id = 6) boolean z) {
