...
public final class LocationSettingsResult extends AbstractSafeParcelable implements Result {
    ...
    @SafeParcelable.Field(getter = "getStatus", m11119id = 1)
    private final Status zza;

    @SafeParcelable.Field(getter = "getLocationSettingsStates", m11119id = 2)
    private final LocationSettingsStates zzb;

    @SafeParcelable.Constructor
    public LocationSettingsResult(@SafeParcelable.Param(m11120id = 1) Status status, @SafeParcelable.Param(m11120id = 2) LocationSettingsStates locationSettingsStates) {
        this.zza = status;
