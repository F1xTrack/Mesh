...
public class FloatingActionButton$BaseBehavior<T> extends AbstractC6397lz {
    public FloatingActionButton$BaseBehavior() {
    }

    @Override // p000.AbstractC6397lz
    /* renamed from: a */
    public final boolean mo11247a(View view) {
    ...
    public FloatingActionButton$BaseBehavior(Context context, AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, NG0.f7695i);
