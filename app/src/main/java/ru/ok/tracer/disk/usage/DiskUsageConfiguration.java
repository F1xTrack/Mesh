...
public final class DiskUsageConfiguration implements TracerConfiguration {
    ...
    public static final class Companion {
        ...
        public final DiskUsageConfiguration m100private(InterfaceC6099nZ block) {
            O90.f(block, "block");
    ...
    private DiskUsageConfiguration(Builder builder) {
        ...
        this.excludedPaths = excludedPaths$tracer_disk_usage_release == null ? MN.a : excludedPaths$tracer_disk_usage_release;
    }
}
