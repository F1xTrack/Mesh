...
public final class SessionStateStorage$fileStorage$1 extends AbstractC1676Vg0 implements InterfaceC5908mZ {
    ...
    public final File invoke() {
        return AbstractC5702lU.g(FileUtils.mkdirsChecked(TracerFiles.INSTANCE.getTracerDir(this.this$0.context)), "session.data");
    }
}
