...
public final class TagsStorage {
    ...
    @Metadata(d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010!\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0080\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J7\u0010\f\u001a\u00020\u000b2\f\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00050\u00042\u0006\u0010\u0007\u001a\u00020\u00052\u0006\u0010\b\u001a\u00020\u00052\b\b\u0002\u0010\n\u001a\u00020\tH\u0002¢\u0006\u0004\b\f\u0010\rJ%\u0010\u000e\u001a\u00020\u000b2\f\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00050\u00042\u0006\u0010\u0007\u001a\u00020\u0005H\u0002¢\u0006\u0004\b\u000e\u0010\u000fJ\u0017\u0010\u0013\u001a\u00020\u00122\u0006\u0010\u0011\u001a\u00020\u0010H\u0002¢\u0006\u0004\b\u0013\u0010\u0014J9\u0010\u0016\u001a\u00020\u000b2\f\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00050\u00042\u0006\u0010\u0007\u001a\u00020\u00052\b\u0010\b\u001a\u0004\u0018\u00010\u00052\b\b\u0002\u0010\n\u001a\u00020\tH\u0001¢\u0006\u0004\b\u0015\u0010\rR\u0014\u0010\u0017\u001a\u00020\u00058\u0002X\u0082T¢\u0006\u0006\n\u0004\b\u0017\u0010\u0018¨\u0006\u0019"}, d2 = {"Lru/ok/tracer/session/TagsStorage$Companion;", "", "<init>", "()V", "", "", TagsStorage.FILE_TAGS, "rawKey", "rawValue", "", "limit", "", "addTag", "(Ljava/util/List;Ljava/lang/String;Ljava/lang/String;I)Z", "removeTag", "(Ljava/util/List;Ljava/lang/String;)Z", "Ljava/io/File;", "file", "LTf1;", "deleteIfExists", "(Ljava/io/File;)V", "putTag$tracer_commons_release", "putTag", "FILE_TAGS", "Ljava/lang/String;", "tracer-commons_release"}, k = 1, mv = {1, 7, 1}, xi = 48)
    public static final class Companion {
        ...
        private final boolean addTag(List<String> list, String rawKey, String rawValue, int limit) {
            ...
            String strX2 = AbstractC7538v51.X(31, rawValue);
            ...
            while (true) {
                ...
                String next = it.next();
                if (D51.o(next, strX, false) && next.length() > length && next.charAt(length) == '=') {
                    it.remove();
                    if (D51.i(next, strX2) && next.length() == strX2.length() + length + 1) {
                        list.add(next);
                        return false;
                    }
                }
        ...
        public final boolean putTag$tracer_commons_release(List<String> list, String rawKey, String rawValue, int limit) {
            O90.f(list, TagsStorage.FILE_TAGS);
            O90.f(rawKey, "rawKey");
    ...
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0005\b\u0082\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005¨\u0006\u0006"}, d2 = {"Lru/ok/tracer/session/TagsStorage$PrevTagsState;", "", "(Ljava/lang/String;I)V", "NONE", "LOADED", "CLEAN", "tracer-commons_release"}, k = 1, mv = {1, 7, 1}, xi = 48)
    ...
    private final void ensurePrevTagsState(PrevTagsState toPrevTagsState) {
        ...
        synchronized (this.lock) {
            try {
                ...
                File fileG = AbstractC5702lU.g(TracerFiles.INSTANCE.getTracerDir(this.applicationContext), FILE_TAGS);
                ...
                if (i != 1) {
                    ...
                    if (i2 == 1) {
                        this.prevTagsData = TagsStorageKt.readTags(fileG);
                    } else {
                        if (i2 != 2) {
                            throw new AssertionError("Unreachable code");
                        }
                        INSTANCE.deleteIfExists(fileG);
                    }
                } else {
    ...
    public static final void setKeys$lambda$4(TagsStorage tagsStorage) {
        ...
        try {
            ...
            TagsStorageKt.writeTags(AbstractC5702lU.g(tracerDir, FILE_TAGS), tagsStorage.getTags());
    ...
    public final List<String> getTags() {
        ...
        synchronized (this.tagsData) {
            listB0 = AbstractC8069xu.b0(this.tagsData);
        }
        return listB0;
    }
