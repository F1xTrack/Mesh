...
public final class ConfigurationProperty<T> implements InterfaceC7018sN0 {
    ...
    public T getValue(TracerConfiguration thisRef, InterfaceC5927mf0 property) {
        O90.f(thisRef, "thisRef");
        O90.f(property, "property");
