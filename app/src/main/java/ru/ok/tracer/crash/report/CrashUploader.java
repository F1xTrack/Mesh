...
@Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\b\u0003\b\u0000\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u0017\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004H\u0002¢\u0006\u0004\b\u0007\u0010\bJ\u001b\u0010\u0007\u001a\u00020\u00062\f\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u00040\t¢\u0006\u0004\b\u0007\u0010\u000b¨\u0006\f"}, d2 = {"Lru/ok/tracer/crash/report/CrashUploader;", "", "<init>", "()V", "Lru/ok/tracer/crash/report/CrashDescription;", "descr", "LTf1;", "upload", "(Lru/ok/tracer/crash/report/CrashDescription;)V", "", "crashDescriptions", "(Ljava/util/List;)V", "tracer-crash-report_release"}, k = 1, mv = {1, 7, 1}, xi = 48)
...
public final class CrashUploader {
    ...
    public final void upload(List<CrashDescription> crashDescriptions) {
        O90.f(crashDescriptions, "crashDescriptions");
    ...
    private final void upload(CrashDescription descr) throws JSONException, IOException {
        ...
        String strF = AbstractC5702lU.f(file);
        File file2 = new File(descr.getTagsPath());
        if (!file2.exists()) {
            file2 = null;
        }
        String strF2 = file2 != null ? AbstractC5702lU.f(file2) : null;
        JSONObject jSONObject = new JSONObject(strF);
        if (strF2 != null) {
            jSONObject.put("tags", new JSONArray(strF2));
        }
        String string = jSONObject.toString();
        O90.e(string, "JSONObject(systemStateJs…}\n            .toString()");
        ...
        O90.e(string2, "CoreTracerConfiguration.…)\n            .toString()");
        ...
        try {
            ...
            NetworkResponseHandler.universalHandleResponse$default(NetworkResponseHandler.INSTANCE, contentType, (body2 == null || (bytes = body2.getBytes()) == null) ? null : D51.h(bytes), FEATURE_CRASH_REPORTKt.getFEATURE_CRASH_REPORT().getName(), null, 8, null);
