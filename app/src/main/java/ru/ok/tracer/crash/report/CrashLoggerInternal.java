...
import defpackage.RunnableC3529eA;
...
public final class CrashLoggerInternal {
    ...
    public static final void reportCrash$lambda$0(CrashLoggerInternal crashLoggerInternal, CrashDescription crashDescription, CountDownLatch countDownLatch) {
        O90.f(crashLoggerInternal, "this$0");
        O90.f(countDownLatch, "$lock");
        crashLoggerInternal.crashUploader.upload(AbstractC8259yu.e(crashDescription));
    ...
    private final SystemState withIssueKey(SystemState systemState, String str) {
        return (str == null || str.length() == 0) ? systemState : SystemState.copy$default(systemState, null, 0L, null, null, null, null, null, null, null, false, false, AbstractC7096sn0.k(systemState.getProperties(), new Pair("issueKey", str)), null, 6143, null);
    }
    ...
    public final void reportCrash(Throwable e) {
        ...
        O90.e(allStackTraces, "getAllStackTraces()");
        ...
        if (crashDescriptionSave != null) {
            ...
            TracerThreads.INSTANCE.runOnIo(new RunnableC1557Ts1(this, crashDescriptionSave, countDownLatch, 13));
            long j = O90.a(Looper.myLooper(), Looper.getMainLooper()) ? 5000L : 100000000L;
    ...
    public final void reportNonFatal(Throwable e, String issueKey) {
        ...
        if (crashDescriptionSave$default != null) {
            TracerThreads.INSTANCE.runOnIo(new RunnableC3529eA(this, 0, crashDescriptionSave$default));
        }
    }
}
