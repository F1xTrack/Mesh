...
@Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010\t\n\u0002\b\u0005\b\u0000\u0018\u00002\u00020\u0001B\u001d\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\f\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\u0004\b\u0007\u0010\bJ\u0017\u0010\f\u001a\u00020\u000b2\u0006\u0010\n\u001a\u00020\tH\u0016¢\u0006\u0004\b\f\u0010\rR\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0003\u0010\u000eR\u001a\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0006\u0010\u000fR\u001a\u0010\u0010\u001a\u00020\u00028\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\u0010\u0010\u000e\u001a\u0004\b\u0011\u0010\u0012R\u001a\u0010\u0014\u001a\u00020\u00138\u0016X\u0096\u0004¢\u0006\f\n\u0004\b\u0014\u0010\u0015\u001a\u0004\b\u0016\u0010\u0017¨\u0006\u0018"}, d2 = {"Lru/ok/tracer/base/http/HttpMultipartBody;", "Lru/ok/tracer/base/http/HttpRequestBody;", "", "boundary", "", "Lru/ok/tracer/base/http/HttpPart;", "parts", "<init>", "(Ljava/lang/String;Ljava/util/List;)V", "Ljava/io/OutputStream;", "stream", "LTf1;", "writeTo", "(Ljava/io/OutputStream;)V", "Ljava/lang/String;", "Ljava/util/List;", "contentType", "getContentType", "()Ljava/lang/String;", "", "contentLength", "J", "getContentLength", "()J", "tracer-base_release"}, k = 1, mv = {1, 7, 1}, xi = 48)
...
public final class HttpMultipartBody implements HttpRequestBody {
    ...
    */
    public HttpMultipartBody(java.lang.String r5, java.util.List<ru.ok.tracer.base.http.HttpPart> r6) {
        /*
            r4 = this;
            ...
            java.lang.String r5 = defpackage.AbstractC8235ym.v(r0, r5)
            r4.contentType = r5
        ...
        L2d:
            ...
            ru.ok.tracer.base.http.HttpPart r6 = (ru.ok.tracer.base.http.HttpPart) r6
        ...
        L4a:
            ...
            byte[] r6 = ru.ok.tracer.base.http.HttpMultipartBodyKt.access$getDASHDASH$p()
            int r6 = r6.length
            long r0 = (long) r6
            java.lang.String r6 = r4.boundary
            int r6 = ru.ok.tracer.base.http.HttpMultipartBodyKt.access$getUtf8Length(r6)
            long r2 = (long) r6
            long r0 = r0 + r2
            byte[] r6 = ru.ok.tracer.base.http.HttpMultipartBodyKt.access$getCRLF$p()
            int r6 = r6.length
            long r2 = (long) r6
            long r0 = r0 + r2
        ...
        L67:
            ...
            java.lang.Object r6 = r5.next()
            ru.ok.tracer.base.http.HttpPart r6 = (ru.ok.tracer.base.http.HttpPart) r6
            byte[] r2 = ru.ok.tracer.base.http.HttpMultipartBodyKt.access$getDASHDASH$p()
            int r2 = r2.length
            long r2 = (long) r2
            long r0 = r0 + r2
            java.lang.String r2 = r4.boundary
            int r2 = ru.ok.tracer.base.http.HttpMultipartBodyKt.access$getUtf8Length(r2)
            long r2 = (long) r2
            long r0 = r0 + r2
            byte[] r2 = ru.ok.tracer.base.http.HttpMultipartBodyKt.access$getCRLF$p()
            int r2 = r2.length
            long r2 = (long) r2
            long r0 = r0 + r2
        ...
        L90:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: ru.ok.tracer.base.http.HttpMultipartBody.<init>(java.lang.String, java.util.List):void");
    }
