...
@Metadata(d1 = {"\u0000,\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u001a\u001a\u0010\u0000\u001a\u00020\u0001*\u00020\u00022\u0006\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006\u001a\u0014\u0010\u0007\u001a\u0004\u0018\u00010\u0004*\u00020\u00022\u0006\u0010\u0003\u001a\u00020\u0004\u001a\u001a\u0010\b\u001a\u00020\t*\u00020\u00022\u0006\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006\u001a\u001a\u0010\n\u001a\u00020\u000b*\u00020\u00022\u0006\u0010\f\u001a\u00020\r2\u0006\u0010\u0005\u001a\u00020\u0006¨\u0006\u000e"}, d2 = {"getApplicationInfoCompat", "Landroid/content/pm/ApplicationInfo;", "Landroid/content/pm/PackageManager;", "packageName", "", "flags", "", "getInstallerPackageNameCompat", "getPackageInfoCompat", "Landroid/content/pm/PackageInfo;", "getProviderInfoCompat", "Landroid/content/pm/ProviderInfo;", "component", "Landroid/content/ComponentName;", "tracer-base_release"}, k = 2, mv = {1, 7, 1}, xi = 48)
...
public final class PackageManagerCompat {
    public static final ApplicationInfo getApplicationInfoCompat(PackageManager packageManager, String str, int i) throws PackageManager.NameNotFoundException {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            O90.e(applicationInfo, "getApplicationInfo(packa…pplicationInfoFlags::of))");
            return applicationInfo;
        }
        ApplicationInfo applicationInfo2 = packageManager.getApplicationInfo(str, i);
        O90.e(applicationInfo2, "getApplicationInfo(packageName, flags)");
    ...
    public static final PackageInfo getPackageInfoCompat(PackageManager packageManager, String str, int i) throws PackageManager.NameNotFoundException {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            O90.e(packageInfo, "getPackageInfo(packageNa…er.PackageInfoFlags::of))");
            return packageInfo;
        }
        PackageInfo packageInfo2 = packageManager.getPackageInfo(str, i);
        O90.e(packageInfo2, "getPackageInfo(packageName, flags)");
        return packageInfo2;
    }
