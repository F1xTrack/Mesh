...
public final class SamplingProfilerConfiguration implements TracerConfiguration {
    ...
    public static final class Companion {
        ...
        public final SamplingProfilerConfiguration m102private(InterfaceC6099nZ block) {
            O90.f(block, "block");
