...
@Metadata(m22266d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0003J\u0010\u0010\u0004\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0006H\u0016J\u001a\u0010\u0007\u001a\u0014\u0012\u0010\u0012\u000e\u0012\n\b\u0001\u0012\u0006\u0012\u0002\b\u00030\u00010\t0\bH\u0016¨\u0006\n"}, m22267d2 = {"Lru/ok/tracer/profiler/sampling/SamplingProfilerInitializer;", "Lru/ok/tracer/startup/Initializer;", "Lru/ok/tracer/profiler/sampling/SamplingProfiler;", "()V", "create", "context", "Landroid/content/Context;", "dependencies", "", "Ljava/lang/Class;", "tracer-profiler-sampling_release"}, m22268k = 1, m22269mv = {1, 7, 1}, m22271xi = 48)
...
public final class SamplingProfilerInitializer implements Initializer<SamplingProfiler> {
    ...
    public SamplingProfiler create(Context context) {
        ...
        if (SamplingProfilerConfiguration.INSTANCE.get$tracer_profiler_sampling_release().getEnabled()) {
            Logger.d$default("Sampling profiler initialized!", null, 2, null);
        } else {
            Logger.d$default("Sampling profiler disabled", null, 2, null);
        }
        SamplingProfiler samplingProfiler = SamplingProfiler.INSTANCE;
        samplingProfiler.init$tracer_profiler_sampling_release(context);
