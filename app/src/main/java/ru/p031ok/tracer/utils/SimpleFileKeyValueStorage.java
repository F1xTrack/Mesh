...
public final class SimpleFileKeyValueStorage {
    ...
    private final InterfaceC6434mZ fileSupplier;

    /* renamed from: map$delegate, reason: from kotlin metadata */
    private final Lazy map;

    @Metadata(m22266d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\n\b\u0082\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0017\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004H\u0002¢\u0006\u0004\b\u0007\u0010\bR\u0014\u0010\n\u001a\u00020\t8\u0002X\u0082T¢\u0006\u0006\n\u0004\b\n\u0010\u000bR\u0014\u0010\f\u001a\u00020\t8\u0002X\u0082T¢\u0006\u0006\n\u0004\b\f\u0010\u000bR\u0014\u0010\r\u001a\u00020\t8\u0002X\u0082T¢\u0006\u0006\n\u0004\b\r\u0010\u000bR\u0014\u0010\u000e\u001a\u00020\t8\u0002X\u0082T¢\u0006\u0006\n\u0004\b\u000e\u0010\u000bR\u0014\u0010\u000f\u001a\u00020\t8\u0002X\u0082T¢\u0006\u0006\n\u0004\b\u000f\u0010\u000bR\u0014\u0010\u0010\u001a\u00020\t8\u0002X\u0082T¢\u0006\u0006\n\u0004\b\u0010\u0010\u000bR\u0014\u0010\u0011\u001a\u00020\t8\u0002X\u0082T¢\u0006\u0006\n\u0004\b\u0011\u0010\u000bR\u0014\u0010\u0012\u001a\u00020\t8\u0002X\u0082T¢\u0006\u0006\n\u0004\b\u0012\u0010\u000b¨\u0006\u0013"}, m22267d2 = {"Lru/ok/tracer/utils/SimpleFileKeyValueStorage$Companion;", "", "<init>", "()V", "Ljava/io/DataInputStream;", "inStream", "LTf1;", "skipLegacyConditions", "(Ljava/io/DataInputStream;)V", "", "LEGACY_TYPE_CONDITIONS", "I", "TYPE_BOOLEAN", "TYPE_DOUBLE", "TYPE_FLOAT", "TYPE_INT", "TYPE_LONG", "TYPE_STRING", "VERSION", "tracer-commons_release"}, m22268k = 1, m22269mv = {1, 7, 1}, m22271xi = 48)
    ...
    public SimpleFileKeyValueStorage(InterfaceC6434mZ interfaceC6434mZ) {
        O90.m5968f(interfaceC6434mZ, "fileSupplier");
        this.fileSupplier = interfaceC6434mZ;
        this.map = AbstractC0705LB.m4915b(new SimpleFileKeyValueStorage$map$2(this));
    }
    ...
    */
    public final java.util.Map<java.lang.String, java.lang.Object> init() {
        ...
        L5f:
            ...
            goto Lb1
        L61:
            ru.ok.tracer.utils.SimpleFileKeyValueStorage$Companion r6 = ru.p031ok.tracer.utils.SimpleFileKeyValueStorage.Companion     // Catch: java.lang.Throwable -> L5f
            ru.ok.tracer.utils.SimpleFileKeyValueStorage.Companion.access$skipLegacyConditions(r6, r2)     // Catch: java.lang.Throwable -> L5f
            Tf1 r6 = p000.C8313Tf1.f11463a     // Catch: java.lang.Throwable -> L5f
            goto L9a
        L69:
        ...
        L9a:
            ...
            p000.O90.m5967e(r6, r7)     // Catch: java.lang.Throwable -> L5f
            java.lang.String r7 = "key"
            p000.O90.m5967e(r5, r7)     // Catch: java.lang.Throwable -> L5f
        ...
        Lac:
            r1 = 0
            p000.AbstractC8729aT1.m9749a(r2, r1)     // Catch: java.lang.Exception -> Lb7
            return r4
        Lb1:
        ...
        Lb7:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: ru.p031ok.tracer.utils.SimpleFileKeyValueStorage.init():java.util.Map");
    }
    ...
    private final void putInternal(String key, Object value) {
        ...
        while (true) {
            ...
            O90.m5967e(map2, "oldOne");
            LinkedHashMap linkedHashMapM24789q = AbstractC11077sn0.m24789q(map2);
            if (value == null) {
                linkedHashMapM24789q.remove(key);
            } else {
                linkedHashMapM24789q.put(key, value);
            }
            while (!map.compareAndSet(map2, linkedHashMapM24789q)) {
                if (map.get() != map2) {
                    break;
                }
            }
    ...
    public final void writeMap() {
        try {
            ...
            O90.m5967e(map, "map.get()");
            Map mapM24787o = AbstractC11077sn0.m24787o(map);
            ...
            try {
                ...
                dataOutputStream.writeInt(mapM24787o.size());
                for (Map.Entry entry : mapM24787o.entrySet()) {
    ...
    public final void save() {
        TracerThreads.INSTANCE.runInBgSequential(new RunnableC8352Tz0(27, this));
    }
}
