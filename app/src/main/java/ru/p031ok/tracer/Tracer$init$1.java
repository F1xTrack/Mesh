...
public final class Tracer$init$1 extends AbstractC8418Vg0 implements InterfaceC6434mZ {
    ...
    public final File invoke() {
        return AbstractC6366lU.m22437g(FileUtils.mkdirsChecked(TracerFiles.INSTANCE.getTracerDir(this.$context)), "settings.data");
    }
}
