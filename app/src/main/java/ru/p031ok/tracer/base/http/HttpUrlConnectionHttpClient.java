...
public final class HttpUrlConnectionHttpClient implements HttpClient {
    ...
    private final int getResponseCode(HttpURLConnection connection) throws IOException {
        try {
            ...
            if (message == null || !D51.m1556o(message, "Attempt to read from field 'int com.android.okhttp.okio.Segment.limit'", false)) {
                throw e2;
            }
    ...
    @Override // ru.p031ok.tracer.base.http.HttpClient
    public HttpResponse execute(HttpRequest request) throws IOException {
        ...
        try {
            ...
            if (list == null || (str = (String) AbstractC7167xu.m25957C(list)) == null) {
                str = "application/octet-stream";
            }
            if (responseCode < 400) {
                InputStream inputStream = httpURLConnection.getInputStream();
                O90.m5967e(inputStream, "conn.inputStream");
                ...
                try {
                    bArrM5672f = NP1.m5672f(bufferedInputStream);
                    AbstractC8729aT1.m9749a(bufferedInputStream, null);
                } finally {
                }
            } else {
                InputStream errorStream = httpURLConnection.getErrorStream();
                O90.m5967e(errorStream, "conn.errorStream");
            ...
            O90.m5967e(responseMessage, "responseMessage");
            return new HttpResponse(responseCode, responseMessage, new HttpByteArrayBody(str, bArrM5672f));
        } catch (IOException e) {
