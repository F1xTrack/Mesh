...
@Metadata(m22266d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\u001c\n\u0000\n\u0002\u0018\u0002\n\u0000\bÆ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0014\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u00042\u0006\u0010\u0006\u001a\u00020\u0007J\u0014\u0010\b\u001a\u00020\u00072\f\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u00050\nJ\u0014\u0010\u000b\u001a\u00020\f2\f\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u00050\n¨\u0006\r"}, m22267d2 = {"Lru/ok/tracer/session/SessionStatesSerializer;", "", "()V", "fromJson", "", "Lru/ok/tracer/session/SessionState;", "string", "", "toJson", "states", "", "toJsonArray", "Lorg/json/JSONArray;", "tracer-commons_release"}, m22268k = 1, m22269mv = {1, 7, 1}, m22271xi = 48)
...
public final class SessionStatesSerializer {
    ...
    public final List<SessionState> fromJson(String string) throws JSONException {
        ...
        for (int i = 0; i < length; i++) {
            ...
            O90.m5967e(string2, "getString(\"versionName\")");
    ...
    public final String toJson(Iterable<SessionState> states) {
        O90.m5968f(states, "states");
        String string = toJsonArray(states).toString();
        O90.m5967e(string, "toJsonArray(states).toString()");
        return string;
    }
