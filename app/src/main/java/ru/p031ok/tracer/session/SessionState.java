...
public final /* data */ class SessionState {
    ...
    @Metadata(m22266d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u001e\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0080\u0002¢\u0006\u0002\b\t¨\u0006\n"}, m22267d2 = {"Lru/ok/tracer/session/SessionState$Companion;", "", "()V", "invoke", "Lru/ok/tracer/session/SessionState;", "systemState", "Lru/ok/tracer/SystemState;", "status", "Lru/ok/tracer/session/SessionState$Status;", "invoke$tracer_commons_release", "tracer-commons_release"}, m22268k = 1, m22269mv = {1, 7, 1}, m22271xi = 48)
    ...
    @Metadata(m22266d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0000\n\u0002\u0010\u000e\n\u0002\b\b\b\u0086\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u000f\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006j\u0002\b\u0007j\u0002\b\bj\u0002\b\tj\u0002\b\n¨\u0006\u000b"}, m22267d2 = {"Lru/ok/tracer/session/SessionState$Status;", "", "value", "", "(Ljava/lang/String;ILjava/lang/String;)V", "getValue", "()Ljava/lang/String;", "BLANK", "CRASH", "ANR", "NATIVE", "tracer-commons_release"}, m22268k = 1, m22269mv = {1, 7, 1}, m22271xi = 48)
    public enum Status {
        BLANK("BLANK"),
        CRASH("CRASH"),
        ANR("ANR"),
    ...
    public boolean equals(Object other) {
        ...
        return this.versionCode == sessionState.versionCode && O90.m5963a(this.versionName, sessionState.versionName) && O90.m5963a(this.sessionUuid, sessionState.sessionUuid) && O90.m5963a(this.processName, sessionState.processName) && this.status == sessionState.status && this.isInBackground == sessionState.isInBackground;
    }
    ...
    public int hashCode() {
        ...
        int iM8586e = AbstractC1374Vq.m8586e(AbstractC1374Vq.m8586e(((int) (j ^ (j >>> 32))) * 31, 31, this.versionName), 31, this.sessionUuid);
        String str = this.processName;
        int iHashCode = (this.status.hashCode() + ((iM8586e + (str == null ? 0 : str.hashCode())) * 31)) * 31;
    ...
    public String toString() {
        ...
        return F91.m2540w(sb, this.isInBackground, ')');
    }
}
