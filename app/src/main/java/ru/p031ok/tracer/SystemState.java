...
public final /* data */ class SystemState {
    ...
    public SystemState(String str, long j, String str2, String str3, String str4, String str5, String str6, String str7, String str8, boolean z, boolean z2, Map<String, String> map, Set<HostedTracerLibraryInfo> set) {
        ...
        O90.m5968f(str4, "sessionUuid");
        O90.m5968f(str5, "device");
        O90.m5968f(str6, "deviceId");
        O90.m5968f(str7, "vendor");
        O90.m5968f(str8, "osVersion");
        O90.m5968f(map, "properties");
        O90.m5968f(set, "hostedLibrariesInfo");
    ...
    public final SystemState copy(String versionName, long versionCode, String packageName, String buildUuid, String sessionUuid, String device, String deviceId, String vendor, String osVersion, boolean isInBackground, boolean isRooted, Map<String, String> properties, Set<HostedTracerLibraryInfo> hostedLibrariesInfo) {
        ...
        O90.m5968f(sessionUuid, "sessionUuid");
        O90.m5968f(device, "device");
        O90.m5968f(deviceId, "deviceId");
        O90.m5968f(vendor, "vendor");
        O90.m5968f(osVersion, "osVersion");
        O90.m5968f(properties, "properties");
        O90.m5968f(hostedLibrariesInfo, "hostedLibrariesInfo");
    ...
    public boolean equals(Object other) {
        ...
        return O90.m5963a(this.versionName, systemState.versionName) && this.versionCode == systemState.versionCode && O90.m5963a(this.packageName, systemState.packageName) && O90.m5963a(this.buildUuid, systemState.buildUuid) && O90.m5963a(this.sessionUuid, systemState.sessionUuid) && O90.m5963a(this.device, systemState.device) && O90.m5963a(this.deviceId, systemState.deviceId) && O90.m5963a(this.vendor, systemState.vendor) && O90.m5963a(this.osVersion, systemState.osVersion) && this.isInBackground == systemState.isInBackground && this.isRooted == systemState.isRooted && O90.m5963a(this.properties, systemState.properties) && O90.m5963a(this.hostedLibrariesInfo, systemState.hostedLibrariesInfo);
    }
    ...
    public int hashCode() {
        ...
        int iM8586e = AbstractC1374Vq.m8586e((iHashCode + ((int) (j ^ (j >>> 32)))) * 31, 31, this.packageName);
        String str = this.buildUuid;
        int iM8586e2 = AbstractC1374Vq.m8586e(AbstractC1374Vq.m8586e(AbstractC1374Vq.m8586e(AbstractC1374Vq.m8586e(AbstractC1374Vq.m8586e((iM8586e + (str == null ? 0 : str.hashCode())) * 31, 31, this.sessionUuid), 31, this.device), 31, this.deviceId), 31, this.vendor), 31, this.osVersion);
        boolean z = this.isInBackground;
        int i = z;
        if (z != 0) {
            i = 1;
        }
        int i2 = (iM8586e2 + i) * 31;
    ...
    public final SystemState withCurrentDate$tracer_commons_release() {
        return copy$default(this, null, 0L, null, null, null, null, null, null, null, false, false, AbstractC11077sn0.m24783k(this.properties, new Pair(NotificationConstants.DATE, DateTimeUtils.formatISO8601(new Date()))), null, 6143, null);
    }
}
