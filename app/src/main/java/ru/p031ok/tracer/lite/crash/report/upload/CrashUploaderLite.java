package ru.p031ok.tracer.lite.crash.report.upload;
...
import ru.p031ok.tracer.base.commands.CommandsHandler;
...
import ru.p031ok.tracer.lite.TracerLibraryInfo;
import ru.p031ok.tracer.lite.TracerLite;
import ru.p031ok.tracer.lite.crash.report.LogEntryLite;
import ru.p031ok.tracer.lite.crash.report.TracerCrashReportLiteKt;
import ru.p031ok.tracer.lite.limits.TracerLiteLimits;
import ru.p031ok.tracer.lite.upload.TracerLiteHttpClientHolder;
import ru.p031ok.tracer.lite.upload.UploadBeanUtilsLite;
...
public final class CrashUploaderLite {
    ...
    public CrashUploaderLite(TracerLite tracerLite, TracerLiteLimits tracerLiteLimits) {
        ...
        O90.m5968f(tracerLiteLimits, "limits");
    ...
    public final void upload(Throwable e, String issueKey, List<LogEntryLite> logs, List<String> tags) {
        ...
        try {
            ...
            O90.m5967e(string2, "uploadBean.toString()");
            StringBuilder sb = new StringBuilder();
            ThrowableUtils.appendStackTraceTo(e, sb);
            String string3 = sb.toString();
            O90.m5967e(string3, "StringBuilder().apply(builderAction).toString()");
            ...
            O90.m5967e(string4, "tracer.configuration.api…}\n            .toString()");
            ...
            try {
                ...
                try {
                    ...
                    this.commandHandler.handleResponse(contentType, (body2 == null || (bytes = body2.getBytes()) == null) ? null : D51.m1549h(bytes));
                    if (statusCode == 200) {
