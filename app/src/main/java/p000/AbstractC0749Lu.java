...
public abstract class AbstractC0749Lu {

    /* renamed from: a */
    public static final ThreadLocal f6923a = new ThreadLocal();

    /* renamed from: a */
    public static int m5128a(double d, double d2, double d3) {
    ...
    /* renamed from: b */
    public static int m5129b(int i, float f, int i2) {
        float f2 = 1.0f - f;
        return Color.argb((int) ((Color.alpha(i2) * f) + (Color.alpha(i) * f2)), (int) ((Color.red(i2) * f) + (Color.red(i) * f2)), (int) ((Color.green(i2) * f) + (Color.green(i) * f2)), (int) ((Color.blue(i2) * f) + (Color.blue(i) * f2)));
    }

    /* renamed from: c */
    public static double m5130c(int i) {
        ThreadLocal threadLocal = f6923a;
    ...
    /* renamed from: d */
    public static int m5131d(int i, int i2) {
        int iAlpha = Color.alpha(i2);
        int iAlpha2 = Color.alpha(i);
        int i3 = 255 - (((255 - iAlpha2) * (255 - iAlpha)) / KotlinVersion.MAX_COMPONENT_VALUE);
        return Color.argb(i3, m5132e(Color.red(i), iAlpha2, Color.red(i2), iAlpha, i3), m5132e(Color.green(i), iAlpha2, Color.green(i2), iAlpha, i3), m5132e(Color.blue(i), iAlpha2, Color.blue(i2), iAlpha, i3));
    }

    /* renamed from: e */
    public static int m5132e(int i, int i2, int i3, int i4, int i5) {
        if (i5 == 0) {
            return 0;
        }
    ...
    /* renamed from: f */
    public static int m5133f(int i, int i2) {
        if (i2 < 0 || i2 > 255) {
