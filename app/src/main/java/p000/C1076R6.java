...
public class C1076R6 extends RadioButton implements InterfaceC7939Ma1, InterfaceC7991Na1 {

    /* renamed from: a */
    public final C6596p6 f9996a;

    /* renamed from: b */
    public final C4218i3 f9997b;

    /* renamed from: c */
    public final C6532o7 f9998c;

    /* renamed from: d */
    public C0762M6 f9999d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1076R6(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, R.attr.radioButtonStyle);
        AbstractC7835Ka1.m4676a(context);
        R91.m6917a(this, getContext());
        C6596p6 c6596p6 = new C6596p6(this, 1);
        this.f9996a = c6596p6;
        c6596p6.m23618h(attributeSet, R.attr.radioButtonStyle);
        C4218i3 c4218i3 = new C4218i3(this);
        this.f9997b = c4218i3;
        c4218i3.m18947l(attributeSet, R.attr.radioButtonStyle);
        C6532o7 c6532o7 = new C6532o7(this);
        this.f9998c = c6532o7;
        c6532o7.m23347f(attributeSet, R.attr.radioButtonStyle);
        getEmojiTextViewHelper().m5262b(attributeSet, R.attr.radioButtonStyle);
    }

    private C0762M6 getEmojiTextViewHelper() {
        if (this.f9999d == null) {
            this.f9999d = new C0762M6(this);
        }
        return this.f9999d;
    }
    ...
    public final void drawableStateChanged() {
        ...
        C4218i3 c4218i3 = this.f9997b;
        if (c4218i3 != null) {
            c4218i3.m18937a();
        }
        C6532o7 c6532o7 = this.f9998c;
        if (c6532o7 != null) {
            c6532o7.m23344b();
        }
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f9998c.m23345d();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f9998c.m23346e();
    }
