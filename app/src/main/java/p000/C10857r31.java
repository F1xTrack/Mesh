...
public final class C10857r31 implements Parcelable.Creator {

    /* renamed from: a */
    public final /* synthetic */ int f41323a;

    public /* synthetic */ C10857r31(int i) {
        this.f41323a = i;
    }
    ...
    public final Object createFromParcel(Parcel parcel) {
        switch (this.f41323a) {
            case 0:
                return new C10985s31();
            case 1:
                return new C11369v31(parcel);
            case 2:
                C8807b41 c8807b41 = new C8807b41();
                c8807b41.f16733a = parcel.readInt();
                c8807b41.f16734b = parcel.readInt();
                c8807b41.f16736d = parcel.readInt() == 1;
                int i = parcel.readInt();
                if (i > 0) {
                    int[] iArr = new int[i];
                    c8807b41.f16735c = iArr;
                    parcel.readIntArray(iArr);
                }
                return c8807b41;
            case 3:
                C8935c41 c8935c41 = new C8935c41();
                c8935c41.f17282a = parcel.readInt();
                c8935c41.f17283b = parcel.readInt();
                int i2 = parcel.readInt();
                c8935c41.f17284c = i2;
                if (i2 > 0) {
                    int[] iArr2 = new int[i2];
                    c8935c41.f17285d = iArr2;
                ...
                if (i3 > 0) {
                    ...
                    c8935c41.f17287f = iArr3;
                    parcel.readIntArray(iArr3);
                }
                c8935c41.f17289h = parcel.readInt() == 1;
                c8935c41.f17290i = parcel.readInt() == 1;
                c8935c41.f17291j = parcel.readInt() == 1;
                c8935c41.f17288g = parcel.readArrayList(C8807b41.class.getClassLoader());
                return c8935c41;
            case 4:
                return new C9198e51(parcel);
            case 5:
                return new C10994s71(parcel);
            case 6:
                ...
                return new C10742q91(string, string2, P70.m6235v(strArrCreateStringArray));
            case 7:
                return new C10156la1(parcel.readInt(), parcel.readInt(), parcel.readInt(), parcel.readInt());
            case 8:
                return new C11308ua1(parcel.readLong(), parcel.readLong());
            case 9:
                return new C7731Ia1(parcel.readLong(), parcel.readLong());
            case 10:
                return new Trace(parcel, false);
            case 11:
                return new C9013ch1(parcel);
            case 12:
                return new C9796im1(parcel);
            case 13:
                return new C9924jm1(parcel);
            case 14:
            ...
            case 15:
                ...
                return new C8243Rw1(i6, i7, intent);
            case 16:
            ...
            case 17:
                ...
                return new GoogleSignInOptions(i9, arrayListCreateTypedList3, account, z, z2, z3, strCreateString9, strCreateString10, GoogleSignInOptions.m11105m0(arrayListCreateTypedList2), strCreateString11);
            case 18:
                ...
                return new C9306ex1(strCreateString12, arrayListCreateStringList);
            case 19:
                ...
                return new C9562gx1(i10, zatVar);
            case 20:
                ...
                return new C9946jx1(i11, connectionResult, zavVar);
            case 21:
            ...
            case 24:
                ...
                C9124dW1 c9124dW1 = new C9124dW1();
                c9124dW1.f26129a = i12;
                c9124dW1.f26130b = strCreateString16;
                c9124dW1.f26131c = strCreateString18;
                c9124dW1.f26132d = strCreateString17;
                return c9124dW1;
            case 25:
                ...
                C9382fX1 c9382fX1 = new C9382fX1();
                c9382fX1.f27226a = d;
                c9382fX1.f27227b = d2;
                return c9382fX1;
            case 26:
                ...
                AY1 ay1 = new AY1();
                ay1.f241a = strCreateString19;
                ay1.f242b = strCreateString20;
                ay1.f243c = strCreateString21;
                ay1.f244d = strCreateString22;
                ay1.f245e = strCreateString23;
                ay1.f246f = strCreateString24;
                ay1.f247g = strCreateString25;
                return ay1;
            case 27:
            ...
            case AvailableCode.APP_IS_BACKGROUND_OR_LOCKED /* 28 */:
                ...
                C9825j02 c9825j02 = new C9825j02();
                c9825j02.f34839a = strCreateString27;
                c9825j02.f34840b = strCreateString28;
                return c9825j02;
            default:
                ...
                K02 k02 = new K02();
                k02.f5834a = strCreateString29;
                k02.f5835b = strCreateString30;
                return k02;
        }
    }
    ...
    public final Object[] newArray(int i) {
        switch (this.f41323a) {
            case 0:
                return new C10985s31[i];
            case 1:
                return new C11369v31[i];
            case 2:
                return new C8807b41[i];
            case 3:
                return new C8935c41[i];
            case 4:
                return new C9198e51[i];
            case 5:
                return new C10994s71[i];
            case 6:
                return new C10742q91[i];
            case 7:
                return new C10156la1[i];
            case 8:
                return new C11308ua1[i];
            case 9:
                return new C7731Ia1[i];
            case 10:
                return new Trace[i];
            case 11:
                return new C9013ch1[i];
            case 12:
                return new C9796im1[i];
            case 13:
                return new C9924jm1[i];
            case 14:
                return new P10[i];
            case 15:
                return new C8243Rw1[i];
            case 16:
                return new GoogleSignInAccount[i];
            case 17:
                return new GoogleSignInOptions[i];
            case 18:
                return new C9306ex1[i];
            case 19:
                return new C9562gx1[i];
            case 20:
                return new C9946jx1[i];
            case 21:
                return new SignInAccount[i];
            case 22:
                return new SignInConfiguration[i];
            case 23:
                return new C0308Et[i];
            case 24:
                return new C9124dW1[i];
            case 25:
                return new C9382fX1[i];
            case 26:
                return new AY1[i];
            case 27:
                return new LZ1[i];
            case AvailableCode.APP_IS_BACKGROUND_OR_LOCKED /* 28 */:
                return new C9825j02[i];
            default:
                return new K02[i];
        }
    }
