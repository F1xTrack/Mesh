...
public final class C8509Wz1 implements InterfaceC7885Kz1, Iterable {

    /* renamed from: a */
    public final String f13472a;

    public C8509Wz1(String str) {
        if (str == null) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C8509Wz1) {
            return this.f13472a.equals(((C8509Wz1) obj).f13472a);
        }
        return false;
    }
  ...
  0x01ac: PHI (r19v2 java.lang.String) = (r19v1 java.lang.String), (r19v3 java.lang.String) binds: [B:395:0x01aa, B:391:0x0195] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public final p000.InterfaceC7885Kz1 mo1960q(java.lang.String r23, p000.C10919rY0 r24, java.util.ArrayList r25) {
        /*
            Method dump skipped, instructions count: 1784
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.C8509Wz1.mo1960q(java.lang.String, rY0, java.util.ArrayList):Kz1");
    }

    public final String toString() {
        return AbstractC1374Vq.m8593l(new StringBuilder("\""), this.f13472a, "\"");
    }

    @Override // p000.InterfaceC7885Kz1
    public final InterfaceC7885Kz1 zzc() {
        return new C8509Wz1(this.f13472a);
    }

    @Override // p000.InterfaceC7885Kz1
    public final Boolean zzd() {
        return Boolean.valueOf(!this.f13472a.isEmpty());
    }
