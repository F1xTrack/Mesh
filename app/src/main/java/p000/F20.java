...
public final class F20 {
    ...
    /* renamed from: g */
    public static final boolean f3026g;

    /* renamed from: h */
    public static final boolean f3027h;

    /* renamed from: i */
    public static final File f3028i;

    /* renamed from: j */
    public static volatile F20 f3029j;

    /* renamed from: k */
    public static volatile int f3030k;
    ...
    /* renamed from: f */
    public final AtomicBoolean f3036f = new AtomicBoolean(false);

    static {
        int i = Build.VERSION.SDK_INT;
        f3026g = i < 29;
        f3027h = i >= 26;
        f3028i = new File("/proc/self/fd");
        f3030k = -1;
    }
    ...
    */
    public F20() {
        ...
        Lb5:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.F20.<init>():void");
    }

    /* renamed from: a */
    public static F20 m2487a() {
        if (f3029j == null) {
    ...
    /* renamed from: b */
    public final boolean m2488b(int i, int i2, boolean z, boolean z2) {
        int i3;
        boolean z3;
        if (!z || !this.f3031a || !f3027h) {
            return false;
        }
        if ((f3026g && !this.f3036f.get()) || z2 || i < (i3 = this.f3033c) || i2 < i3) {
            return false;
        }
        synchronized (this) {
            try {
                int i4 = this.f3034d + 1;
                this.f3034d = i4;
                if (i4 >= 50) {
                    this.f3034d = 0;
                    this.f3035e = ((long) f3028i.list().length) < ((long) (f3030k != -1 ? f3030k : this.f3032b));
                }
                z3 = this.f3035e;
            } catch (Throwable th) {
                throw th;
