...
public abstract class AbstractC10596p12 {
    /* renamed from: a */
    public static WritableArray m23592a(Spannable spannable, Layout layout, TextPaint textPaint, Context context) {
    ...
    /* renamed from: b */
    public static LinkedList m23593b(List list) throws ParseException {
        if (list == null) {
            return null;
        }
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (obj == null) {
                throw new ParseException(AbstractC7222ym.m26230g(i, "The X.509 certificate at position ", " must not be null"), 0);
            }
            if (!(obj instanceof String)) {
                throw new ParseException(AbstractC7222ym.m26230g(i, "The X.509 certificate at position ", " must be encoded as a Base64 string"), 0);
            }
            linkedList.add(new C0672Kf((String) obj));
        }
        return linkedList;
    }
}
