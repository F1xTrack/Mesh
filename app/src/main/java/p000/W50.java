...
public abstract class W50 {
    ...
    /* renamed from: a */
    public static final C9367fQ0 f12992a;
    ...
    static {
        ...
        AbstractC9088dE1.m17509a(192, objArr);
        f12992a = P70.m6232s(192, objArr);
    }

    /* renamed from: a */
    public static String m8670a(int i) {
        if (i >= 0) {
            C9367fQ0 c9367fQ0 = f12992a;
            if (i < c9367fQ0.size()) {
                return (String) c9367fQ0.get(i);
            }
        }
        return null;
    }
