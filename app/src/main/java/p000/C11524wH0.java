...
public final class C11524wH0 extends BroadcastReceiver {

    /* renamed from: a */
    public final /* synthetic */ int f44757a;

    /* renamed from: b */
    public final /* synthetic */ RNDeviceModule f44758b;

    public /* synthetic */ C11524wH0(RNDeviceModule rNDeviceModule, int i) {
        this.f44757a = i;
        this.f44758b = rNDeviceModule;
    }
    ...
    public final void onReceive(Context context, Intent intent) {
        switch (this.f44757a) {
            case 0:
                RNDeviceModule rNDeviceModule = this.f44758b;
                ...
                break;
            case 1:
                RNDeviceModule rNDeviceModule2 = this.f44758b;
                ...
                break;
            case 2:
                RNDeviceModule rNDeviceModule3 = this.f44758b;
                ...
                break;
            default:
                RNDeviceModule rNDeviceModule4 = this.f44758b;
