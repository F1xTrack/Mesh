...
public final class C11683xX0 implements X509TrustManager {

    /* renamed from: a */
    public final /* synthetic */ int f45669a;

    /* renamed from: b */
    public final ArrayList f45670b;

    public C11683xX0(List list) throws NoSuchAlgorithmException, IOException, KeyStoreException, CertificateException {
        this.f45669a = 1;
        ArrayList arrayList = new ArrayList();
        X509TrustManager x509TrustManagerM25910a = m25910a(null);
        if (x509TrustManagerM25910a != null) {
            arrayList.add(x509TrustManagerM25910a);
        }
        if (!list.isEmpty()) {
            ...
            X509TrustManager x509TrustManagerM25910a2 = m25910a(keyStore);
            if (x509TrustManagerM25910a2 != null) {
                arrayList.add(x509TrustManagerM25910a2);
            }
        }
        ...
        while (it3.hasNext()) {
            ...
            arrayList3.add(new C7613Ft1(x509TrustManager, new X509TrustManagerExtensions(x509TrustManager)));
        }
        this.f45670b = arrayList3;
    }

    /* renamed from: a */
    public static X509TrustManager m25910a(KeyStore keyStore) throws NoSuchAlgorithmException, KeyStoreException {
        try {
    ...
    public final void checkClientTrusted(X509Certificate[] x509CertificateArr, String str) throws CertificateException {
        switch (this.f45669a) {
            case 0:
                Iterator it = this.f45670b.iterator();
                while (it.hasNext()) {
                    try {
            ...
            default:
                ...
                while (it2.hasNext()) {
                    try {
                        ((C7613Ft1) it2.next()).f3461a.checkServerTrusted(x509CertificateArr, str);
                        return;
    ...
    public final void checkServerTrusted(X509Certificate[] x509CertificateArr, String str) throws CertificateException {
        switch (this.f45669a) {
            case 0:
                ...
                ArrayList arrayList = this.f45670b;
    ...
    public final X509Certificate[] getAcceptedIssuers() {
        switch (this.f45669a) {
            ...
            default:
                ArrayList arrayList2 = this.f45670b;
                ArrayList arrayList3 = new ArrayList();
                Iterator it2 = arrayList2.iterator();
                while (it2.hasNext()) {
                    X509Certificate[] acceptedIssuers = ((C7613Ft1) it2.next()).f3461a.getAcceptedIssuers();
                    O90.m5967e(acceptedIssuers, "it.trustManager.acceptedIssuers");
                    AbstractC0246Du.m1920m(arrayList3, AbstractC0576J8.m4173D(acceptedIssuers));
                }
    ...
    public C11683xX0(InputStream inputStream) throws IOException {
        this.f45669a = 0;
        ...
        if (inputStream != null) {
            ...
            try {
                try {
                    ...
                    for (TrustManager trustManager : trustManagers) {
                        if (trustManager instanceof X509TrustManager) {
                            this.f45670b.add((X509TrustManager) trustManager);
                        }
                    }
                    B12.m464a(inputStream);
