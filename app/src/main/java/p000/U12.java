...
public abstract class U12 {
    /* renamed from: a */
    public static ByteBuffer m7864a(E80 e80) throws C9039cs0 {
        int i;
        int i2 = e80.f2508f;
        int i3 = 0;
        if (i2 == -1) {
            Bitmap bitmapCopy = (Bitmap) Preconditions.checkNotNull(e80.f2503a);
        ...
        if (i2 != 35) {
            if (i2 != 842094169) {
                throw new C9039cs0("Unsupported image format", 13);
            }
        ...
        if (z) {
            ...
            m7865b(planeArr[0], i21, i22, bArr, 0, 1);
            m7865b(planeArr[1], i21, i22, bArr, i23 + 1, 2);
            m7865b(planeArr[2], i21, i22, bArr, i23, 2);
        }
        return ByteBuffer.wrap(bArr);
    }

    /* renamed from: b */
    public static final void m7865b(Image.Plane plane, int i, int i2, byte[] bArr, int i3, int i4) {
