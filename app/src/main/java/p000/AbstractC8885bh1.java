...
public abstract class AbstractC8885bh1 {

    /* renamed from: a */
    public static final Uri f17121a = Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "display_photo");

    /* renamed from: a */
    public static String m10480a(ContentResolver contentResolver, Uri uri) {
        Uri uri2;
        String str;
        String[] strArr;
        ...
        String string = null;
        if (!RemoteMessageConst.Notification.CONTENT.equals(m10481b(uri))) {
            if ("file".equals(m10481b(uri))) {
                return uri.getPath();
            }
            return null;
        }
    ...
    /* renamed from: b */
    public static String m10481b(Uri uri) {
        if (uri == null) {
            return null;
        }
    ...
    /* renamed from: c */
    public static boolean m10482c(Uri uri) {
    ...
    /* renamed from: d */
    public static boolean m10483d(Uri uri) {
        String strM10481b = m10481b(uri);
        return "https".equals(strM10481b) || "http".equals(strM10481b);
    }
}
