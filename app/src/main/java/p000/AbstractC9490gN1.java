...
public abstract class AbstractC9490gN1 {

    /* renamed from: a */
    public static final KG1 f27708a;

    static {
        if (HM1.f4247e && HM1.f4246d) {
            int i = PD1.f8909a;
        }
        f27708a = new KG1(3);
    }
    ...
    /* renamed from: a */
    public static int m18475a(byte[] bArr, int i, int i2) {
        int i3 = i2 - i;
        byte b = bArr[i - 1];
        if (i3 != 0) {
            if (i3 == 1) {
                return m18479e(b, bArr[i]);
            }
            if (i3 != 2) {
    ...
    /* renamed from: b */
    public static int m18476b(String str, byte[] bArr, int i, int i2) {
        int i3;
        int i4;
        int i5;
        char cCharAt;
        ...
        while (i6 < length) {
            ...
            if (cCharAt2 < 128 && i7 < i3) {
                ...
                if ((cCharAt2 >= 55296 && cCharAt2 <= 57343) || i7 > i3 - 3) {
                    ...
                    throw new C8845bN1(i6 - 1, length);
                }
    ...
    /* renamed from: c */
    public static int m18477c(String str) {
        int length = str.length();
        int i = 0;
        int i2 = 0;
    ...
    /* renamed from: d */
    public static boolean m18478d(byte[] bArr, int i, int i2) {
        f27708a.getClass();
        return KG1.m4592a(0, bArr, i, i2) == 0;
    }

    /* renamed from: e */
    public static int m18479e(int i, int i2) {
        if (i > -12 || i2 > -65) {
            return -1;
        }
        return i ^ (i2 << 8);
