...
public final class C11255uA0 {

    /* renamed from: a */
    public char f43543a;

    /* renamed from: b */
    public final float[] f43544b;

    public C11255uA0(char c, float[] fArr) {
        this.f43543a = c;
        this.f43544b = fArr;
    }

    /* renamed from: a */
    public static void m25124a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
        double d;
        double d2;
        ...
        if (d19 == ConfigValue.DOUBLE_DEFAULT_VALUE) {
            return;
        }
        double d20 = (1.0d / d19) - 0.25d;
        if (d20 < ConfigValue.DOUBLE_DEFAULT_VALUE) {
            float fSqrt = (float) (Math.sqrt(d19) / 1.99999d);
            m25124a(path, f, f2, f3, f4, f5 * fSqrt, f6 * fSqrt, f7, z, z2);
            return;
        }
        ...
        if (z2 != (dAtan22 >= ConfigValue.DOUBLE_DEFAULT_VALUE)) {
    ...
    /* renamed from: b */
    public static void m25125b(C11255uA0[] c11255uA0Arr, Path path) {
        int i;
        int i2;
        char c;
        int i3;
        ...
        float f11;
        float f12;
        C11255uA0[] c11255uA0Arr2 = c11255uA0Arr;
        int i5 = 6;
        float[] fArr = new float[6];
        int length = c11255uA0Arr2.length;
        int i6 = 0;
        char c2 = 'm';
        while (i6 < length) {
            C11255uA0 c11255uA02 = c11255uA0Arr2[i6];
            char c3 = c11255uA02.f43543a;
            float f13 = fArr[0];
            float f14 = fArr[1];
            float f15 = fArr[2];
            float f16 = fArr[3];
            ...
            int i7 = 0;
            while (true) {
                float[] fArr2 = c11255uA02.f43544b;
                if (i7 < fArr2.length) {
                    if (c3 != 'A') {
                        if (c3 != 'C') {
                            if (c3 == 'H') {
                                ...
                                c11255uA0 = c11255uA02;
                                i3 = i6;
                                m25124a(path, f46, f45, fArr2[i28] + f46, fArr2[i29] + f45, fArr2[i2], fArr2[i2 + 1], fArr2[i2 + 2], fArr2[i2 + 3] != 0.0f, fArr2[i2 + 4] != 0.0f);
                                f21 = f46 + fArr2[i28];
                                f22 = f45 + fArr2[i29];
                            }
                            i7 = i2 + i;
                            c11255uA02 = c11255uA0;
                            length = i4;
                            c2 = c;
                            c3 = c2;
                            i6 = i3;
                        ...
                        int i34 = i2 + 5;
                        int i35 = i2 + 6;
                        m25124a(path, f21, f22, fArr2[i34], fArr2[i35], fArr2[i2], fArr2[i2 + 1], fArr2[i2 + 2], fArr2[i2 + 3] != 0.0f, fArr2[i2 + 4] != 0.0f);
                        f21 = fArr2[i34];
                        f22 = fArr2[i35];
                    }
                    f16 = f22;
            ...
            fArr[4] = f19;
            fArr[5] = f20;
            c2 = c11255uA02.f43543a;
            i6++;
            c11255uA0Arr2 = c11255uA0Arr;
            length = length;
            i5 = 6;
        }
    }

    public C11255uA0(C11255uA0 c11255uA0) {
        this.f43543a = c11255uA0.f43543a;
        float[] fArr = c11255uA0.f43544b;
        this.f43544b = AbstractC11658xK1.m25838b(fArr, fArr.length);
    }
}
