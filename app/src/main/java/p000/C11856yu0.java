...
public class C11856yu0 {
    private static final String TAG = "yu0";
    private final boolean DEBUG_MODE;
    private final RectF mBoundingBox;
    private final C7522Ea0 mJSResponderHandler;
    private boolean mLayoutAnimationEnabled;
    private final C9145dh0 mLayoutAnimator;
    private HashMap<Integer, Set<Integer>> mPendingDeletionsForTag;
    private final SparseBooleanArray mRootTags;
    private final RootViewManager mRootViewManager;
    private final SparseArray<ViewManager> mTagsToViewManagers;
    private final SparseArray<View> mTagsToViews;
    private final ComponentCallbacks2C7803Jk1 mViewManagers;

    public C11856yu0(ComponentCallbacks2C7803Jk1 componentCallbacks2C7803Jk1) {
        RootViewManager rootViewManager = new RootViewManager();
        this.DEBUG_MODE = false;
        this.mJSResponderHandler = new C7522Ea0();
        this.mLayoutAnimator = new C9145dh0();
        this.mBoundingBox = new RectF();
        this.mViewManagers = componentCallbacks2C7803Jk1;
    ...
    /* renamed from: c */
    public static String m26281c(ViewGroup viewGroup, ViewGroupManager viewGroupManager, int[] iArr, C8581Yj1[] c8581Yj1Arr, int[] iArr2) {
        ...
        if (c8581Yj1Arr != null) {
            sb.append("  viewsToAdd(" + c8581Yj1Arr.length + "): [\n");
            for (int i7 = 0; i7 < c8581Yj1Arr.length; i7 += 16) {
                int i8 = 0;
                while (true) {
                    int i9 = i7 + i8;
                    if (i9 >= c8581Yj1Arr.length || i8 >= 16) {
                        break;
                    }
                    sb.append("[" + c8581Yj1Arr[i9].f14494b + StringUtils.COMMA + c8581Yj1Arr[i9].f14493a + "],");
                    i8++;
                }
                sb.append("\n");
            }
    ...
    /* renamed from: b */
    public final void m26282b(View view, int[] iArr) {
    ...
    public synchronized void createView(S91 s91, int i, String str, NM0 nm0) {
        ...
        MT1.m5371b("NativeViewHierarchyManager_createView".concat(""));
        try {
            ViewManager viewManagerM4401a = this.mViewManagers.m4401a(str);
            this.mTagsToViews.put(i, viewManagerM4401a.createView(i, s91, nm0, null, this.mJSResponderHandler));
            this.mTagsToViewManagers.put(i, viewManagerM4401a);
        } finally {
            Trace.endSection();
        }
    }
    ...
    /* renamed from: d */
    public final Set m26283d(int i) {
    ...
    public synchronized int findTargetTagForTouch(int i, float f, float f2) {
        ...
        return AbstractC11946zb1.m26475a(f, f2, (ViewGroup) view, AbstractC11946zb1.f46885a);
    }

    public long getInstanceHandle(int i) {
        View view = this.mTagsToViews.get(i);
        if (view == null) {
            throw new C8810b60(AbstractC11153tN0.m24909u(i, "Unable to find view for tag: "));
        }
        Long l = (Long) view.getTag(R.id.view_tag_instance_handle);
        if (l != null) {
            return l.longValue();
        }
        throw new C8810b60(AbstractC11153tN0.m24909u(i, "Unable to find instanceHandle for tag: "));
    }
    ...
    */
    public synchronized void manageChildren(int r18, int[] r19, p000.C8581Yj1[] r20, int[] r21) {
        /*
            Method dump skipped, instructions count: 529
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.C11856yu0.manageChildren(int, int[], Yj1[], int[]):void");
    }
    ...
    public synchronized void measure(int i, int[] iArr) {
        ...
        View view = this.mTagsToViews.get(i);
        if (view == null) {
            throw new C7720Hv0("No native view for " + i + " currently exists");
        }
        View view2 = (View) YQ1.m9298b(view);
        if (view2 == null) {
            throw new C7720Hv0("Native view " + i + " is no longer on screen");
        }
        m26282b(view2, iArr);
        int i2 = iArr[0];
        int i3 = iArr[1];
    ...
    public final synchronized View resolveView(int i) {
        ...
        view = this.mTagsToViews.get(i);
        if (view == null) {
            throw new C8810b60("Trying to resolve view with tag " + i + " which doesn't exist");
        }
        return view;
    }
    ...
    public final synchronized ViewManager resolveViewManager(int i) {
        ...
        if (viewManager == null) {
            throw new C8810b60("ViewManager for tag " + i + " could not be found.\n");
        }
        return viewManager;
    }
    ...
    public void sendAccessibilityEvent(int i, int i2) {
        View view = this.mTagsToViews.get(i);
        if (view == null) {
            throw new RetryableMountingLayerException(AbstractC11153tN0.m24909u(i, "Could not find view with tag "));
        }
        ...
        try {
            ...
            for (int i2 = 0; i2 < readableArray.size(); i2++) {
                ...
                if (view == null) {
                    ...
                    sb.append("\n detail: ");
                    C8581Yj1[] c8581Yj1Arr = new C8581Yj1[readableArray.size()];
                    for (int i3 = 0; i3 < readableArray.size(); i3++) {
                        c8581Yj1Arr[i3] = new C8581Yj1(readableArray.getInt(i3), i3);
                    }
                    sb.append(m26281c(viewGroup, viewGroupManager, null, c8581Yj1Arr, null));
    ...
    public synchronized void updateLayout(int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        MT1.m5371b("NativeViewHierarchyManager_updateLayout".concat(""));
        try {
            ...
            if (!this.mRootTags.get(i)) {
                ...
                if (!(nativeModule instanceof J50)) {
                    throw new C8810b60("Trying to use view with tag " + i + " as a parent, but its Manager doesn't implement IViewManagerWithChildren");
                }
