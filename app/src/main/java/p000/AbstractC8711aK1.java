...
public abstract class AbstractC8711aK1 {

    /* renamed from: a */
    public static final C9604hG1 f15465a;

    static {
        if (BJ1.f713e && BJ1.f712d) {
            int i = MB1.f7033a;
        }
        f15465a = new C9604hG1(3);
    }

    /* renamed from: a */
    public static /* bridge */ /* synthetic */ int m9701a(byte[] bArr, int i, int i2) {
        int i3 = i2 - i;
        byte b = bArr[i - 1];
        if (i3 == 0) {
            if (b <= -12) {
    ...
    /* renamed from: b */
    public static int m9702b(String str, byte[] bArr, int i, int i2) {
        int i3;
        int i4;
        int i5;
        char cCharAt;
    ...
    /* renamed from: c */
    public static int m9703c(String str) {
        int length = str.length();
        int i = 0;
        int i2 = 0;
    ...
    /* renamed from: d */
    public static boolean m9704d(byte[] bArr, int i, int i2) {
        f15465a.getClass();
        return C9604hG1.m18792c(bArr, i, i2);
    }
}
