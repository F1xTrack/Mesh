...
public class AlertDialogLayout extends AbstractC8474Wi0 {
    public AlertDialogLayout(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, 0);
    }

    /* renamed from: l */
    public static int m9847l(View view) {
        ...
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m9847l(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    */
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (view2 != null) {
            view2.measure(i, 0);
            iM9847l = m9847l(view2);
            measuredHeight = view2.getMeasuredHeight() - iM9847l;
            paddingBottom += iM9847l;
        ...
        if (view2 != null) {
            int i5 = paddingBottom - iM9847l;
            int iMin = Math.min(i4, measuredHeight);
            if (iMin > 0) {
                i4 -= iMin;
                iM9847l += iMin;
            }
            view2.measure(i, View.MeasureSpec.makeMeasureSpec(iM9847l, 1073741824));
        ...
        if (mode2 != 1073741824) {
            ...
            for (int i7 = 0; i7 < childCount; i7++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) c8422Vi0).width == -1) {
                        int i8 = ((LinearLayout.LayoutParams) c8422Vi0).height;
                        ((LinearLayout.LayoutParams) c8422Vi0).height = childAt3.getMeasuredHeight();
                        measureChildWithMargins(childAt3, iMakeMeasureSpec, 0, i2, 0);
                        ((LinearLayout.LayoutParams) c8422Vi0).height = i8;
                    }
                }
            }
        }
