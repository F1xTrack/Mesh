...
public class EmojiCompat {
    ...
    public static final class CompatInternal19 extends CompatInternal {
        ...
        public class C17091 extends MetadataRepoLoaderCallback {
            public C17091() {
            }
    ...
    public static abstract class Config {
        ...
        public Config(MetadataRepoLoader metadataRepoLoader) {
            AbstractC9104dM1.m17549h(metadataRepoLoader, "metadataLoader cannot be null.");
        ...
        public Config registerInitCallback(InitCallback initCallback) {
            AbstractC9104dM1.m17549h(initCallback, "initCallback cannot be null");
            if (this.mInitCallbacks == null) {
                this.mInitCallbacks = new C0135C8(0);
            }
        ...
        public Config setGlyphChecker(GlyphChecker glyphChecker) {
            AbstractC9104dM1.m17549h(glyphChecker, "GlyphChecker cannot be null");
    ...
    public static class ListenerDispatcher implements Runnable {
        ...
        public ListenerDispatcher(Collection<InitCallback> collection, int i, Throwable th) {
            AbstractC9104dM1.m17549h(collection, "initCallbacks cannot be null");
    ...
    private EmojiCompat(Config config) {
        ...
        C0135C8 c0135c8 = new C0135C8(0);
        this.mInitCallbacks = c0135c8;
        ...
        if (set != null && !set.isEmpty()) {
            c0135c8.addAll(config.mInitCallbacks);
        }
    ...
    public static EmojiCompat get() {
        ...
        synchronized (INSTANCE_LOCK) {
            ...
            AbstractC9104dM1.m17550i(emojiCompat != null, NOT_INITIALIZED_ERROR_TEXT);
        }
        return emojiCompat;
    }
    ...
    public String getAssetSignature() {
        AbstractC9104dM1.m17550i(isInitialized(), "Not initialized yet");
    ...
    public int getEmojiMatch(CharSequence charSequence, int i) {
        AbstractC9104dM1.m17550i(isInitialized(), "Not initialized yet");
        AbstractC9104dM1.m17549h(charSequence, "sequence cannot be null");
    ...
    public void load() {
        AbstractC9104dM1.m17550i(this.mMetadataLoadStrategy == 1, "Set metadataLoadStrategy to LOAD_STRATEGY_MANUAL to execute manual loading");
        if (isInitialized()) {
            return;
        }
        this.mInitLock.writeLock().lock();
    ...
    public CharSequence process(CharSequence charSequence, int i, int i2, int i3, int i4) {
        ...
        if (i3 >= 0) {
            AbstractC9104dM1.m17545d("start should be <= than end", i <= i2);
            if (charSequence == null) {
                return null;
            }
            AbstractC9104dM1.m17545d("start should be < than charSequence length", i <= charSequence.length());
            AbstractC9104dM1.m17545d("end should be < than charSequence length", i2 <= charSequence.length());
