...
public class ArrayReadWriteBuf implements ReadWriteBuf {
    ...
    public void setDouble(int i, double d) {
        ...
        bArr[i + 3] = (byte) ((i2 >> 24) & KotlinVersion.MAX_COMPONENT_VALUE);
        int i3 = (int) (jDoubleToRawLongBits >> 32);
        bArr[i + 4] = (byte) (i3 & KotlinVersion.MAX_COMPONENT_VALUE);
        bArr[i + 5] = (byte) ((i3 >> 8) & KotlinVersion.MAX_COMPONENT_VALUE);
        bArr[i + 6] = (byte) ((i3 >> 16) & KotlinVersion.MAX_COMPONENT_VALUE);
        bArr[i + 7] = (byte) ((i3 >> 24) & KotlinVersion.MAX_COMPONENT_VALUE);
    }
    ...
    public void setFloat(int i, float f) {
        ...
        byte[] bArr = this.buffer;
        bArr[i] = (byte) (iFloatToRawIntBits & KotlinVersion.MAX_COMPONENT_VALUE);
        bArr[i + 1] = (byte) ((iFloatToRawIntBits >> 8) & KotlinVersion.MAX_COMPONENT_VALUE);
        bArr[i + 2] = (byte) ((iFloatToRawIntBits >> 16) & KotlinVersion.MAX_COMPONENT_VALUE);
        bArr[i + 3] = (byte) ((iFloatToRawIntBits >> 24) & KotlinVersion.MAX_COMPONENT_VALUE);
    }
